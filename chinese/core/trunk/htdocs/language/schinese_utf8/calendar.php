...
define("_CAL_TGL1STD", "每周第一天为星期几？");
define("_CAL_PREVYR", "上一年 (hold for menu)");
define("_CAL_PREVMNTH", "上个月 (hold for menu)");
define("_CAL_GOTODAY", "返回今天");
define("_CAL_NXTMNTH", "下个月 (hold for menu)");
define("_CAL_NEXTYR", "下一年 (hold for menu)");
define("_CAL_SELDATE", "请选择日期");
define("_CAL_DRAGMOVE", "按住鼠标可以拖动");
define("_CAL_TODAY", "今天");
define("_CAL_DISPM1ST", "把星期一作为一周的开始");
define("_CAL_DISPS1ST", "把星期天作为一周的开始");
?>