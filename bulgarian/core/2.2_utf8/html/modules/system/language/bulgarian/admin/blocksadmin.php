...
define("_AM_ADDBLOCK","Добавя нов блок");
define("_AM_LISTBLOCK","Показва всички блокове");
define("_AM_SIDE","Страна");
define("_AM_BLKDESC","Описание на блок");
...
define("_AM_POSCONTT","Позициониране на допълнителното съдържание");
...
define("_AM_EDITBLOCK","Редактира блок");
define("_AM_SYSTEMCANT","Системните блокове не могат да бъдат изтрити!");
define("_AM_MODULECANT","Този блок не може да бъде изтрит директно! Ако искате да забраните блока, деактивирайте модула.");
define("_AM_RUSUREDEL","Сигурен ли сте, че искате да изтриете блока <b>%s</b>?");
define("_AM_NAME","Име");
