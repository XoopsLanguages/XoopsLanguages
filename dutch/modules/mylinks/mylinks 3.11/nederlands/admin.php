<?php
// $Id: admin.php,v 3.1 2011/03/04 12:52:25 mamba Exp $
//%%%%%%		Module Name 'MyLinks'		%%%%%
...
define('_AM_MYLINKS_ACTIVERIGHTS', "Rechten Inzending");
...
// Configuration
define("_AM_MYLINKS_CONFIG_CHECK", "Configuratie Controle");
define("_AM_MYLINKS_CONFIG_PHP", "Minimum PHP vereist: %s (jouw versie is %s)");
define("_AM_MYLINKS_CONFIG_XOOPS", "Minimum XOOPS vereist: %s (jouw versie is %s)");