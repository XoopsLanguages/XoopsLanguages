...
define('_MI_NEWS_BNAME3','Belangrijk Artikel');
...
define("_MI_UPLOAD_GROUP1","Indieners en goedkeurders");
define("_MI_UPLOAD_GROUP2","Alleen goedkeurders");
define("_MI_UPLOAD_GROUP3","Uploaden Gedeactiveerd");

// Text for notifications

define('_MI_NEWS_GLOBAL_NOTIFY', 'Algemeen');
define('_MI_NEWS_GLOBAL_NOTIFYDSC', 'Algemene nieuws notificatie-opties.');
...
define('_MI_RESTRICTINDEXDSC', 'Is de instelling JA, dan zien de gebruikers alleen de nieuws-items in de categorieën waar ze leestoegang toe hebben'); //If set to yes, users will only see news items listed in the index from the topics, they have access to as set in News Permissions

define('_MI_NEWSBYTHISAUTHOR', 'Artikelen van dezelfde auteur');
define('_MI_NEWSBYTHISAUTHORDSC', 'Als deze instelling op JA staat, dan zal er een link \'Artikelen afkomstig van deze auteur\' zichtbaar zijn '); //then a link \'Articles by this author\' will be visible

define('_MI_NEWS_PREVNEX_LINK','Vorige en Volgende link tonen ?');
define('_MI_NEWS_PREVNEX_LINK_DESC','Als deze ingesteld is op  \'JA\', zullen er twee twee nieuwe links onder ieder artikel zichtbaar zijn. Deze links worden gebruikt om te navigeren naar het vorige of volgende artikel volgens publicatie datum');
...
define("_MI_NEWS_SITE_NAVBAR","Gebruikmaking van de Mozilla en Opera Site Navigation's Bar?");
...
define("_MI_NEWS_SKIN_1","Bar Stijl");
define("_MI_NEWS_SKIN_2","Beveled");
define("_MI_NEWS_SKIN_3","Klassiek");
define("_MI_NEWS_SKIN_4","mappen");
