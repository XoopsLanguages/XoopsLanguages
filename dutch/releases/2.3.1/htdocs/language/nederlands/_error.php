...
define('_ER_US_INVALIDNICKNAME','FOUT: Ongeldige gebruikersnaam');
define('_ER_US_NICKNAMETOOLONG','Gebruikersnaam is te lang. Moet korten zijn als %s karakters.');
define('_ER_US_NICKNAMETOOSHORT','Gebruikersnaam is te kort. It must be more than %s karakters.');
define('_ER_US_NAMERESERVED','FOUT: Naam is gereserveerd.');
define('_ER_US_NICKNAMENOSPACES','Er zijn geen spaties in de gebruikersnaam toegelaten.');
define('_ER_US_NICKNAMETAKEN','FOUT: Gebruikersnaam al in gebruiker.');
define('_ER_US_EMAILTAKEN','FOUT: E-mail adres al geregistreerd.');
define('_ER_US_ENTERPWD','FOUT: Je moet een paswoord invullen.');
define('_ER_US_SORRYNOTFOUND','Sorry, geen overeenkomstige gebruikersinfo gevonden.');
