...
'<ul>
<li>De positie van een blok is eenvoudig te veranderen door deze te verslepen en los te laten op de plaats waar dat is gewenst.</li>
<li>Klik op <img class="tooltip" src="%s" alt="'._AM_SYSTEM_BLOCKS_DRAG.'" title="'._AM_SYSTEM_BLOCKS_DRAG.'" /> deze afbeelding en deel de de blokken in zoals dat is gewenst.</li>
<li>Toevoegen van een eigen ontworpen blok door te klikken op "Blok toevoegen".</li>
<li>Verberg of maak een blok zichtbaar door te klikken op <img class="tooltip" width="16" src="%s" alt="'._AM_SYSTEM_BLOCKS_DISPLAY.'" title="'._AM_SYSTEM_BLOCKS_DISPLAY.'"/> of <img class="tooltip" width="16" src="%s" alt="'._AM_SYSTEM_BLOCKS_HIDE.'" title="'._AM_SYSTEM_BLOCKS_HIDE.'" /></li>
</ul>');
