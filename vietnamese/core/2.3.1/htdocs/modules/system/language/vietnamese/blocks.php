...
//%%%%%%    www.xoopsviet.com  %%%%%%%
//%%%%%%    Ngày 18/09/2008 %%%%%%%%%%%%%%%%%%%
define("_MB_SYSTEM_ADMENU","Mục quản trị");//Administration Menu
define("_MB_SYSTEM_RNOW","Ðăng ký tài khoản");//Register now!
define("_MB_SYSTEM_LPASS","Quên mật khẩu?");//Lost Password?
define("_MB_SYSTEM_SEARCH","Tìm kiếm");//Search
define("_MB_SYSTEM_ADVS","Tìm kiếm chi tiết");//Advanced Search
...
define("_MB_SYSTEM_WLNKS","Liên kết đang chờ");//Waiting Links
define("_MB_SYSTEM_BLNK","Liên kết vỡ");//Broken Links
define("_MB_SYSTEM_MLNKS","Liên kết được sửa");//Modified Links
define("_MB_SYSTEM_WDLS","Đợi tải xuống");//Waiting Downloads
define("_MB_SYSTEM_BFLS","Hồ sơ vỡ");//Broken Files
define("_MB_SYSTEM_MFLS","Hồ sơ được sửa");//Modified Downloads
define("_MB_SYSTEM_HOME","Trang chủ"); // Home link to home page in main menu block
define("_MB_SYSTEM_RECO","Giới thiệu với bạn bè");//Recommend Us
...
define("_MB_SYSTEM_DISPLAY","Hiển thị %s thành viên");//Display %s members
define("_MB_SYSTEM_DISPLAYA","Hiển thị hình đại diện của thành viên");//Display member avatars
