...
define('_AM_KUHT_MINI_SHOW','Prikaži ovaj èlanak');
define('_AM_KUHT_MINI_TEXT','Teaser teksta (Ostavite prazno da bi omoguæili automatsko obnavljanje)');
...
define('_AM_KUHT_XML_URL_DESC','{X_SITEURL} æe ispisati '.XOOPS_URL.'/');
...
define('_AM_KUHT_XML_MANAGE','Obriši / Promjeni redosljed');
...
define('_AM_KUHT_NAME_INTROTEXT','Napišite uvodni tekst');
define('_AM_ADMINCONFIGMENU','Neobavezno, možete napisati neka objašnjenja za nekoliko djelova Obavjesti suèelja.');

define('_AM_WRITE_INTRO1','Ovo je tekst koji se nalazi na poèetku bloka.');
define('_AM_WRITE_INTRO2','Ako imate drugih novosti, ovaj tekst æe biti uvod.');
define('_AM_WRITE_INTRO3','Ovo je podnožje, prije same linije sa statistikom, ako je ukljuèena');

define('_AM_SUBMIT','Prijavi');
define('_AM_RESET','Poništi');
...
define('_AM_LAST10NEWARTS','Zadnjih 10 News èlanaka');
define('_AM_LAST10WFSARTS','Zadnjih 10 WF-Section èlanaka');
define('_AM_MESSAGE','Baza podataka je uspješno obnovljena');
define('_AM_NOTFOUND','Nema èlanaka!');
define('_AM_INTROTEXT','Konfiguracija uvodnog teksta');

define('_AM_SELECT_NEWS','News Konfiguracija');
define('_AM_SELECT_SPOTLIGHT_NEWS','Izaberite News prièu za objavljivanje:');
define('_AM_SELECT_AUTO_NEWS','Objavi posljednje News prièe?');
define('_AM_SELECT_SPOTLIGHT','Izaberite èlanak za objavljivanje');
define('_AM_SELECT_NEWS_AUTO_IMG','Prikaži sliku kategorije News prièe?');
...
define('_AM_SELECT_SPOTLIGHT_WFS','Izaberite WF-Section èlanak za objavljivanje:');
define('_AM_SELECT_AUTO_WFS','Objavi zadnje WF-Section èlanke?');
define('_AM_SELECT_IMG_WFS','Izaberite WF-Section sliku objavljivanja:');
define('_AM_SELECT_WFS_AUTO_IMG','Prikaži sliku kategorije WF-Section èlanka?');
...
define("_AM_OFF", "Iskljuèeno");
define("_AM_ON", "Ukljuèeno");
define("_AM_SAFEMODEPROBLEMS", " (Ovo bi moglo stvarati probleme) ");
define("_AM_UPLOADPATH", "Upload put:");
define("_AM_ANDTHEMAX", "Max Upload velièina: ");
define("_AM_DELETEFILE", "WARNING<br/>Obriši ovu datoteku?");
define("_AM_ERRORDELETEFILE", "Greška pri brisanju datoteke!");;
...
define("_AM_DELETEIMAGE", "Obriši sliku");
define("_AM_ERRORMESSAGE", "Greška pri obnavljanju baze podataka.");
define("_AM_NOTERESIZE", "Slici je promjenjena velièina");
