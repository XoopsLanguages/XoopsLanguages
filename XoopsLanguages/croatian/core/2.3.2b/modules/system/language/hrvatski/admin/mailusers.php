...
define("_AM_TIMEFORMAT","(Oblik vremena dd-mm-yyyy, neobvezno)");
...
define("_AM_INACTIVE","Pošalji poruku samo neaktivnim korisnicima (nije obavezno)");
define("_AMIFCHECKD","Ako je ovo izabrano, sve navedeno gore bit će zanemareno");
define("_AM_MAILFNAME","Od, ime pošiljatelja (samo email)");
define("_AM_MAILFMAIL","Od, email adresa pošiljatelja (samo email)");
define("_AM_MAILSUBJECT","Tema");
define("_AM_MAILBODY","Tijelo poruke");
define("_AM_MAILTAGS","Korisne oznake:");
define("_AM_MAILTAGS1","{X_UID} će ispisati korisnički ID");
define("_AM_MAILTAGS2","{X_UNAME} će ispisati korisničko ime");
define("_AM_MAILTAGS3","{X_UEMAIL} će ispisati korisničku email adresu");
define("_AM_MAILTAGS4","{X_UACTLINK} će ispisati korisnički aktivaciski link");
define("_AM_SENDTO","Pošalji na");
