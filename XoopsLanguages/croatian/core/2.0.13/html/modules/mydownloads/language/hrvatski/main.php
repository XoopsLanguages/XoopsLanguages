...
define("_MD_NOPERMISETOLINK", "Ova datoteka ne pripada stranici s koje dolazite <br /><br />Molimo da kontaktirate administratora tih stranica i preporuèite mu:   <br /><b>NEMOJTE TERORIZIRATI, KRASTI TUÐE LINKOVE!</b> <br /><br /><b>Definicija teroriziranja:</b> Onaj koji je prelijen da poveže datoteku sa svog poslužitelja ili ukrade teški rad drugih ljudi i napravi da izgleda kako je njegovo <br /><br />  Vaša IP adresa <b>je zabilježena</b>.");
define("_MD_ALL","Sve");
...
define("_MD_DATEOLD","Datum (Prikaži prvo starije datoteke)");
define("_MD_DATENEW","Datum (Prikaži prvo novije datoteke)");
...
define("_MD_THEREARE","Postoji <b>%s</b> datoteke u našoj bazi podataka");
...
define("_MD_HOMEPAGEC","Poèetna stranica: ");
define("_MD_VERSIONC","Inaèica: ");
define("_MD_FILESIZEC","Velièina datoteke: ");
...
define("_MD_THANKYOU","Hvala vam na vašem vremenu za glasanje na %s"); // %s is your site name
define("_MD_VOTEONCE","Molimo da ne glasate za isti izvor više od jednom.");
...
define("_MD_RECEIVED","Primili smo podatke o vašem downloadu. Hvala!");
define("_MD_WHENAPPROVED","Primit æete email kada datoteka bude odobrena.");
define("_MD_SUBMITONCE","Podnesite svoju datoteku samo jednom.");
define("_MD_ALLPENDING","Sve datoteke su poslane i èekaju provjeru.");
define("_MD_DONTABUSE","Korisnièko ime i IP adresa su zabilježeni, pa stoga nemojte zloupotrebljavati sustav.");
define("_MD_TAKEDAYS","Može proæi nekoliko dana prije nego vaša datoteka bude u našoj bazu podataka.");
...
define("_MD_ALREADYREPORTED","Veæ ste prijavili ovu slomljenu datoteku.");
...
define("_MD_GENERALSET","Opæenite postavke Downloada");
define("_MD_ADDMODDELETE","Dodaj, uredi i izbriši datoteke/kategorije");
define("_MD_DLSWAITING","Dovnload koji èekaju potvrdu");
...
define("_MD_IGNOREDESC","Zanemari (zanemari prijave i samo izbriši <b>prijave slomljenih datoteke</b>)");
define("_MD_DELETEDESC","Izbriši (Izbriši <b>prijave slomljene podatke o preuzimanju</b> i <b>prijave slomljenih datoteka</b> za datoteku.)");
define("_MD_REPORTER","Prijava pošiljatelja");
...
define("_MD_WARNING","UPOZORENJE: Sigurno želite izbrisati ovu kategoriju i sve njene datoteke i komentare?");
define("_MD_YES","Da");
define("_MD_NO","Ne");
define("_MD_NEWCATADDED","Nova kategorija uspješno dodana!");
define("_MD_ERROREXIST","GREŠKA: Download koji ste unjeli je veæ u bazi podataka!");
...
define("_MD_WEAPPROVED","Odobrili smo vašu datoteku, i dodana je u našu bazu podataka.");
...
define("_MD_YOURFILEAT","Vaša datoteka podnesena na %s"); // this is an approved mail subject. %s is your site name

define("_MD_VISITAT","Posjetite naš download odjel na %s");

define("_MD_DLRATINGS","Ocjena Download (ukupno glasova: %s)");
define("_MD_ISAPPROVED","Odobrili smo vaš prijedlog za download");
?>