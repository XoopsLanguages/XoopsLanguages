...
define('_US_SORRYNOTFOUND','Oprostite, slanje korisnièke informacije za %s nije uspjelo.');
define('_US_NEWPWDREQ','Zahtjev sa novom lozinkom na %s');
define('_US_MAILPWDNG','mail_lozinka: greška pri izmjeni korisnièkog raèuna. Kontaktirajte administratora');
// AVATAR
...
define("_US_RESENDACTIVATIONMAIL", "Ponovo pošalji aktivacijski email");
?>