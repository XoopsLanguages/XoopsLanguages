 ...
 */
 //Nav
define('_AM_SYSTEM_USERRANK_NAV_MANAGER','Admin. rangos');
define('_AM_SYSTEM_USERRANK_NAV_MAIN','Mostrar rangos');
define('_AM_SYSTEM_USERRANK_NAV_ADD','Añadir rango');
define('_AM_SYSTEM_USERRANK_NAV_EDIT','Modificar rango');
define("_AM_SYSTEM_USERRANK_NAV_DELETE","Eliminar rango");

define('_AM_SYSTEM_USERRANK_ACTION','Acción');
define('_AM_SYSTEM_USERRANK_ADD','Añadir rango');
...
define('_AM_SYSTEM_USERRANK_ON','No es un rango especial');
