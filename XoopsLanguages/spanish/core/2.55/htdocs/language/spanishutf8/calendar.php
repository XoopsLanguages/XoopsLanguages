...
define('_CAL_TGL1STD', 'Cambiar al primer día de la semana');
define('_CAL_PREVYR', 'Año anterior');
define('_CAL_PREVMNTH', 'Mes anterior');
define('_CAL_GOTODAY', 'Ir a hoy');
define('_CAL_NXTMNTH', 'Mes próximo');
define('_CAL_NEXTYR', 'Año próximo');
define('_CAL_SELDATE', 'Seleccione la fecha');
define('_CAL_DRAGMOVE', 'Arrastre para mover');
define('_CAL_TODAY', 'Hoy');
define('_CAL_DISPM1ST', 'Mostrar el lunes primero');
define('_CAL_DISPS1ST', 'Mostrar el domingo primero');
