 ...
 * @license         GNU GPL 2 (http://www.gnu.org/licenses/old-licences/gpl-2.0.html)
 * @package         kernel
 * @subpackage      form
 * @since           2.3.0
...
define('_XOOPS_FORM_ALT_IMAGE', 'Gestor de imágenes');
define('_XOOPS_FORM_ALT_SMILEY', 'Carita');
...
define('_XOOPS_FORM_ALT_UNDERLINE', 'Subrayado');
...
define('_XOOPS_FORM_ALT_CENTER', 'Izquierda');
...
define('_XOOPS_FORM_ENTERWIKITERM', 'Palabra a enlazar con el Wiki:');
define('_XOOPS_FORM_ALTMP3', 'MP3');
define('_XOOPS_FORM_ENTERMP3URL', 'MP3 URL');
define('_XOOPS_FORM_ALT_CHECKLENGTH', 'Comprobar longitud del contenido');
define('_XOOPS_FORM_ALT_LENGTH', 'Longitud actual del contenido: %s');
define('_XOOPS_FORM_ALT_LENGTH_MAX', 'Longitud máxima: ');
define('_XOOPS_FORM_PREVIEW_CONTENT', 'Clic en <strong>' . _PREVIEW . '</strong> para previsualizar el contenido.');
