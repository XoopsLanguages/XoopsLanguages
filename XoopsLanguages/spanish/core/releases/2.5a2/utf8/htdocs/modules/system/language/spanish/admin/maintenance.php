...
define("_AM_SYSTEM_MAINTENANCE_ERROR_MAINTENANCE","Otra opción de mantenimiento");
...
define("_AM_SYSTEM_MAINTENANCE_DUMP_TABLES_OR_MODULES","Eliminar tablas o módlos");
define("_AM_SYSTEM_MAINTENANCE_DUMP_DROP","Añada el comando DROP TABLE IF EXISTS 'tables' in the dump");
define("_AM_SYSTEM_MAINTENANCE_DUMP_OR", "O");
define("_AM_SYSTEM_MAINTENANCE_DUMP_AND", "Y");
define("_AM_SYSTEM_MAINTENANCE_DUMP_ERROR_TABLES_OR_MODULES", "Ha de legir tablas o módulos");
