...
define('_PM_PROFILE','Konto');

// %s is a username
define('_PM_PREVIOUS','Vorherige');
define('_PM_NEXT','Nächste');

//%%%%%%	File Name pmlite.php 	%%%%%
define('_PM_SORRY','Verzeihung! Sie sind kein registriertes Mitglied.');
define('_PM_REGISTERNOW','Registrieren Sie sich jetzt!');
define('_PM_GOBACK','Zurück');
define('_PM_USERNOEXIST','Das ausgewählte Mitglied existiert nicht in unserer Datenbank.');
define('_PM_PLZTRYAGAIN','Bitte überprüfen Sie den Namen und versuchen Sie es erneut.');
define('_PM_MESSAGEPOSTED','Ihre Nachricht wurde abgeschickt.');
