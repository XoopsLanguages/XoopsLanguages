...
define("_LCX_ADM_ADDREF_TITLE",		"Referrer ausschließen");
define("_LCX_ADM_ADDREF_DESC",		"Setzen Sie den Referrer, der nicht in die Statistiken aufgenommen werden soll<br />Referrer, die diese Zeichenfolge enthalten, werden nicht aufgenommen.");
...
define("_LCX_ADM_DELETEREF_TITLE",	"Ausgeschlossene Referrer");
define("_LCX_ADM_DELETEREF_DESC",	"Referrer von Ausnahmeliste löschen<br />(Referrer in Statistiken aufnehmen)");
...
define("_LCX_ADM_REPORTING_WORBT",	"Suchmaschinenrobot ausschließen");
define("_LCX_ADM_REPORTING_ROBOT",	"Suchmaschinenrobit");

define("_LCX_ADM_BY_R2",	"nach Referrer (Zusammenfassung)");
...
define("_LCX_ADM_BY_RF",	"nach Referrer (Letzter Zugriff)");
define("_LCX_ADM_BY_QW",	"nach Suchwort");
define("_LCX_ADM_BY_UN",	"nach Mitgliedsname");
define("_LCX_ADM_BY_PI",	"nach Eingangsseite");
define("_LCX_ADM_REFLINK",	"Link auf Referrer setzen");
...
define("_LCX_ADM_NOHSTCNT_DESC","Zugriffe von ausgeschlossenen Anbietern weglassen<br />Sie können Anbieter über die 'Berichtsanzeige'-Einstellunge l�schen oder hinzu�gen");
...
define("_LCX_ADM_LOGLIM_DESC",		"Beschränkung des Berichts (Anzahl der Berichte)");
...
define("_LCX_ADM_CHGIMG_NOTE",	"Unabhägig von dieser Einstellungen werden vorrangig die Bilder benutzt, die sich im Verzeichnis mit dem gleichen Namen wie das aktive Theme befinden.");
