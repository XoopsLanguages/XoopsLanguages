...
define("_AM_NEWBB_SYNCFORUM","Forum synchronisieren");
...
define('_AM_NEWBB_NOTAVAILABLE','<font color="red">nicht verfügbar</font>');
define('_AM_NEWBB_NOTWRITABLE','<font color="red">nicht beschreibbar</font>');
...
define('_AM_NEWBB_DIGEST_PAST','<font color="red">Sollte vor %d Minuten abgeschickt worden sein.</font>');
...
define("_AM_NEWBB_CAN_ACCESS","Hat Zugriff auf die Kategorie");
