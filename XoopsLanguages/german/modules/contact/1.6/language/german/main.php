...
define("_CT_THANKYOUCOMMENTS","Vielen Dank für die Nachricht an %s.");
...
define("_CT_CONFIRM", "Bestätigungsmail");
define("_CT_SENDCONFIRMEMAIL", "Bestätigungsmail an %s verschicken?");
define("_CT_SENDCONFIRM", "Bestätigungsmail zuschicken?" );
define("_CT_SENTASCONFIRM","Ihre Nachricht wurde an: %s als Bestätigungsmail geschickt.");
...
define("_CT_ERROR_BADSECVALUE_MSG", "Der Sicherheitscode ist ungültig!<br />");
define("_CT_ERROR_BADEMAIL_MSG", "Bitte prüen Sie die eigegebene Email-Adresse!<br />");
