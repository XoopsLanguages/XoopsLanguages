...
/*****************************************************/
  ...
  define("_MYQUIZ_VIEWSCORE","Wyœwietlenie wyników - Display scores");
  define("_MYQUIZ_VIEWSTAT","Wyœwietlenie statystyki - Display stats");
  define("_MYQUIZ_VIEWANSWER","Wyœwietlenie odpowiedzi - Display the answers");
  define("_MYQUIZ_SENDEMAIL","Poinformowanie administratora - Inform administrator");
  define("_MYQUIZ_LIMITVOTE","Limitowanie iloœci prób rozwi¹zañ -  Limit vote number");
  define("_MYQUIZ_NBSCORE","Iloœæ wyœwietlanych rezultatów rozwi¹zañ - Displayed result number");
  ...
  define("_MYQUIZ_SUBMIT","Wyœlij - Submit");
  ...
  define("_MYQUIZ_ANSWER","OdpowiedŸ - Answer");
  ...
  define("_MYQUIZ_MUSTBEUSER","Musisz byæ zarejestrowany aby wzi¹æ udzia³ w teœcie ! - You must be a registered user to take this Quizz !");
  define("_MYQUIZ_MUSTBEACTIVE","Test nieaktywny ! - This is an inactive Quizz !");
  define("_MYQUIZ_ALREADYVOTED","Ju¿ raz rozwi¹zywa³eœ test ! - You have already played !");
  define("_MYQUIZ_THANKS","Dziêkujemy za udzia³ w teœcie ! - Thanks for playing !");
  ...
  define("_MYQUIZ_MEANSCORE","Œrednio - Mean Score");
  ...
  define("_MYQUIZ_YOUHASVOTED","bra³ udzia³ w teœcie - has voted on Quizz");
  define("_MYQUIZ_YOUHAVECHOOSE","Twoja odpowiedŸ - You have choosen");
  define("_MYQUIZ_CORRECTANSWER","poprawna odpowiedŸ to - and the correct answer is");
  define("_MYQUIZ_COEF","Wartoœæ punktowa pytania - Point value of question (arbitrary)");
  ...
  define("_MYQUIZ_HELPVIEWSCORE","Wyœwietlenie wyników testu po jego rozwi¹zaniu -  Display the scores after the user votes");
  define("_MYQUIZ_HELPANSWER","Wyœwietlenie odpowiedzi do testu po jego rozw¹zaniu - Display the answers after the user votes");
  ...
  define("_MYQUIZ_HELPNBSCORE","Iloœæ wyœwietlanych wyników testu po jego rozwiazaniu - Score number to display after the user vote");
