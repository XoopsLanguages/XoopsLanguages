...
define( "_MD_WFL_THANKSFORINFO"      , "Dziekujemy za propozycjê. Zostaniesz poinformowany kiedy twoja propozycja zostanie zaakceptowana przez administratora strony." );
define( "_MD_WFL_ISAPPROVED"         , "Dziekujemy, twoja propozycja zostawa³a zaakceptowana." );
define( "_MD_WFL_THANKSFORHELP"      , "Dziêkujê za wk³ad w utrzymanie dzia³u w ³adzie." );
define( "_MD_WFL_FORSECURITY"        , "Ze wzglêdów bezpieczeñstwa twoja nazwa u¿ytkownika oraz IP zosta³o zapisane." );
define( "_MD_WFL_DESCRIPTION"        , "Opis" );
define( "_MD_WFL_SUBMITCATHEAD"      , "Formularz dodawania linku" );
define( "_MD_WFL_MAIN"               , "Strona g³ówna" );
...
define( "_MD_WFL_POPULARITYLTOM"     , "Popularno¶æ (Od najmniej do najbardziej popularnych)" );
define( "_MD_WFL_POPULARITYMTOL"     , "Popularno¶æ (Od najbardziej do najmniej popularnych" );
...
define( "_MD_WFL_RATINGLTOH"         , "Ocena (Najmniejsza do najwiêksza)" );
define( "_MD_WFL_RATINGHTOL"         , "Ocena (Najwiêksza do najmniejsza)" );
...
define( "_MD_WFL_NUMVOTES"     , "%s G³osów" );
define( "_MD_WFL_RATETHISFILE" , "Oceñ ¼ród³o" );
define( "_MD_WFL_MODIFY"       , "Modyfikuj" );
define( "_MD_WFL_REPORTBROKEN" , "Zg³o¶ uszkodzony" );
define( "_MD_WFL_BROKENREPORT" , "Zg³o¶ uszkodzone ¼ród³o" );
define( "_MD_WFL_SUBMITBROKEN" , "Dodaj" );
define( "_MD_WFL_BEFORESUBMIT" , "Przed zg³oszeniem uszkodzonego ¼ród³a, sprawd¼ czy aktualne ¼ród³o linku który zg³aszasz jako uszkodzonu, nie znajduje siê na serwerze docelowym." );
define( "_MD_WFL_TELLAFRIEND"  , "Poleæ komu¶" );
define( "_MD_WFL_EDIT"         , "Edytuj" );
define( "_MD_WFL_THEREARE"     , "S± <b>%s</b> <i>Kategorie</i> i <b>%s</b> <i>Linków</i> w bazie" );
define( "_MD_WFL_THEREIS"      , "Jest <b>%s</b> <i>Kategorii</i> i <b>%s</b> <i>Linków</i> w bazie" );
...
define( "_MD_WFL_VIEWDETAILS"  , "Poka¿ szczegó³y" );
define( "_MD_WFL_OPTIONS"      , 'Opcje: ' );
define( "_MD_WFL_NOTIFYAPPROVE", 'Poinformuj mnie kiedy link zostanie zaakceptowany' );
define( "_MD_WFL_VOTEAPPRE"    , "Twój g³os zosta³ wziêty pod uwagê." );
define( "_MD_WFL_THANKYOU"     , "Dziêkujê za g³osowanie w ankiecie %s" ); // %s is your site name
define( "_MD_WFL_VOTEONCE"     , "Nie wolno g³osowaæ na t± sam± rzecz ponad 1 raz." );
define( "_MD_WFL_RATINGSCALE"  , "Skala jest od 1 do 10, 1 to najs³absza a 10 najlepsza." );
define( "_MD_WFL_BEOBJECTIVE"  , "Proszê byæ obiektywnym podczas g³osowania, je¿eli ka¿dy zag³osuje na 1 lub 10, oceny nie bêd± zbyt miarodajne." );
define( "_MD_WFL_DONOTVOTE"    , "Nie wolno g³osowaæ plik który siê samemu doda³o." );
define( "_MD_WFL_RATEIT"       , "Oceñ!" );
...
define( "_MD_WFL_HITS"         , "Klikniêæ" );
define( "_MD_WFL_RATING"       , "G³osów" );
...
define( "_MD_WFL_MUSTREGFIRST" , "Przepraszam ale nie masz wystarczaj±cych uprawnieñ aby tego dokonaæ.<br />Proszê sie zarejestrowaæ lub zalogowaæ!" );
define( "_MD_WFL_NORATING"     , "Nie wybrano oceny." );
define( "_MD_WFL_VOTEFORTITLE" , "Oceñ ten link: " );
define( "_MD_WFL_CANTVOTEOWN"  , "Nie wolno g³osowaæ plik który siê samemu doda³o.<br />Wszystkie g³osy s± wpisane i przejrzane." );
define( "_MD_WFL_SUBMITLINK"   , "Dodaj link" );
define( "_MD_WFL_SUB_SNEWMNAMEDESC", "<ul><li>Wszystkie dodawane linki s± poddawane weryfikacji która mo¿e potrwaæ 24h zanim link uka¿e siê w naszej bazie.</li><li>Mo¿emy odrzuciæ dany link lub zmieniæ jego zawarto¶æ.</li></ul>" );
define( "_MD_WFL_MAINLISTING"  , "Raporty g³ównej kategorii" );
define( "_MD_WFL_LASTWEEK"     , "Ostatni tydzieñ" );
define( "_MD_WFL_LAST30DAYS"   , "Ostatnie 30 dni" );
define( "_MD_WFL_1WEEK"        , "1 Tydzieñ" );
...
define( "_MD_WFL_TOTALNEWLINKS", "Razem nowych linków" );
define( "_MD_WFL_DTOTALFORLAST", "Razem nowych linków dla ostatnich" );
define( "_MD_WFL_AGREE"        , "Zgadzam siê" );
define( "_MD_WFL_DOYOUAGREE"   , "Czy zgadzasz siê z tymi warunkami?" );
...
define( "_MD_WFL_WEBMASTERACKNOW"    , "Uznanych raportów: " );
define( "_MD_WFL_WEBMASTERCONFIRM"   , "Potwierdzonych raportów: " );
define( "_MD_WFL_ERRORSENDEMAIL"     , "Raport potwerdzono lecz wyst±pi³ b³±d podczas wysy³ania informacji do administratora." );

define( "_MD_WFL_DELETE"               , "Usuñ" );
...
define( "_MD_WFL_LEGENDTEXTNEWLAST"    , "Maj±ce ponad tydzieñ" );
...
Proszê o wype³nienie formularza poni¿ej, dodamy to jak najszybciej.<br /><br />
Dziekujê za wype³nienie i po¶wiêcenie chwilki czasu. Chcemy daæ naszym u¿ytkownik± tylko sprawdzone rzeczy.<br /><br />Wszystkie wypowiedzi zostan± sprawdzone przed ich opublikowaniem. 
" );
define( "_MD_WFL_ISNOTAPPROVED"   , "Twoja propozycja musi byæ najpierw zaakceptowana przez administratora." );
...
define( "_MD_WFL_LINKTIMES"       , "Klikniêæ: " );
define( "_MD_WFL_MAINTOTAL"       , "Razem linków: " );
define( "_MD_WFL_LINKNOW"         , "Odwied¼ stronê" );
define( "_MD_WFL_PAGES"           , "<b>Strony</b>" );
define( "_MD_WFL_RATEDRESOURCE"   , "Ocena ¼ród³a" );
...
// added frankblack
define( "_MD_WFL_NOTALLOWESTOSUBMIT"  , "Nie mo¿esz dodawaæ nowych linków" );
...
define( "_MD_WFL_NEWTHIS"  , "Nowo dodane oprócz tego tygodnia" );
define( "_MD_WFL_THREE"    , "Nowo dodane przez ostatnie trzy dni" );
define( "_MD_WFL_TODAY"    , "Nowo dodane dzisiaj" );
define( "_MD_WFL_NO_FILES" , "Nie ma jeszcz ¿adnych linków" );

define( "_MD_WFL_NOPERMISSIONTOPOST"  , "Nie mo¿esz dodawaæ nic w tej kategorii." );
define( "_MD_WFL_RESOURCES"           , "¬ród³a" );
