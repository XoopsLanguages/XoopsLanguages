...
define("_MD_INVALID_IMG","Zdjęcie, które przesłano, nie może byc obsłużone przez bibliotekę GD.");
...
define("_MD_PIC_IN_INVALID_ALBUM","Plik znajduje się w nieistniejacym albumie (%s)!?");
define("_MD_GD_VERSION_ERR","PHP działające na tym serwerze nie obsługuje bibliteki GD version 2.x, przełacz do GD wersja 1.x w konfiguracji galerii");
