...
define("_AM_SYSTEM_USERRANK_NAV_DELETE","Usuwanie");

define("_AM_SYSTEM_USERRANK_ACTION","Akcja");
define("_AM_SYSTEM_USERRANK_ADD","Dodaj nową rangę");
...
define("_AM_SYSTEM_USERRANK_ON","Zwykła ranga");
define("_AM_SYSTEM_USERRANK_SAVE",_AM_SYSTEM_DBUPDATED);
define("_AM_SYSTEM_USERRANK_SPECIAL","Ranga specjalna");
define("_AM_SYSTEM_USERRANK_SPECIAL_CAN","Rangi specjalne są wyświetlane bez względu na ilość napisanych postów)");
define("_AM_SYSTEM_USERRANK_SUREDEL","UWAGA: Czy na pewno chcesz to usunąć?");
define("_AM_SYSTEM_USERRANK_TITLE","Tytuł");
