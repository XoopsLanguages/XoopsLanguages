...
define("_MORE", "więcej...");
define("_MULTIPAGE", "Aby podzielić twój artykuł na wiele stron, użyj słowa <font color=red>[pagebreak]</font> (razem z nawiasami) w treści artykułu.");
define("_IFNOTRELOAD", "Jeśli strona nie przeładowała się automatycznie, proszę kliknąć <a href=%s>tutaj</a>");
define("_WARNINSTALL2", "OSTRZEŻENIE: Folder %s istnieje na Twoim serwerze. <br />Proszę usunąć ten go ze względów bezpieczeństwa.");
define("_WARNINWRITEABLE", "OSTRZEŻENIE: Plik %s ma prawa zapisu dla serwera. <br />Ze względów bezpieczeństwa proszę zmienić te prawa<br /> w systemach Unix (444), lub w Windows (tylko-do-odczytu)");
...
//%%%%%%	File Name admin.php 	%%%%%
define("_NOPERM", "Przepraszamy, nie masz praw dostępu do tej strefy.");
//%%%%%		Common Phrases		%%%%%
define("_NO", "Nie");
define("_YES", "Tak");
define("_EDIT", "Edytuj");
...
define("_MUSTWABLE", "Plik %s musi mieć prawa zapisu!");
// Module info
