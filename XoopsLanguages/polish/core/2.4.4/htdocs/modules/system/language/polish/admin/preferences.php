...
define("_MD_AM_USERCOOKIE","Nazwa dla ciasteczek (cookies) użytkownika.");
define("_MD_AM_USERCOOKIEDSC","Wpisanie nazwy ciasteczek (cookies) pozwala na wyświetlenie kontrolki 'Zapamiętaj mnie' na ekranie logowania. Jeśli użytkownik zaznaczy 'Zapamiętaj mnie', za każdym razem będzie logowany automatycznie. Cookie wygasa po 1 roku.");
...
define("_MD_AM_INDEXFOLLOW","indeksuj stronę i podążaj za linkami");
define("_MD_AM_NOINDEXFOLLOW","nie indeksuj strony i podążaj za linkami");
define("_MD_AM_INDEXNOFOLLOW","indeksuj stronę i nie podążaj za linkami");
define("_MD_AM_NOINDEXNOFOLLOW","nie indeksuj strony i nie podążaj za linkami");
...
define("_MD_AM_THEMEOK","Tematy do wyboru");
define("_MD_AM_THEMEOKDSC","Tematy, które mogą być wybrane przez użytkownika jako domyślny.");
...
define("_MD_AM_MODULEPREF","Preferencje Modułów");
