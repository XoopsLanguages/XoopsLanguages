...
define('_MD_IMGCATRGRP', 'Wybierz grupy mające dostęp do tej kategorii:<br /><br /><span style="font-weight: normal;">Te grupy mogą wybierać obrazki z tej kategorii, ale nie mogą ich dodawać. Webmaster ma uprawnienia automatyczne.</span>');
...
define('_IMGWEIGHT', 'Kolejność wyświetlania:');
