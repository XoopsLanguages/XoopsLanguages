...
define("_POSTANON","Publier en anonyme");
define("_DISABLESMILEY","Désactiver les émoticônes");
define("_DISABLEHTML","Désactiver le code HTML");
...
define("_OLDESTFIRST","Les plus anciens en premier");
define("_NEWESTFIRST","Les plus récents en premier");
define("_MORE","Plus ...");
...
define("_VISITWEBSITE","Visiter le site Internet");
define("_SENDPMTO","Envoyer un message privé à %s");
define("_SENDEMAILTO","Envoyer un courrier par email à %s");
define("_ADD","Ajouter");
...
//%%%%%%        File Name admin.php         %%%%%
define("_NOPERM","Désolé, vous n'avez pas les permissions pour accéder à cette zone.");
//%%%%%                Common Phrases                %%%%%
define("_NO","Non");
define("_YES","Oui");
define("_EDIT","Editer");
...
* Image manager
*/
define("_MD_ADDIMGCAT","Ajouter une catégorie d'images");
define("_MD_IMGCATNAME","Nom de la catégorie");
define("_MD_IMGCATRGRP","Groupe(s) pouvant accéder");
define("_MD_IMGCATWGRP","Groupe(s) pouvant gérer");
define("_MD_IMGCATWEIGHT","Ordre d'affichage");
define("_MD_IMGCATDISPLAY","Affichage");
define("_MD_IMGCATSTRTYPE","Paramètre d'enregistrement");
...
define("_IMGMAXWIDTH","Largeur maximum autorisée (pixels) :");
define("_IMGMAXHEIGHT","Hauteur maximum autorisée (pixels) :");
...
define("_ENTERURL","Saisissez l'adresse internet du lien que vous voulez ajouter :");
define("_ENTERWEBTITLE","Entrez le titre du site internet :");
define("_ENTERIMGURL","Entrez l'adresse de l'image que vous voulez ajouter.");
...
* xoops emoticone
*/
define("_AM_ADDSMILE","Ajouter une émoticône");
