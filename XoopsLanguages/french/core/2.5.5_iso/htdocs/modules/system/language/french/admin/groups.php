...
//Nav
define("_AM_SYSTEM_GROUPS_NAV_MANAGER","Gestion des groupes");
define("_AM_SYSTEM_GROUPS_NAV_LIST","Liste des groupes");
define("_AM_SYSTEM_GROUPS_NAV_ADD","Ajouter un nouveau groupe");
define("_AM_SYSTEM_GROUPS_NAV_EDIT","Editer le groupe");
define("_AM_SYSTEM_GROUPS_NAV_DELETE","Supprimer le groupe");

// Tips
define("_AM_SYSTEM_GROUPS_NAV_TIPS_1","<ul><li>Créez un nouveau groupe d'utilisateurs avec ses propres permissions.</li><li>Éditez les groupes pour modifier les permissions.</li></ul>");
define("_AM_SYSTEM_GROUPS_NAV_TIPS_2","<ul><li>Modifiez ou créez les permissions pour ce groupe d'utilisateurs. Toutes les modifications affecteront la totalité des utilisateurs de ce groupe.</li></ul>");
...
define("_AM_SYSTEM_GROUPS_CUSTOMBLOCK","Bloc Personnalisé ");
