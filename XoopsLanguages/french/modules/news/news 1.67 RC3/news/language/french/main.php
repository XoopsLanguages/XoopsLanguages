...
define('_NW_SENDSTORY',"Envoyer cet article à un ami");
...
define('_NW_NOTIFYSBJCT',"Des articles à publier sur le site"); // Notification mail subject
define('_NW_NOTIFYMSG',"Hé! Vous avez de nouvelles propositions d'articles pour votre site."); // Notification mail message
...
// %s is your site name
define('_NW_INTARTICLE',"Article intéressant sur %s");
define('_NW_INTARTFOUND',"Voici un article intéressant trouvé sur %s");

define('_NW_TOPICC',"Sujet :");
define('_NW_URL',"Site :");
define('_NW_NOSTORY',"Désolé, l'article sélectionné n'existe pas.");
...
// Added by Hervé
define('_NW_ATTACHEDFILES',"Fichiers attachés : ");
define('_NW_ATTACHEDLIB',"Cet article a des fichiers attachés");
define('_NW_NEWSSAMEAUTHORLINK',"Articles du même auteur");
define('_NW_NEWS_NO_TOPICS',"Désolé, mais il n'y actuellement aucun sujet, merci de le créer avant de soumettre un article");
define('_NW_PREVIOUS_ARTICLE',"Article précédent");
...
define('_NW_RATINGSCALE',"L'échelle va de 1 à 10, 1 étant Pas Terrible quand 10 est Excellent.");
define('_NW_BEOBJECTIVE',"Merci de rester objectif, si tout le monde reçoit une note de 1 ou 10, la notation n'est pas très utile.");
define('_NW_DONOTVOTE',"Merci de ne pas voter pour vos propres participations.");
define('_NW_RATING',"Notation");
define('_NW_VOTE',"Vote");
define('_NW_NORATING',"Aucune note sélectionnée.");
