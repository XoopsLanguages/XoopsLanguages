...
define("_INSTALL_WEBMASTERD","�����ڱ׷�");
define("_INSTALL_REGUSERS","���ȸ��");
define("_INSTALL_REGUSERSD","���ȸ���׷�");
define("_INSTALL_ANONUSERS","�մ�");
define("_INSTALL_ANONUSERSD","�մԱ׷�");

define("_INSTALL_L165","�� ����Ʈ�� ���� ������ ���� �ӽ� ����� �����Դϴ�. ����Ŀ� �ٽ� �湮�� �ֽʽÿ�!");

define("_INSTALL_ANON","�մ�");
