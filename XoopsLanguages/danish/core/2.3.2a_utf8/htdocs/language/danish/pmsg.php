...
define('_PM_DELETED','Din(e) meddelelser er slettet');
define('_PM_PRIVATEMESSAGE','Privat meddelelse');
define('_PM_INBOX','Indbakke');
define('_PM_FROM','Fra');
define('_PM_YOUDONTHAVE','Du har ingen private meddelelser');
...
define('_PM_GOBACK','Tilbage');
define('_PM_USERNOEXIST','Den valgte bruger eksistere ikke i databasen');
define('_PM_PLZTRYAGAIN','Kontrollér venligst navnet og prøv igen');
define('_PM_MESSAGEPOSTED','Din meddelelse er sendt');
...
define('_PM_SEND','Opret ny');
define('_PM_DELETE','Slet');
define('_PM_REPLY','Besvar');
define('_PM_PLZREG','Registrer dig som bruger før du kan sende private meddelelser');
