...
define("_XOOPS_FORM_ALT_IMAGE","Interne billeder");
...
define("_XOOPS_FORM_ALT_CENTER","Centreret");
...
define("_XOOPS_FORM_ENTERWIKITERM","Ordet der skal linkes til i Wiki:");
define("_XOOPS_FORM_ALTMP3","MP3");
define("_XOOPS_FORM_ENTERMP3URL","MP3 URL");

define("_XOOPS_FORM_ALT_CHECKLENGTH","Kontroller tekst længde");
define("_XOOPS_FORM_ALT_LENGTH","Aktuel indholds længde: %s");
define("_XOOPS_FORM_ALT_LENGTH_MAX","Maksimal længde: ");

define("_XOOPS_FORM_PREVIEW_CONTENT","Klik på <strong>" . _PREVIEW . "</strong> for at se indholdet i funktion.");
