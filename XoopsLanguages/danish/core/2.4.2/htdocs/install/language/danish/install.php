...
define("RECOMMENDED_EXTENSIONS_MSG","Disse udvidelser er ikke et krav til normalt brug, men kan v&aelig;re n&oslash;dvendige for at udnytte nogle specifikke muligheder (som multi-sprog eller RSS-st&oslash;tte). anbefales det at f&aring; dem installeret." );
define("NONE","Ingen" );
