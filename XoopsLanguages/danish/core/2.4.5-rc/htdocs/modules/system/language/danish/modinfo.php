...
define('_MI_SYSTEM_ADMENU7', 'Smilier');
define('_MI_SYSTEM_ADMENU9', 'Brugerrang');
define('_MI_SYSTEM_ADMENU10', 'Redigér brugere');
define('_MI_SYSTEM_ADMENU11', 'Skriv til brugere');
define('_MI_SYSTEM_ADMENU12', 'Find brugere');
define('_MI_SYSTEM_ADMENU13', 'Billeder');
define('_MI_SYSTEM_ADMENU14', 'Brugerikoner');
