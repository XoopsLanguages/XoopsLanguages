...
define('_MD_A_MYMENU_MYBLOCKSADMIN','Odobrenja');
define('_MD_A_MYMENU_MYPREFERENCES','Pode&#353;avanja');

// index.php
define("_AM_TH_DATETIME","Vrijeme");
define("_AM_TH_USER","Korisnik");
define("_AM_TH_IP","IP");
define("_AM_TH_AGENT","Klijent");
define("_AM_TH_TYPE","Typ");
define("_AM_TH_DESCRIPTION","Opis");

define("_AM_TH_BADIPS" , '\"Lo&scaron;e\" IP adrese<br /><br /><span style="font-weight:normal;">Svaka IP adresa u novi red<br />Ako je prazno polje za IP adrese onda je svakoj IP dozvoljen pristup stranici</span>' ) ;
