...
$GLOBALS['formtextdhtml_sizes'] = array(
    ...
    'large' => 'Velika' , 
    'x-large' => 'Vrlo-Velika' , 
    'xx-large' => 'Extra-Velika');
define('_XOOPS_FORM_ALT_URL','URL');
define('_XOOPS_FORM_ALT_EMAIL','Email');
define('_XOOPS_FORM_ALT_IMG','Slike');
define('_XOOPS_FORM_ALT_IMAGE','Naše slike');
define('_XOOPS_FORM_ALT_SMILEY','Smjehuljci');
define('_XOOPS_FORM_ALT_CODE','Izvorni code');
define('_XOOPS_FORM_ALT_QUOTE','Citat');
define('_XOOPS_FORM_ALT_BOLD','Podebljano');
define('_XOOPS_FORM_ALT_ITALIC','Koso');
...
define('_XOOPS_FORM_ENTERWIKITERM','Riječ za link na Wiki:');
...
define('_XOOPS_FORM_ALT_LENGTH','Trenutna dužina teksta: %s');
define('_XOOPS_FORM_ALT_LENGTH_MAX','Maksimalana dužina teksta je: ');
define('_XOOPS_FORM_PREVIEW_CONTENT','Klikni i <strong>' . _PREVIEW . '</strong> sadžaj u akciji.');
