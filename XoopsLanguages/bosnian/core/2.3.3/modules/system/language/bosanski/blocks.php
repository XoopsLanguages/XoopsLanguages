...
define('_MB_SYSTEM_RNOW','Klikni ovdje i sada se registruj, besplatno!');
define('_MB_SYSTEM_LPASS','Lozinku si zaboravio?');
...
define('_MB_SYSTEM_WLNKS','Pristigli Linkovi');
define('_MB_SYSTEM_BLNK','Neispravni Linkovi');
define('_MB_SYSTEM_MLNKS','Promjenjeni Linkovi');
define('_MB_SYSTEM_WDLS','Pristigli Downloadi');
define('_MB_SYSTEM_BFLS','Neispravni Downloadi');
define('_MB_SYSTEM_MFLS','Promijenjeni Downloadi');
define('_MB_SYSTEM_HOME','Start stranica'); // link to home page in main menu block
define('_MB_SYSTEM_RECO','Preporu&#269;i nas dalje.');
...
define('_MB_SYSTEM_SEMTO','E-Mail za %s po&scaron;alji');

define('_MB_SYSTEM_DISPLAY','Prika&#382;i %s &#269;lana');
define('_MB_SYSTEM_DISPLAYA','Avatare od &#269;lanova prika&#382;i');
