...
define('_PM_SORRY', 'Du är tyvärr inte registrerad som användare.');
define('_PM_REGISTERNOW', 'Registrera nu!');
define('_PM_GOBACK', 'Gå tillbkaa');
...
define('_PM_CLICKHERE', 'Klicka här för att läsa dina privata meddelanden');
...
define('_PM_NOTREAD', 'Inte läst');
define('_PM_SEND', 'Skicka');
define('_PM_DELETE', 'Radera');
define('_PM_REPLY', 'Svara');
define('_PM_PLZREG', 'Du måste registrera dig först för att kunna skicka privata meddelanden!');
