...
define("_AM_TH_IP","IP");
define("_AM_TH_AGENT","AGEN");
define("_AM_TH_TYPE","Jenis");
define("_AM_TH_DESCRIPTION","Huraian");

define( "_AM_TH_BADIPS" , 'Bad IPs<br /><br /><span style="font-weight:normal;">Tulis setiap IP dalam barisan <br />kosong bermaksud semua IP dibenarkan</span>');

define( "_AM_TH_GROUP1IPS" , 'IP yang dibenarkan untuk Group=1<br /><br /><span style="font-weight:normal;">Tulis setiap IP dalam barisan.<br />192.168. bermaksud 192.168.*<br />kosong bermaksud semua IP dibenarkan</span>');
...
define("_AM_ADV_DBFACTORYPATCHED","Databasefactory anda kini sedia untuk DBLayer Trapping anti-SQL-Injection");
