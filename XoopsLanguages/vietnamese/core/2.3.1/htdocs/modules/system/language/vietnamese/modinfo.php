...
define("_MI_SYSTEM_NAME","Hệ Thống");//System
// A brief description of this module
define("_MI_SYSTEM_DESC","Để quản lý cho những sự thiết đặt chính của site.");//For administration of core settings of the site.
// Names of blocks for this module (Not all module has blocks)
define("_MI_SYSTEM_BNAME2","Mục thành viên");//User Menu
define("_MI_SYSTEM_BNAME3","Đăng nhập");//Login
define("_MI_SYSTEM_BNAME4","Tìm kiếm");//Search
...
define("_MI_SYSTEM_ADMENU2","Khối");//Blocks
define("_MI_SYSTEM_ADMENU3","Nhóm");//Groups
define("_MI_SYSTEM_ADMENU5","Mô-đun");//Modules
define("_MI_SYSTEM_ADMENU6","Tùy chọn");//Preferences
define("_MI_SYSTEM_ADMENU7","Hình mặt cười");//Smilies
