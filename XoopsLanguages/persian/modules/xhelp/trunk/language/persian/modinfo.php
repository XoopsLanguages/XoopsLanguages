...
// Submenu
define('_MI_XHELP_SMNAME1','خلاصه');
define('_MI_XHELP_SMNAME2','گزارش بلیط ها');
define('_MI_XHELP_SMNAME3','ویژگی های فردی من');
define('_MI_XHELP_SMNAME4','دیدن همه بلیط ها');
define('_MI_XHELP_SMNAME5','جستجو');
define('_MI_XHELP_SMNAME6','دیدن گزارشات');
