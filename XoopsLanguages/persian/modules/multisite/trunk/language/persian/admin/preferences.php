...
// dont change
define("_MD_AM_SUCCESSCOPY","با موفقیت انجام شدن کپی تنظیمات با نام: ");
define("_MD_AM_ERRORCOPY","خطا در هنگام کپی کردن تنظیمات با نام: ");
define("_AM_DBUPDATED",_MD_AM_DBUPDATED);
define("_MD_AM_SITEPREF_DOMAIN",'انتخاب دامنه برای تنظیم ویژگی ها');
define("_AM_SELECT_DOMAIN",'دامنه مورد نظر خود را برای تنظیم ویژگی ها انتخاب کنید');
define("_AM_DOMAINS",'دامنه:');
...
define('_MD_AM_PREFMAIN','صفحه‌ی اصلی ویژگی‌ها (Preferences)');
