...
define('_MD_USER_LASTVISIT','آخرین بازدید شما از انجمن در %s بوده‌است.');
define('_MD_USER_LASTPOST','آخرین پست شما در انجمن %s بوده است.');
define('_MD_USER_NOLASTPOST','شما هنوز پستی ارسال نکرده اید');
define('_MD_USER_TOPICS','عنوان های ساخته شده توسط شما: ');
define('_MD_USER_POSTS','پست های ارسال شده شما: ');
define('_MD_USER_DIGESTS','خلاصه های شما: ');
define('_MD_VIEW_NEWPOSTS','دیدن پست های جدید');
...
define('_MD_TODAYTOPICSC','عنوان های امروز: ');
define('_MD_TODAYPOSTSC','پیام های امروز: ');
define('_MD_TOTALDIGESTSC','همه خلاصه ها: ');
...
define("_MD_CAN_TYPE","شما <strong>می توانید</strong>از تغییر حالت تاپیک استفاده کنید<br />");
define("_MD_CANNOT_TYPE","شما <strong>نمی توانید</strong>از تغییر حالت تاپیک استفاده کنید<br />");
define("_MD_CAN_HTML","شما <strong>می توانید</strong> از HTML  استفاده کنید<br />");
define("_MD_CANNOT_HTML","شما <strong>نمی توانید</strong> از HTML  استفاده کنید<br />");
define("_MD_CAN_UPLOAD","شما  <strong>می توانید</strong> فایل ها را بارگذاری کنید.<br />");
define("_MD_CANNOT_UPLOAD","شما  <strong>نمی توانید</strong> فایل ها را بارگذاری کنید.<br />");
define("_MD_CAN_SIGNATURE","شما  <strong>می توانید</strong> امضا داشته باشید.<br />");
define("_MD_CANNOT_SIGNATURE","شما <strong>نمی توانید</strong> امضا داشته باشید.<br />");
...
define("_MD_NEWBB_TYPE","نوع عنوان");

//define("_MD_NEWBB_TAG","تگ");
/*
