...
define("_MI_NEWBB_BLOCK_TAG_CLOUD","توده کلمات کلیدی");
define("_MI_NEWBB_BLOCK_TAG_TOP","محبوب ترین کلمات کلیدی");
/*
...
define("_MI_NEWBB_ADMENU_TYPE","الگو تاپیک");
...
define("_MI_NEWBB_INSTALL_POST_TEXT","
	...
	اگر هر سوالی راجع به استفاده از CBB دارید, لطفا سایت پشتیبانی را بازدید کنید <a href=\"http://irxoops.org/modules/newbb/\" target=\"_blank\" title=\"CBB @ farsixoops\">ماژول انجمن ها</a>.
	");
?>