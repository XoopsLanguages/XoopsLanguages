...
define('_MI_ACHAT_ALLOWED_COLORSDESC','رنگ ها رابه وصيله ي | از هم جدا کنيد , و به وسيله ي# خارج کنيد.<br />مثال : "000000|FFFFFF"  رنگ سفيد  و سياه انتخاب شده است<br />ميتوانيد 8 رنگ انتخاب کنيد.');
...
define('_MI_ACHAT_NICK4GUESTS','کاربر مهمان ميتواند نام نمايشي انتخاب کند');
