...
define("_NW_SENDSTORY","پیشنهاد این صفحه");
...
define("_NW_SUBMITNEWS","ارسال خبر برای صفحه اول");
...
define("_NW_NOTIFYMSG","یک نوشته جدید برای صفحه اول سایت اومده."); // Notification mail message
...
// Added by Hervé
define("_NW_ATTACHEDFILES","فایل‌های پیوست‌شده:");
define("_NW_ATTACHEDLIB","این خبر دارای فایل پیوست شده است");
define("_NW_NEWSSAMEAUTHORLINK","خبرهای فرستاده شده توسط این شخص");
define("_NW_NEWS_NO_TOPICS","متاسفانه سرفصلی برای ارسال خبر وجود ندارد. اول باید یک سرفصل بسازید");
define("_NW_PREVIOUS_ARTICLE","خبر قبلی");
define("_NW_NEXT_ARTICLE","خبر بعدی");
define("_NW_OTHER_ARTICLES","سایر خبرها");
...
define("_NW_RATINGSCALE","از 1 تا 10 می‌توانید رای دهید 1 یعنی به درد نخور و 10 یعنی عالی");
...
define("_NW_CANTVOTEOWN","شما نمی‌توانید به نوشته‌های خود رای دهید.<br />تمام رای‌ها ذخیره و بازبینی می‌شوند");
define("_NW_VOTEDELETED","داده‌های ارزش‌گذاری حذف شد.");
define("_NW_VOTEONCE","لطفا به یک نوشته بیش از یک بار رای ندهید");
...
define("_NW_META_DESCRIPTION","شرح Meta (برای موتورهای جستجو)");
define("_NW_META_KEYWORDS","کلمات کلیدی Meta (برای موتورهای جستجو)");
define("_NW_MAKEPDF","از این خبر یک pdf بساز");
define('_MD_POSTEDON',"ارسال شده در تاریخ: ");
define("_NW_AUTHOR_ID","شناسه نویسنده");
define("_NW_POST_SORRY","متاسفانه یا سرفصلی وجود ندارد و یا شما دسترسی به هیچ سرفصلی برای ارسال خبر ندارید. اگر شما وب‌مستر هستید، به صفحه دسترسی‌ها بروید و دسترسی‌ها برای 'ارسال' را تنظیم کنید.");
...
define('_NW_NEWS_LIST_OF_AUTHORS',"در اینجا فهرستی از تمام نویسندگان خبر این سایت را مشاهده می‌کنید، روی نام نویسنده کلیک کنید تا فهرست خبرهای ارسال شده را ببینید");
define('_AM_NEWS_TOPICS_DIRECTORY',"شاخه سرفصل‌ها");
