...
define("_AM_XTUBE_WARNINSTALL1", "span style='font-weight: bold;'WARNING:</span> <span style='text-decoration: underline;'>Directory</span> %s exists on your server.<br />Please remove this directory for security reasons.");
define("_AM_XTUBE_WARNINSTALL2", "span style='font-weight: bold;'WARNING:</span> <span style='text-decoration: underline;'>File</span> %s exists on your server.<br />Please remove this directory for security reasons.");
define("_AM_XTUBE_WARNINSTALL3", "span style='font-weight: bold;'WARNING:</span> <span style='text-decoration: underline;'>Folder</span> %s does not exists on your server.<br />This folder is required by XoopsTube.");
...
define("_AM_XTUBE_VIDEO_SPHPINI", "span style='font-weight: bold;'Information taken from PHP ini Link:</span>");
...
define("_AM_XTUBE_VIDEO_GDON", "span style='font-weight: bold;'Enabled</span> (Thumbs Nails Available)");
define("_AM_XTUBE_VIDEO_GDOFF", "span style='font-weight: bold;'Disabled</span> (No Thumb Nails Available)");
...
define("_AM_XTUBE_MINDEX_PAGE", "span style='font-weight: bold;'Page:span style='font-weight: bold;' ");
...
define("_AM_XTUBE_SUB_APPROVEWAITINGFILE", "span style='font-weight: bold;'Approve</span> new video information without validation.");
define("_AM_XTUBE_SUB_EDITWAITINGFILE", "span style='font-weight: bold;'Edit</span> new video information and then approve.");
define("_AM_XTUBE_SUB_DELETEWAITINGFILE", "span style='font-weight: bold;'Delete</span> the new video information.");
...
define("_AM_XTUBE_VOTE_DELETEDSC", "span style='font-weight: bold;'Deletes</span> the chosen vote information from the database.");
...
define("_AM_XTUBE_VIDEO_ALLOWEDAMIME", "<div style='padding-top: 4px; padding-bottom: 4px;'>span style='font-weight: bold;'Allowed Admin Video Extensions</span>:</div>");
...
span style='font-weight: bold;'Blip.tv </span>embed codespan style='font-weight: bold;':</span> http://blip.tv/play/<span style='color: #FF0000;'>Abe6EwA</span> ...<br />
...
define("_AM_XTUBE_VIDEO_SETPUBLISHDATE", "span style='font-weight: bold;'Set Publish Date: </span>");
define("_AM_XTUBE_VIDEO_SETNEWPUBLISHDATE", "span style='font-weight: bold;'Set New Publish Date: </span><br />Published:");
define("_AM_XTUBE_VIDEO_SETPUBDATESETS", "span style='font-weight: bold;'Publish Date Set: </span><br />Publishes On Date:");
define("_AM_XTUBE_VIDEO_EXPIREDATESET", " Expire date set: ");
define("_AM_XTUBE_VIDEO_SETEXPIREDATE", "span style='font-weight: bold;'Set Expire Date: </span>");
define("_AM_XTUBE_VIDEO_DELEDITMESS", "Delete Broken Report?<br /><br /><span style='font-weight: normal;'>When you choose span style='font-weight: bold;'YES</span> the Broken Report will automatically deleted and you confirm that the video now works again.</span>");
define("_AM_XTUBE_VIDEO_MUSTBEVALID", "Screenshot image must be a valid image under %s directory (ex. shot.gif). This screenshot is used for XoopsTube internal flv player only.");
...
define("_AM_XTUBE_VIDEO_CREATENEWSSTORY", "span style='font-weight: bold;'Create News Story From link</span>");
...
define("_AM_XTUBE_BROKEN_IGNOREDESC", "span style='font-weight: bold;'Ignores</span> the report and only deletes the broken video report.");
define("_AM_XTUBE_BROKEN_DELETEDESC", "span style='font-weight: bold;'Deletes</span> the reported link data and broken video reports for the link.");
define("_AM_XTUBE_BROKEN_EDITDESC", "span style='font-weight: bold;'Edit</span> the video to fix the problem.");
define("_AM_XTUBE_BROKEN_ACKDESC", "span style='font-weight: bold;'Acknowledged</span> Set Acknowledged state of broken file report.");
define("_AM_XTUBE_BROKEN_CONFIRMDESC", "span style='font-weight: bold;'Confirmed</span> Set confirmed state of broken video report.");
...
define("_AM_XTUBE_MXOOPSTUBE", "Add XoopsTube Clip");
...
define("_AM_XTUBE_XOOPSTUBEVIDEO", "XoopsTube Video File:");
define("_AM_XTUBE_WARNINSTALL4", "span style='font-weight: bold;'WARNING:</span> <span style='text-decoration: underline;'>Folder</span> %s is not writeable. <br />This folder needs to be writeable (CHMOD 777) for XoopsTube.");
