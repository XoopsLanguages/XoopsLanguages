...
define('_XO_AD_USERBENNED_HEADER', 'شناسه بسته شده');
define('_XO_AD_USERBENNED_TEXT', 'شناسه کاربری شما در سیستم ما بسته شده است. </br />اگر احساس میکنید در این مورد اشتباهی روی داده است , لطفا با استفاده از %s با مدیر وبسایت تماس بگیرید.');
?>