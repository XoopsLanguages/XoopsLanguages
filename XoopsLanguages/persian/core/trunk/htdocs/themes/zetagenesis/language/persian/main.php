...
/* ------------------- userbar.html ------------------- */
define("_THEME_REGISTER",           "ثبت نام کاربر");
...
define("THEME_NOTIFICATION",			"نمایش آگاهی رسانی ها");
define("THEME_MESSAGE",					"نمایش پیام ها");
define("THEME_YOUHAVE",					"شما");
define("THEME_NOTREAD",					"پیام خوانده نشده دارید");
define("THEME_MYACCOUNT",				"ویژگی های فردی من");
define("THEME_SEARCH",					"جستجو");
define("THEME_DESC_SEARCH",				"یافت شده در وب سایت");
define("THEME_KEYWORDS",				"کلمه کلیدی");
define("THEME_UPTOP",					"بالای صفحه");
define("THEME_USER",					"کاربران");

/* footer admin */
define("THEME_CPHOME",					"مدیریت");
define("THEME_SYSOPTIONS",				"گزینه ها");
