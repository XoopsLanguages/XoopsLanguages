...
define("_AM_LISTBLOCK","فهرست همهٔ بلاک‌ها");
...
define("_AM_SAVECHANGES","ذخیرهٔ تغییرات");
...
define('_AM_TOPPAGE', 'صفحهٔ اصلی (Top page)');
define('_AM_VISIBLEIN', 'قابل دیدن در');
define('_AM_ALLPAGES', 'همهٔ صفحات');
define('_AM_TOPONLY', 'فقط صفحهٔ اصلی (Top Page)');
