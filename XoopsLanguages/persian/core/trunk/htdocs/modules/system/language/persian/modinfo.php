...
define("_MI_SYSTEM_NAME","سیستم (system)");

// A brief description of this module
define("_MI_SYSTEM_DESC","برای مدیریت هستهٔ اصلی وب سایت");
...
define("_MI_SYSTEM_ADMENU1","بنر‌ها (Banners)");
...
define("_MI_SYSTEM_ADMENU7","لبخندک ها (Smilies)");
define("_MI_SYSTEM_ADMENU9","نشان اعضا");
define("_MI_SYSTEM_ADMENU10","ویرایش اعضا");
define("_MI_SYSTEM_ADMENU11","فرستادن پیام به اعضا");
define("_MI_SYSTEM_ADMENU12", "پیدا کردن اعضا");
define("_MI_SYSTEM_ADMENU13", "تصاویر (Images)");
define("_MI_SYSTEM_ADMENU14", "تصاویر اعضا (Avatars)");
