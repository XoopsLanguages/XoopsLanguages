...
define('_US_LOSTPASSWORD','رمزعبور را فراموش کرده‌اید ؟');
define('_US_NOPROBLEM','نگران نباشید، آدرس پست‌الکترونیکی خود را وارد کنید ما برای شما رمزعبور را ارسال خواهیم کرد.');
define('_US_YOUREMAIL','پست‌الکترونیکی شما ');
define('_US_SENDPASSWORD','ارسال رمزعبور');
define('_US_LOGGEDOUT','شما خارج‌شدید');
define('_US_THANKYOUFORVISIT','برای بازدید سایت از شما متشکریم');
define('_US_INCORRECTLOGIN','شناسه‌ی‌کاربری یا رمزعبور صحیح نیست');
...
define('_US_ACTKEYNOT','رمزعبور برای فعال سازی کاربر صحیح نیست');
define('_US_ACONTACT','این کاربر قبلا فعال‌شده است');
define('_US_ACTLOGIN','شناسه‌ی شما فعال شد با رمزعبور ثبت شده وارد شوید');
define('_US_NOPERMISS','متاسفانه شما دسترسی برای انجام این کار ندارید');
define('_US_SURETODEL','یقین دارید که می‌خواهید شناسه‌ی خود را حذف کنید؟');
define('_US_REMOVEINFO','این کار تمامی اطلاعات شما را از پایگاه‌داده‌ی ما حذف خواهد کرد');
define('_US_BEENDELED','شناسه‌ی شما حذف شد');
define('_US_ACTFAILD','فعال سازی موفقیت آمیز نبود !');
//%%%%%%		File Name register.php 		%%%%%
define('_US_USERREG','توجه: پر کردن گزینه‌‌هایی که ستاره ندارند اختیاری است. در شناسه‌ی‌کاربری می‌توانید کلمات فارسی، نویسه‌‌های خاص مانند فاصله و غیره را به کار ببرید. شناسه را با دقت انتخاب کنید چون برای تغییر آن باید با یکی از مدیران سایت تماس بگیرید. حداکثر اندازه برای شناسه‌‌های انگلیسی ۲۵ و برای شناسه‌‌های فارسی ۱۲ نویسه، بدون در نظر‌گرفتن فاصله (Space) است.در پر کردن پست‌الکترونیکی دقت کنید چون اگر غلط نوشته شده‌باشد نامه‌ی فعال‌سازی به دست شما نمی‌رسد. پست‌الکترونیکی را به صورت مثال روبرو بدون www وارد کنید : ali@yahoo.com<br><br>ثبت‌کاربر');
define('_US_NICKNAME','شناسه‌ی‌کاربری');
...
define('_US_TIMEZONE','منطقه‌ی زمانی');
define('_US_AVATAR','تصویر اصلی');
define('_US_VERIFYPASS','تکرار رمزعبور');
define('_US_SUBMIT','ارسال');
define('_US_USERNAME','شناسه‌ی‌کاربری');
...
define('_US_YOURREGISTERED','ثبت‌نام شما با موفقیت انجام شد، نامه‌ی فعال‌سازی شناسه‌ی‌کاربری شما به آدرس پست‌الکترونیکی که وارد کرده‌اید فرستاده شد، لطفا به پست‌الکترونیکی خود بروید و متن نامه را پیگیری کنید ');
define('_US_YOURREGMAILNG','شما ثبت‌نام شدید، ولی متاسفانه ارسال نامه‌ی فعال‌سازی برای شما با مشکل روبرو شد، این خطا را به مدیر سایت اطلاع دهید.');
define('_US_YOURREGISTERED2','شما ثبت نام شدید، باید منتظر بمانید تا مدیر سایت شناسه‌ی شما را فعال کند که این کمی زمان نیاز دارد، خواهش می‌کنیم صبر داشته باشید.');
// %s is your site name
...
define('_US_INVALIDNICKNAME','خظا: شناسه‌ی‌کاربری نادرست');
define('_US_NICKNAMETOOLONG','شناسه‌ی‌کاربری باید حد اکثر  %s نویسه باشد');
define('_US_NICKNAMETOOSHORT','شناسه‌ی کاربری باید حداقل %s نویسه باشد');
define('_US_NAMERESERVED','خطا : این شناسه وجود دارد');
define('_US_NICKNAMENOSPACES','شناسه‌ی کاربری نمی‌تواند فاصله داشته باشد');
...
define('_US_ENTERPWD','خطا : شما باید رمزعبور داشته باشید');
...
define('_US_ICQ','شماره‌ی ICQ');
define('_US_AIM','شناسه‌ی AIM');
define('_US_YIM','شناسه‌ی YIM');
define('_US_MSNM','شناسه‌ی MSNM');
...
define('_US_ALLABOUT','همه‌چیز درباره‌ی %s');
...
define('_US_PASSWORD','رمزعبور');
define('_US_TYPEPASSTWICE','برای تغییر رمزعبور دوبار رمزعبور جدید را وارد کنید');
define('_US_SAVECHANGES','ذخیره‌ی تغییرات');
define('_US_NOEDITRIGHT','متاسفانه شما دسترسی برای تغییر ویژگی‌‌های فردی این کاربر را ندارید');
define('_US_PASSNOTSAME','دو واژه‌ی رمز با یکدیگر تفاوت دارند، هر دو باید یکی باشند');
define('_US_PWDTOOSHORT','متاسفانه، طول رمزعبور باید حداقل<b>%s</b> نویسه باشد');
...
define('_US_ADMINNO','کاربری که عضو گروه گردانندگان سایت (وب مستر‌ها) است را نمی‌توانید حذف کنید');
