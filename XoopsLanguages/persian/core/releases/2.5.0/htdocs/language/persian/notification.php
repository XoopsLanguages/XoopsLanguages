...
define('_NOT_CONFIG_ENABLEDDSC','این ماژول به کاربران امکان می‌دهد از رویداد‌های سایت با خبر شوند، گزینه "بله" را برای فعال‌سازی این امکان انتخاب کنید');
...
define('_NOT_CONFIG_ENABLEDSC','این ماژول به کاربران امکان می‌دهد از رویداد‌های سایت با خبر شوند، گزینه "بله" را برای فعال‌سازی این امکان انتخاب کنید');
...
define('_NOT_NOTIFYMETHOD','روش اگهی‌: هنگامی که انجمنی را پیگیری می‌کنید به چه روشی می‌خواهید از رویداد‌های آن با خبر شوید؟');
...
define('_NOT_MODE_SENDALWAYS','آگهی از تمام رویداد‌های انتخاب شده');
