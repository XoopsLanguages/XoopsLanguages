...
define("_PROFILE_AM_PROF_ACCESS_DESC", 
        "<ul>" .
        "<li>گروه وب‌مستر‌ها: اگر کاربر عضو گروه وب‌مستر‌ها باشد, کاربر مورد نظر در صورتی دسترسی دارد که یکی از گروه ‌هایی که کاربر عضو آن است دسترسی گروه وب مستر ‌ها را داشته باشد; در غیر این صورت</li>" .
        "<li>گروهی غیر از گروه ‌های پایه: اگر کاربر عضو یک یا چند گروه غیر از گروه ‌های پایه باشد (یعنی  وب‌مستر‌ها, كاربران عضو, مهمان), کاربر مورد نظر در صورتی دسترسی دارد که گروه فعلی او اجازه دسترسی به یکی از گروه ‌های غیر اصلی سایت را بدهد; در غیر این صورت</li>" .
