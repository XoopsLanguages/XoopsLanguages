...
define('_AD_WARNINGXOOPSLIBINSIDE','هشدار امنیتی: شاخه %s در داخل شاخه ریشه سایت قرار دارد <br />برای امنیت بیشتر به شدت پیشن‌هاد میشود این شاخه را به خارج از ریشه سایت منتقل کنید.');
