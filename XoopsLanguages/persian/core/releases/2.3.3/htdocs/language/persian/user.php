...
define('_US_USERREG','توجه: پر کردن گزینه‌هایی که ستاره ندارند اختیاری است. در شناسه‌ی‌کاربری می‌توانید کلمات فارسی، نویسه‌های خاص مانند فاصله و غیره را به کار ببرید. شناسه را با دقت انتخاب کنید چون برای تغییر آن باید با یکی از مدیران سایت تماس بگیرید. حداکثر اندازه برای شناسه‌های انگلیسی ۲۵ و برای شناسه‌های فارسی ۱۲ نویسه، بدون در نظر‌گرفتن فاصله (Space) است. 
در پر کردن پست‌الکترونیکی دقت کنید چون اگر غلط نوشته شده‌باشد نامه‌ی فعال‌سازی به دست شما نمی‌رسد. پست‌الکترونیکی را به صورت مثال روبرو بدون www وارد کنید : ali@yahoo.com<br><br>ثبت‌کاربر');
