<?php
// $Id: xoopslists.php 1435 2008-04-06 14:47:51Z phppp $
//  ------------------------------------------------------------------------ //
...
//Start add 30 minuts by 30 minuts time zone hacked by irmtfan ( www.jadoogaran.org )
                     $time_zone_list = array ("-12" => _TZ_GMTM12,"-11.5" => _TZ_GMTM115,"-11" => _TZ_GMTM11,"-10.5" => _TZ_GMTM105, "-10" => _TZ_GMTM10,"-9.5" => _TZ_GMTM95, "-9" => _TZ_GMTM9,"-8.5" => _TZ_GMTM85, "-8" => _TZ_GMTM8,"-7.5" => _TZ_GMTM75, "-7" => _TZ_GMTM7,"-6.5" => _TZ_GMTM65, "-6" => _TZ_GMTM6,"-5.5" => _TZ_GMTM55, "-5" => _TZ_GMTM5,"-4.5" => _TZ_GMTM45, "-4" => _TZ_GMTM4, "-3.5" => _TZ_GMTM35, "-3" => _TZ_GMTM3,"-2.5" => _TZ_GMTM25, "-2" => _TZ_GMTM2,"-1.5" => _TZ_GMTM15, "-1" => _TZ_GMTM1,"-0.5" => _TZ_GMTM05, "0" => _TZ_GMT0,"0.5" => _TZ_GMTP05, "1" => _TZ_GMTP1,"1.5" => _TZ_GMTP15, "2" => _TZ_GMTP2,"2.5" => _TZ_GMTP25, "3" => _TZ_GMTP3, "3.5" => _TZ_GMTP35, "4" => _TZ_GMTP4, "4.5" => _TZ_GMTP45, "5" => _TZ_GMTP5, "5.5" => _TZ_GMTP55, "6" => _TZ_GMTP6,"6.5" => _TZ_GMTP65, "7" => _TZ_GMTP7,"7.5" => _TZ_GMTP75, "8" => _TZ_GMTP8,"8.5" => _TZ_GMTP85, "9" => _TZ_GMTP9, "9.5" => _TZ_GMTP95, "10" => _TZ_GMTP10,"10.5" => _TZ_GMTP105, "11" => _TZ_GMTP11,"11.5" => _TZ_GMTP115, "12" => _TZ_GMTP12);
//End add 30 minuts by 30 minuts time zone hacked by irmtfan ( www.jadoogaran.org )		
