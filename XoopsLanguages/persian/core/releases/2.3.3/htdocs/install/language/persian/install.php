...
define("DB_CHARSET_HELP",  "MySQL از مجموعه نویسههایی پشتیبانی می‌کند که شما را قادر می‌سازد که داده را با استفاده از مجموعه‌های مختلفی از نویسهها ذخیره کنید و براساس دسته‌ای از مجموعه ها، مقایسه انجام دهید.");
