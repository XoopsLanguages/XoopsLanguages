...
define("_SR_ALL","Nir'(AND)");
define("_SR_EXACT","Terevain Utuina");
define("_SR_SHOWALLR","Uuvein ilya alata");
define("_SR_NEXT","Ento >>");
define("_SR_PREVIOUS","<< Yana");
