...
define("_SR_PLZENTER","براۓ مھربانی تمام لازمی ڈیٹا داخل کریں!");
define("_SR_SEARCHRESULTS","تلاش کے نتائج");
define("_SR_NOMATCH","کوئ مشابہ نتیجہ نہیں ملا ");
define("_SR_FOUND","ملا <strong>%s</strong> مشابہ(es)");
define("_SR_SHOWING","(دکھا رہا ہے %d - %d)");
define("_SR_ANY","کوئ (OR)");
define("_SR_ALL","سارا (AND)");
define("_SR_EXACT","مشابہت");
define("_SR_SHOWALLR","سارے نتائج دکھایئں");
define("_SR_NEXT","آگے >>");
define("_SR_PREVIOUS","<< پیچھے");
