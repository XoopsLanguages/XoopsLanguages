...
define("_AM_CTYPE","Tipo di contenuto");
define("_AM_HTML","HTML");
define("_AM_PHP","PHP");
define("_AM_AFWSMILE","Formattazione automatica [Html+BBcode] (faccine abilitate)");
define("_AM_AFNOSMILE","Formattazione automatica [Html+BBcode] (faccine disabilitate)");
define("_AM_SUBMIT","Invia");
define("_AM_CUSTOMHTML","Blocco personalizzato (HTML)");
define("_AM_CUSTOMPHP","Blocco personalizzato (PHP)");
define("_AM_CUSTOMSMILE","Blocco personalizzato (Formattazione automatica con faccine)");
define("_AM_CUSTOMNOSMILE","Blocco personalizzato (Formattazione automatica senza faccine)");
define("_AM_DISPRIGHT","Mostra solo i blocchi laterali di destra");
define("_AM_SAVECHANGES","Salva le modifiche");
define("_AM_EDITBLOCK","Modifica Blocco");
