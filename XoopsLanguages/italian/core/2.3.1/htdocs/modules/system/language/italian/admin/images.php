...
define('_MD_IMGCATRGRP','Seleziona i gruppi che possono utilizzare le immagini:<br /><br /><span style="font-weight: normal;">A questi gruppi &egrave; consentito di utilizzare le immagini ma non di caricarle sul server. Il gruppo dei webmaster ha accesso automatico.</span>');
define('_MD_IMGCATWGRP','Scegli i gruppi cui &egrave; consentito caricare le immagini sul server:<br /><br /><span style="font-weight: normal;">Tipicamente consentito al gruppo moderatori e amministratori.</span>');
define('_MD_IMGCATWEIGHT','Peso della categoria:');
