...
define("_PROFILE_AM_PROF_VISIBLE_ON","Campo visualizzato nel profilo di questi gruppi");
define("_PROFILE_AM_PROF_VISIBLE_FOR","Visualizzazione nel profilo del campo attivata per i seguenti gruppi");
define("_PROFILE_AM_PROF_VISIBLE","Visualizzazione campi");
define("_PROFILE_AM_PROF_EDITABLE","Modificabile dall'utente nel profilo");
define("_PROFILE_AM_PROF_REGISTER","Inserito nel modulo di registrazione");
define("_PROFILE_AM_PROF_SEARCH","Utilizzabile come parametro nella ricerca");
define("_PROFILE_AM_PROF_ACCESS","Accesso ai profili in base al gruppo");
...
define("_PROFILE_AM_FIELDVISIBLEON"," quando accedono al profilo di ");
...
define("_PROFILE_AM_VALUE","Testo visualizzato");
...
define("_PROFILE_MA_USERLEVEL","Livello Utente");
...
define("_PROFILE_AM_STEPSAVE","Salvataggio al termine");
