...
define("_US_NOPROBLEM","Inserisci l'indirizzo email utilizzato durante la registrazione e riceverai quanto prima una nuova password.");
...
define("_US_ALLOWVIEWEMAIL","Permettere ad altri utenti di vedere il mio indirizzo email");
