...
define("_AM_AYSYWTDU","Sei sicuro di voler eliminare l'utente %s?");
...
define("_AM_GO","Ok");
define("_AM_ADDUSER","Nuovo Utente");
...
define("_AM_NOTACTIVE","Questo utente non &egrave; stato attivato. Si desidera attivare l'account dell'utente?");
...
define("_AM_USERPOST","Messaggi inviati dall'utente");
define("_AM_STORIES","Articoli");
define("_AM_COMMENTS","Commenti");
define("_AM_PTBBTSDIYT","Premere il pulsante che segue per sincronizzare i dati, se si ritiene che il numero dei messaggi inviati dall'utente non corrisponda al valore presente nel database.<br />");
define("_AM_SYNCHRONIZE","Sincronizza");
define("_AM_USERDONEXIT","L'utente non esiste!");
define("_AM_STNPDNM","Spiacenti, le due password sono diverse. Tornare indietro e ripetere l'operazione.");
