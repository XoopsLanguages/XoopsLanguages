...
define('_AUTH_LDAP_XOOPS_USER_NOTFOUND',"Spiacente, per la connessione: %s <br /> non &egrave; stata trovata alcuna informazione per l'utente nel database Xoops. Per favore verificate i dati dell'utente o attivate la gestione automatica");
