...
define("_MI_NEWS_IMAGE_MAX_WIDTH","Максимальная ширина изображения, до которой нужно изменить");
define("_MI_NEWS_IMAGE_MAX_HEIGHT","Максимальная высота изображения, до которой нужно изменить");
?>