...
// _LANGCODE: ru
// _CHARSET : UTF-8
// Translator: 2010-01-26 andrey3761
...
define('_PROFILE_AM_VALIDATIONNAME', 'Правило проверки');
define('_PROFILE_AM_VALIDATION', 'Проверка (JSON)');
define('_PROFILE_AM_VALIDATION2', 'Проверка (POST)');
define('_AM_NOTHING_SELECTED', 'Ничего не выбрано');

define("_AM_RULE_ID", "ID правила");
define("_AM_RULE_TYPE", "Тип правила");
define("_AM_RULE_WEIGHT", "Вес правила");
define("_AM_RULE_ACTION", "Функция запускаемая правилом");
define("_AM_FORM_WEIGHT", "Вес");
define("_AM_FORM_TYPE", "Тип функции");
define("_AM_FORM_TYPE_DESC", "Это тип фукции, которая используется для проверки.");
define("_AM_FORM_ACTION", "Функция/Действие:");
define("_AM_FORM_VALIDATION_NEW", "Создание правила проверки!");
define("_AM_FORM_VALIDATION_EDIT", "Редактирование правила проверки!");
define("_AM_FORM_LISTINGRULES", "Это текущие правила проверки!");
define("_AM_RULE_NEW","Создать новую проверку!");

define("_AM_ACTION", "Действие");
define("_AM_RESET_ORDER", "Сохранить сортировку");
