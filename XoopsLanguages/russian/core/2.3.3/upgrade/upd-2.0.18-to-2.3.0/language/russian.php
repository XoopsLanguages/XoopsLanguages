...
define("LEGEND_XOOPS_MAINFILE_FORPROTECTOR","Xoops mainfile подготовка");
define("XOOPS_MAINFILE_LABEL_FORPROTECTOR","Если вам необходимо установить модуль <b>Защитника от GIJOE</b>, пожалуйста, вставьте файл <em>/extras/mainfile.dist.php.protector</em> в папку<em>/upgrade/" . basename(dirname(dirname(__FILE__))) . "/mainfile.dist.php</em> " .
                                            " (Убедитесь в том, что вы изменили имя скопированного файла на <em>mainfile.dist.php</em>).<br />" .
                                            "Если модуль <b>Защитника </b> уже установлен и работает корректно, игнорируйте этот шаг.");
?>