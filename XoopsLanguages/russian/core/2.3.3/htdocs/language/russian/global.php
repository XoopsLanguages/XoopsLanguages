...
define("_WARNINNOTWRITEABLE","WARNING: Folder %s is not writeable by the server. <br />Please change the permission of this folder.<br /> in Unix (777), in Win32 (readable)");
define("_WARNINXOOPSLIBINSIDE","WARNING: Folder %s is inside DocumentRoot! The is a folder where XOOPS and its modules will store some sensible code and information for more security.");
