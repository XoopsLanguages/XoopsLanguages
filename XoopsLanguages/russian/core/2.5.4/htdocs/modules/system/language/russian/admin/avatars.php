...
define("_AM_SYSTEM_AVATAR_CUSTOM","Аватары пользователей" );
...
define("_AM_SYSTEM_AVATAR_USERS","Пользователей, использующих этот аватар" );
define("_AM_SYSTEM_AVATAR_USE_FILE","Выбрать файлы: %s" );
