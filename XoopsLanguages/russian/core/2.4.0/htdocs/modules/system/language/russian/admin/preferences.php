<?php
// $Id: preferences.php 3397 2009-08-02 05:02:25Z wishcraft $
// _LANGCODE: ru
// _CHARSET : UTF-8
...
define("_MD_AM_SYSTEMKEY", "Уникальный ключ XOOPS");
define("_MD_AM_SYSTEMKEYDSC", "Этот ключ используется для уникальной идентификации Вашей CMS XOOPS");
...
define("_MD_AM_PROFILE_ALLOWED_GROUPS", "Группы имеющие доступ к профилям пользователей");
define("_MD_AM_PROFILE_ALLOWED_GROUPS_DESC", "Группы которым разрешен доступ к страницам профиля пользователей.");
