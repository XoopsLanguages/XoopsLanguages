...
define('_PLEASEWAIT','Prosím počkejte');
define('_FETCHING','Nahrávám...');
define('_TAKINGBACK','Přesměrovávám zpět...'); // Taking you back to where you were....
define('_LOGOUT','Odhlásit');
define('_SUBJECT','Předmět');
define('_MESSAGEICON','Obrázek zprávy');
define('_COMMENTS','Komentáře');
define('_POSTANON','Odeslat anonymně');
define('_DISABLESMILEY','Zakázat smajlíky');
define('_DISABLEHTML','Zakázat HTML');
define('_PREVIEW','Náhled');
define('_GO','Provést!');
define('_NESTED','Vnořené');
define('_NOCOMMENTS','Žádné komentáře');
define('_FLAT','Ploché');
define('_THREADED','Vlákno');
...
* xoops smilie
*/
define('_AM_ADDSMILE',' Vytvořit nového smajlíka');
...
define('_MONTH','1 týdnů');
define('_DATESTRING','j. n. Y. G:i:s'); // Y/n/j
define('_MEDIUMDATESTRING','j. n. Y. G:i'); // Y/n/j
