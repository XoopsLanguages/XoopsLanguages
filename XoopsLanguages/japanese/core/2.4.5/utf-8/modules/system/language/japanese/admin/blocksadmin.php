...
define("_AM_ADDBLOCK","新規ブロック追加");
define("_AM_LISTBLOCK","すべてのブロックを表示");
...
define("_AM_CBBOTTOMLEFT","中央ブロック - 下左");
define("_AM_CBBOTTOMRIGHT","中央ブロック - 下右");
define("_AM_CBBOTTOM","中央ブロック - 下");
define("_AM_CONTENT","コンテンツ");
define("_AM_OPTIONS","オプション");
define("_AM_CTYPE","コンテンツのタイプ");
define("_AM_HTML","HTML タグ");
define("_AM_PHP","PHP スクリプト");
define("_AM_AFWSMILE","自動フォーマット（顔文字有効）");
define("_AM_AFNOSMILE","自動フォーマット（顔文字無効）");
define("_AM_SUBMIT","送信");
define("_AM_CUSTOMHTML","カスタムブロック(HTML)");
define("_AM_CUSTOMPHP","カスタムブロック(PHP)");
define("_AM_CUSTOMSMILE","カスタムブロック(顔文字有効)");
define("_AM_CUSTOMNOSMILE","カスタムブロック(顔文字無効)");
define("_AM_DISPRIGHT","右ブロックのみ表示");
define("_AM_SAVECHANGES","変更を保存");
define("_AM_EDITBLOCK","ブロック編集");
define("_AM_SYSTEMCANT","システムブロックは削除できません！");
define("_AM_MODULECANT","このブロックを直接削除できません！ブロックを非表示にしたい時はモジュールを無効に設定してください");
define("_AM_RUSUREDEL","本当に削除してもいいですか？: ブロック <strong>%s</strong>");
define("_AM_NAME","名称");
