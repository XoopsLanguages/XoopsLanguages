...
define('_MD_IMGCATRGRP','イメージマネージャを使用するグループを選択してください。:<br /><br /><span style="font-weight: normal;">ここではイメージマネージャの画像を利用出来るグループを選択します。管理者は自動的に使用出来るようになります。</span>');
define('_MD_IMGCATWGRP','イメージマネージャで画像を登録出来るグループ:<br /><br /><span style="font-weight: normal;">通常、これは管理者のみの設定にします。</span>');
define('_MD_IMGCATWEIGHT','イメージマネージャ表示順序:');
