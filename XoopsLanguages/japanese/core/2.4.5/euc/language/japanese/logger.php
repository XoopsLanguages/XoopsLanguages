...
define('_LOGGER_DEBUG',"�ǥХå�");
define('_LOGGER_INCLUDED_FILES',"�����ե�����");
define('_LOGGER_FILES',"%s �ե�����");
define('_LOGGER_MEM_USAGE',"���ѥ���");
define('_LOGGER_MEM_ESTIMATED',"%s [Estimated]");
define('_LOGGER_NONE',"None");
define('_LOGGER_ALL',"All");
define('_LOGGER_ERRORS',"���顼");
define('_LOGGER_DEPRECATED',"Deprecated");
define('_LOGGER_QUERIES',"�����꡼");
define('_LOGGER_BLOCKS',"�֥�å�");
...
define('_LOGGER_E_USER_WARNING',"���");
define('_LOGGER_E_USER_ERROR',"���顼");
