...
define('_XOBJ_ERR_REQUIRED', '%s が必要');
define('_XOBJ_ERR_SHORTERTHAN', '%s は %d 字より短いのが必要.');
...
define('_ONLINEPHRASE', '<strong>%s</strong> 人のユーザが現在オンラインです。');
define('_ONLINEPHRASEX', '<strong>%s</strong> 人のユーザが <strong>%s</strong> を参照しています。');
...
define('_MUSTWABLE', 'ファイル %s への書き込み権限があるかどうか確認してください。'); // %s represents file name
// Module info
