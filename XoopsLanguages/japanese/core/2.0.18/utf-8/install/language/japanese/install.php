<?php
// $Id: finish.php 2008-07-25T16:41+09:00 2 8 6 $
...
define("_INSTALL_L15","mainfile.php を開き、必要なデータベース設定を記載して下さい。");
...
define("_INSTALL_L51","データベース");
define("_INSTALL_L66","使用する DB サーバの種類を選択して下さい。");
...
define("_INSTALL_L69","デフォルトは「いいえ」です。よく分からない場合は「いいえ」で構いません。");
define("_INSTALL_L55","XOOPS ドキュメントルートへのパス");
define("_INSTALL_L59","　XOOPSが設置されているディレクトリへのフルパスを入力してください。<br />　末尾には「/」を付加しないでください。");
define("_INSTALL_L56","XOOPSへのURL");
define("_INSTALL_L58","XOOPS にアクセスするURLを入力してください。<br />　末尾には「/」を付加しないでください。");
...
define("_INSTALL_L35","インストール中にエラーが発生している場合は各 XOOPS サイトへのサポートを要するかもしれません。");
define("_INSTALL_L36","サイト管理者のユーザ名・ユーザパスワード・メールアドレスを入れて下さい。");
...
define("_INSTALL_L88","設定を保存しています....");
