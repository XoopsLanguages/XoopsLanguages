...
define($constpref.'_DOS_CRSAFEDSC','Een perl regex patroon om de user-agent te herkennen.<br />Als het overeenkomt, zal de web-crawler nooit als ongewenst worden beschouwd.<br />eg) /(bingbot|Googlebot|Yahoo! Slurp)/i');
...
define($constpref.'_STOPFORUMSPAM_ACTIONDSC','Controleert POST data met spammers geregistreerd in de database van www.stopforumspam.com. PHP CURL lib vereist.');
}
