...
//toegevoegd in 2.5.5 RC
define('_PROFILE_AM_REQUIRED_TOGGLE','Verplicht veld instellen');
define('_PROFILE_AM_REQUIRED_TOGGLE_SUCCESS','Verplicht veld succesvol aangepast ');
define('_PROFILE_AM_REQUIRED_TOGGLE_FAILED','Verplicht veld niet succesvol aangepast');

define('_PROFILE_AM_SAVESTEP_TOGGLE','Opslaan instellen');
define('_PROFILE_AM_SAVESTEP_TOGGLE_SUCCESS',"'Opslaan na stap' succesvol aangepast");
define('_PROFILE_AM_SAVESTEP_TOGGLE_FAILED',"'Opslaan na stap' niet succesvol aangepast"); 
?>
