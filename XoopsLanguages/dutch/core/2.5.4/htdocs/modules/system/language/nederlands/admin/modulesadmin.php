...
define("_AM_SYSTEM_MODULES_BTOMADMIN","Terug naar de Modulebeheer pagina");
...
"<ul>
<li>Wanneer een nieuwe module geïnstalleerd is, vergeet dan niet de voorkeuren, blokken en gebruikerspermissies in te stellen.</li>
<li>Stel <b>menu</b> in om een module te verbergen in het blok Hoofdmenu.</li>
<li>Verwijder de bestanden van een ongebruikte module van de server om beveiligingsproblemen te voorkomen en de website veilig te houden.</li>
