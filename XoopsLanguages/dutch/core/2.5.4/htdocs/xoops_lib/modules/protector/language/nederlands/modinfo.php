...
define($constpref.'_DBTRAPWOSRV','_SERVER nooit controleren op anti-SQL-Injectie');
define($constpref.'_DBTRAPWOSRVDSC','Sommige servers activeren altijd DB Layer trapping. Het veroorzaakt verkeerde detecties als SQL injectie aanval. Schakel deze optie in, wanneer deze fouten voorkomen. Deze optie verzwakt de beveiliging van DB layer trapping anti-SQL-injection');

// Appended by Xoops Language Checker -GIJOE- in 2009-01-14 11:10:54
define($constpref.'_DBLAYERTRAP','Activeren DB Layer trapping anti-SQL-Injectie');
define($constpref.'_DBLAYERTRAPDSC','Bijna SQL injectie aanvallen zullen geannuleerd worden door deze functie. Deze functie vereist ondersteuning van de databasefactory. Controleer dit op de Beveiligingsadvies pagina.');

// Appended by Xoops Language Checker -GIJOE- in 2008-12-03 11:47:21
define($constpref.'_DEFAULT_LANG','Standaard taal');
define($constpref.'_DEFAULT_LANGDSC','Specificeer de taalset voor het weergeven van berichten voordat common.php wordt verwerkt');
...
define($constpref.'_HIJACK_DENYGP','Groepen die niet toegestaan zijn om van IP te wisselen in een sessie');
...
define($constpref.'_FILE_DOTDOTDSC','Verwijdert ".." uit alle verzoeken die op een bestandsspecificatie lijken');

define($constpref.'_BF_COUNT','Anti Brute Force');
define($constpref.'_BF_COUNTDSC','Zet de tijdsduur die je iemand geeft om in te loggen op 10 minuten. Als iemand er langer over doet om in te loggen dan deze tijd, dan zal zijn/haar IP verbannen/geblokt worden.');

define($constpref.'_BWLIMIT_COUNT','Bandbreedte beperking');
define($constpref.'_BWLIMIT_COUNTDSC','Geef de maximum toegang aan tot mainfile.php gedurende de controletijd. Deze waarde dient 0 te zijn voor normale omgevingen die genoeg CPU bandbreedte hebben. Een waarde minder dan 10 wordt genegeerd.');
...
//Toegevoegd in 2.5.4
define($constpref."_ADMINHOME","Overzicht");
define($constpref."_ADMINABOUT","Over");
