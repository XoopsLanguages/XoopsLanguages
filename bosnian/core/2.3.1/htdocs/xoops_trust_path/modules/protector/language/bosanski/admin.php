...
define('_MD_A_MYMENU_MYBLOCKSADMIN','Pode¹avanja');
...
define("_AM_EZ_TABLES","Ukupno tabela");
define("_AM_EZ_UPDATED","Datum aktuliziranja");
define("_AM_EZ_COPY","Kopiraj Bazu");
