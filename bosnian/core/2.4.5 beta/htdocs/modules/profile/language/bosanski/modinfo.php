...
define("_PROFILE_MI_PROFILE_MESSAGES","Privatne poruke aktivirati?");
define("_PROFILE_MI_PROFILE_MESSAGES_DESC", "korisnici mogu sa privatnim porukama komunicirati");
...
define("_PROFILE_MI_PROFILE_PICTURESMAXSPACE_DESC","ova memorija je zvakog pojedina&#269;nog &#269;lana koji koriste za upload svojih slika<br /> Odredi u Kilobyte (kb), stim je 1MB = 1024 kB");
define("_PROFILE_MI_PROFILE_PICTURESMAXSOLOSPACE","max. upload veli&#269;ina slike");
define("_PROFILE_MI_PROFILE_PICTURESMAXSOLOSPACE_DESC"," odredi kolika je max. veli&#269;ina slike u kb za upload.<br /> Odredi u Kilobyte (kb), stim je 1MB = 1024 kB");
define("_PROFILE_MI_PROFILE_PICTURESMAXHEIGTH","max. visina slike za upload");
define("_PROFILE_MI_PROFILE_PICTURESMAXHEIGTH_DESC","odredi max. visinu slike za upload.<br >U Pixelima");
define("_PROFILE_MI_PROFILE_PICTURESMAXWIDTH","max. &scaron;irina slike");
define("_PROFILE_MI_PROFILE_PICTURESMAXWIDTH_DESC","odredi max. &scaron;irinu slike za upload.<br >U Pixelima");
define("_PROFILE_MI_PROFILE_PERPAGE","Broj upisa/postova po stranici");
define("_PROFILE_MI_PROFILE_PERPAGE_DESC","Broj objekata u odgovaraju&#263;im kategorijama na stranici");
define("_PROFILE_MI_PROFILE_PICTURESTHUMBHEIGTH","max. visina pregledne slike");
define("_PROFILE_MI_PROFILE_PICTURESTHUMBHEIGTH_DESC","odredi max. visinu pregledne slike, ako slika bude ve&#263;a onda se automatski na ovu navedenu visinu umanjuje.<br >U Pixelima");
define("_PROFILE_MI_PROFILE_PICTURESTHUMBWIDTH","max. &scaron;irina pregledne slike");
define("_PROFILE_MI_PROFILE_PICTURESTHUMBWIDTH_DESC","odredi max. &scaron;irinu pregledne slike, ako slika bude ve&#263;a onda se automatski na ovu navedenu &scaron;irinu umanjuje.<br >U Pixelima");
define("_PROFILE_MI_PROFILE_AUDIOMAXSPACE","max. dozvoljena veli&#269;ina za MP3 za svakog &#269;lana");
define("_PROFILE_MI_PROFILE_AUDIOMAXSPACE_DESC","Odredi koliko veliki MP3 je dozvoljen za upload.<br />Odredba je u KB (kb), tako da je 1MB = 1024 kB");
define("_PROFILE_MI_PROFILE_WITHTUBE","&scaron;irina videa");
define("_PROFILE_MI_PROFILE_WITHTUBE_DESC","");
define("_PROFILE_MI_PROFILE_HEIGTHTUBE","visina videa");
define("_PROFILE_MI_PROFILE_HEIGTHTUBE_DESC","");
define("_PROFILE_MI_PROFILE_TRIBESMAX","max. broj Grupa koje &#269;lan moze kreirati");
//ADD in 1.69
define("_PROFILE_MI_PROFILE_FACEBOOKTITLE","Facebook");
define("_PROFILE_MI_PROFILE_FACEBOOK","Facebook aktivirati");
...
define("_PROFILE_MI_PROFILE_SCRAPSTITLE","Knjiga gostiju");
define("_PROFILE_MI_PROFILE_FRIENDSTITLE","Lista Prijatelja");
define("_PROFILE_MI_PROFILE_PICTURESTITLE","Slike");
define("_PROFILE_MI_PROFILE_AUDIOSTITLE","Muzika");
define("_PROFILE_MI_PROFILE_VIDEOSTITLE","Video");
define("_PROFILE_MI_PROFILE_GROUPSTITLE","Grupe");
?>