...
define('_NOT_BOOKMARK_NOTIFY','Prati ovo');
define('_NOT_BOOKMARK_NOTIFYCAP','Prati ovo  (bez obavijesti).');
define('_NOT_BOOKMARK_NOTIFYDSC','Prati ovo bez dobijanja obavijesti o promjenama.');
