...
define('_MD_AM_TEMPLATE_DELETE_OLD_ERROR','Gre&scaron;ka: Brisanje starijih Template %s nije uspjelo. Prekinuta aktulizacija ovoga podatka. ');
...
define('_MD_AM_BLOCK_ACCESS','Dodavanje odobrenje pristupa bloku');
define('_MD_AM_BLOCK_ACCESS_ERROR','Gre&scaron;ka: Nemo&#382;e se dati odobrenje pristupa bloku');
define('_MD_AM_BLOCK_ADD','Blok %s je dodat ');
define('_MD_AM_BLOCK_ADD_ERROR','Gre&scaron;ka: Nemo&#382;e se dati blok %s u bazu podataka! ');
define('_MD_AM_BLOCK_ADD_ERROR_DATABASE','Gre&scaron;kau bazi podataka: %s ');
define('_MD_AM_BLOCK_CREATED','Blok %s je kreiran ');
define('_MD_AM_BLOCK_DELETE','Blok %s je izbrisan. ');
define('_MD_AM_BLOCK_DELETE_DATA','Blok template %s je izbrisan iz baze podataka. ');
define('_MD_AM_BLOCK_DELETE_ERROR','Gre&scaron;ka: Nemo&#382;e se izbrisati blok %s');
define('_MD_AM_BLOCK_DELETE_TEMPLATE_ERROR','Gre&scaron;ka: Nemo&#382;e se izbrisati blok template %s iz baze podataka');
define('_MD_AM_BLOCK_DEPRECATED','Blok template %s nije odobren ');
define('_MD_AM_BLOCK_DEPRECATED_ERROR','Gre&scaron;ka: Nemo&#382;e se izbrisati neodobren blok template.  ');
define('_MD_AM_BLOCK_UPDATE','Blok %s je aktuliziran. ');

/* Configs */
define('_MD_AM_GONFIG_ID','Config ID: %s');
define('_MD_AM_MODULE_DATA_ADD','Dodat je za modul config podatak...');
define('_MD_AM_MODULE_DATA_DELETE','Brisanje od modula config opcije...');
define('_MD_AM_MODULE_DATA_UPDATE','Modula podaci su aktulizirani.');

define('_MD_AM_CONFIG_ADD',' Config opcije su dodate');
define('_MD_AM_CONFIG_DATA_ADD',' Config %s je dodat u bazu podataka');
define('_MD_AM_CONFIG_DATA_ADD_ERROR',' Gre&scaron;ka: Nemo&#382;e se unijeti config %s u bazu podataka. ');
define('_MD_AM_GONFIG_DATA_DELETE','Config podatak je izbrisan iz baze podataka. ');
define('_MD_AM_CONFIG_DATA_DELETE_ERROR','Gre&scaron;ka: Nemo&#382;e se izbrisati config podatak iz baze podataka');

/* Access */
define('_MD_AM_GROUP_SETTINGS_ADD','Odobrenja za Grupe...');

define('_MD_AM_GROUP_PERMS_DELETE_ERROR','Gre&scaron;ka: Nemogu se izbrisati odobrenja za grupe');
define('_MD_AM_GROUP_PERMS_DELETED','Odobrenja za grupe su izbrisane ');

define('_MD_AM_ACCESS_ADMIN_ADD','Dadat je admin odobrenje pristupa grupama sa Grupe ID %s');
define('_MD_AM_ACCESS_ADMIN_ADD_ERROR','Gre&scaron;ka: Nemo&#382;e se dodati admin odobrenje pristupa grupama sa Grupom ID %s');
define('_MD_AM_ACCESS_USER_ADD_ERROR','Dodato je pravo pristupa &#269;lanovima Grupi sa ID: %s');
define('_MD_AM_ACCESS_USER_ADD_ERROR_ERROR','Gre&scaron;ka: Nemo&#382;e se dodati pravo pristupa &#269;lanovima Grupi sa ID: %s');

// execute module specific install script if any
define('_MD_AM_FAILED_EXECUTE','Naredba nije uspjela %s');
define('_MD_AM_FAILED_SUCESS','%s naredba je uspjela.');

define('_MD_AM_DELETE_ERROR','Gre&scaron;ka: Nemo&#382;e se izbrisati %s');
define('_MD_AM_UPDATE_ERROR','Gre&scaron;ka: Nemo&#382;e se aktulizirati %s');
define('_MD_AM_DELETE_MOD_TABLES','Brisanje tabela od modula...');

define('_MD_AM_COMMENTS_DELETE','Brisanje komentara...');
define('_MD_AM_COMMENTS_DELETE_ERROR','Gre&scaron;ka: Komentari se nemogu izbrisati');
define('_MD_AM_COMMENTS_DELETED','Komentari su izbrisani');

define('_MD_AM_NOTIFICATIONS_DELETE','Brisanje obavijesti...');
define('_MD_AM_NOTIFICATIONS_DELETE_ERROR','Gre&scaron;ka: Nemogu se obavijesti izbrisati');
define('_MD_AM_NOTIFICATIONS_DELETED','Obavijesti su izbrisane');

define('_MD_AM_TABLE_DROPPED','Table %s je izba&#269;ena!');
define('_MD_AM_TABLE_DROPPED_ERROR','Gre&scaron;ka: Nemogu se izbaciti table %s');
define('_MD_AM_TABLE_DROPPED_FAILDED','Gre&scaron;ka: Nije ti dozvoljeno table %s izbaciti iz baze!');
?>