...
define('_TPLSADMIN_FMT_MSG_ENCLOSEBYCOMMENT' , '%d template caches su bile zatvorene sa tplsadmin komentarima' ) ;
define('_TPLSADMIN_DT_ENCLOSEBYCOMMENT' , 'Implemitiraj komentare' ) ;
define('_TPLSADMIN_DD_ENCLOSEBYCOMMENT' , 'Dva HTML komentara bi&#263;e implementirani u the begging/ending point of each templates. Since this rarely breaks its design, it is recommended to professionals can read HTML itself' ) ;
