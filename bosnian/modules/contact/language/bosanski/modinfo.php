...
define("_MI_CONTACT_ALLOWSENDCONFIRM", "Potvrdni mail omoguæi?" );
define("_MI_CONTACT_ALLOWSENDCONFIRMDSC", "DA - Poka¾i posjetiocu Checkbox "
                                 ."kod aktiviranja Checkbox-a  po¹aljilac æe dobiti potvrdni mail." );
...
define("_MI_CONTACT_INTRO_DESC", "Ovo upustvo stoji ustvari u <b>Kontakt formularu</b>. Sadr¾aji na koje se misli su npr. Pozdrav, Adresa za kontakt ili upustvo i opis dolaska na odreðeno mjesto." );
...
define("_MI_CONTACT_SITEKEY", "Sluèajni kljuè?" );
define("_MI_CONTACT_SITEKEYDSC", "Sluèajni izbor brojeva i slova za <b>Sigurnosnu-Provjeru.</b>" );
...
define("_MI_CONTACT_SHOWDEPT", "Prikaz Podruèja-Izabranog?");
define("_MI_CONTACT_SHOWDEPTDSC", "DA - Prika¾i izabrano polje za definisano podruèje<br />"
                                 ."Ako nisu podruèja data, onda æe sva pitanja preko Kontakt formulara biti na Admin-email poslati." );

define("_MI_CONTACT_DEPTTITLE", "Podruèje-Uvoda?");
define("_MI_CONTACT_DEPTTITLEDSC", "Oznaèi ime polja zaizabrano izabrano podruèje.");

define("_MI_CONTACT_DEPT", "Podruèja?" );
define("_MI_CONTACT_DEPTDSC", "Ovde mo¾e¹ razne primaoce sa liènom njihovom Email-Adresom za podruèje definisati."
							 ." Podruèje i Mail podruèje sa zarezom i bez praznog razmaka upi¹i!<br /><br />"
							 ." Vi¹e podruèja sa ovom oznakom '|'rastavi bez praznog razmaka!" );
...
define("_MI_CONTACT_SHOWMOREINFODSC", "DA - Prika¾i podruèje sa Checkboxom");									   							 

define("_MI_CONTACT_MOREINFOTITLE", "Ime polja za dodatniinfo?" );
define("_MI_CONTACT_MOREINFOTITLEDSC", "Oznaèi ime polja za dodatni info u Kontakt formularu" );
