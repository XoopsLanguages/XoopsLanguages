...
define("_MI_MYLINKS_DESC","Tworzy sekcjê, gdzie u¿ytkownicy mog± wyszukiwaæ/dodawaæ/oceniaæ ró¿ne strony WWW.");
...
define("_MI_MYLINKS_ADMENU2","Dodaj/Usuñ Linki");
...
define('_MI_MYLINKS_USESHOTS','U¿yæ screenshotu?');
define('_MI_MYLINKS_USEFRAMES','U¿yæ ramek?');
define('_MI_MYLINKS_SHOTWIDTH','Wymiary screenshotu');
define("_MI_MYLINKS_ANONPOST","Zezwoliæ na dodawanie linków przez nie zarejestrowanych u¿ytkowników?");
define('_MI_MYLINKS_AUTOAPPROVE','Zezwoliæ na automatyczna akceptacje linków?');

// Description of each config items
define('_MI_MYLINKS_POPULARDSC','Liczba klikniêæ ¿eby link sta³ sie popularny');
define('_MI_MYLINKS_NEWLINKSDSC','Maksymalna liczba nowych linków wy¶wietlanych na stronie');
define('_MI_MYLINKS_PERPAGEDSC','Maksymalna liczba linków wy¶wietlanych na stronie');
define('_MI_MYLINKS_USEFRAMEDSC','Wybierz je¶li chcesz wy¶wietlaæ w ramce twojej strony');
define('_MI_MYLINKS_USESHOTSDSC','Wybierz TAK by wy¶wietlaæ screenshoty dla ka¿dego linku');
define('_MI_MYLINKS_SHOTWIDTHDSC','Wprowad¼ maksymaln± szeroko¶æ screenshota');
