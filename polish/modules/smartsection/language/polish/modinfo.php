...
define("_MI_SSECTION_ADMENU1", "Strona główna");
define("_MI_SSECTION_ADMENU2", "Kategorie");
define("_MI_SSECTION_ADMENU3", "Artykuły");
define("_MI_SSECTION_ADMENU4", "Uprawnienia");
define("_MI_SSECTION_ADMENU5", "Bloki i grupy");
define("_MI_SSECTION_ADMENU6", "Typy plików");
define("_MI_SSECTION_ADMENU7", "Idź do modułu");

define('_MI_SSECTION_ALLOWADMINHITS'            , '[OPCJE TREŚCI] Licznik czytań administratora:');
define('_MI_SSECTION_ALLOWADMINHITSDSC'         , 'Czy włączyć odwiedziny administratora do statystyk?');
define('_MI_SSECTION_ALLOWCOMMENTS'             , "[UPRAWNIENIA] Kontrola komentarzy na poziomie artykułów:");
define('_MI_SSECTION_ALLOWCOMMENTSDSC'          , "Jeśli wybierzesz 'Tak' to będziesz widział komentarze dla artykułów, które na to pozwalają (mają zaznaczony checkbox komentarzy). <br /><br />Jeśli wybierzesz 'Nie' komentarze będą zarządzane na poziomie globalnym (popatrz na podpunkt 'Zasady komentowania'.");
define("_MI_SSECTION_ALLOWSUBMIT"               , "[UPRAWNIENIA] Dodawanie artykułów przez użytkowników:");
define("_MI_SSECTION_ALLOWSUBMITDSC"            , "Pozwolić na dodawanie artykułów przez użytkowników?");
define("_MI_SSECTION_ALLOWUPLOAD"               , "[UPRAWNIENIA] Dodawanie plików przez użytkowników");
define("_MI_SSECTION_ALLOWUPLOADDSC"            , "Pozwolić użytkownikom na dodawanie plików związanych z artykułami?");
define("_MI_SSECTION_ANONPOST"                  , "[UPRAWNIENIA] Pozwolić na anonimowe dodawanie artykułów");
define("_MI_SSECTION_ANONPOSTDSC"               , "Pozwolić użytkownikom na dodawnie artykułów.");
define('_MI_SSECTION_AUTOAPPROVE_SUB_ITEM'      , "[UPRAWNIENIA] Automatyczne aprobowanie artykułów:");
define('_MI_SSECTION_AUTOAPPROVE_SUB_ITEMDSC'   , "Automatyczne aprobowanie artykułów bez proszenia o zgodę administratora.");
...
define('_MI_SSECTION_CATPERPAGE'                , '[OPCJE FORMATOWANIA] Ilość kategorii na stronie:');
define('_MI_SSECTION_CATPERPAGEDSC'             , 'Maksymalna ilość głównych kategorii na stronie widocznych od razu dla użytkownika.');
...
define('_MI_SSECTION_DATEFORMATDSC'             , 'Użyj końcowej części pliku language/english/global.php aby wybrać styl prezentowania daty. Na przykład "d-M-Y H:i" pokaże "30-Mar-2004 22:35"');
...
define("_MI_SSECTION_DISCOM"					, "[TREŚĆ] Display comment count?");
define("_MI_SSECTION_DISCOMDSC"					, "Set to 'Yes' to display the comments count in the individual article");
define("_MI_SSECTION_DISDATECOL"				, "[TREŚĆ] Display the 'Published on' column?");
...
define('_MI_SSECTION_DISPLAY_CAT_SUMMARY'       , "[OPCJE TREŚCI] Pokazać podsumowanie kategorii?");
define('_MI_SSECTION_DISPLAY_CAT_SUMMARY_DSC'   , "Wybierz 'Tak' aby pokazywać podsumowanie kategorii w module.");
define("_MI_SSECTION_DISPLAY_CATEGORY"          , "Pokazywać nazwę kategorii?");
define("_MI_SSECTION_DISPLAY_CATEGORY_DSC"      , "Wybierz 'Tak' aby pokazać link do kategorii w artykule");
define('_MI_SSECTION_DISPLAYTYPE_FULL'          , "Widok pełny");
...
define("_MI_SSECTION_DISSBCATDSC"				, "[TREŚĆ] Display sub-categories description?");
...
define('_MI_SSECTION_FILEUPLOADDIRDSC'          , "Katalog do którego będą importowane pliki załączone do artykułów. W nazwie nie wpisuj zadnych '/' ani z przodu ani w trakcie??? (  Do not include any leading nor trailing slashes.)");
define('_MI_SSECTION_FOOTERPRINT'               , '[OPCJE DRUKOWANIA] Stopka strony');
define('_MI_SSECTION_FOOTERPRINTDSC'            , 'Stopka, która będzie drukowana dla każdego artykułu');
...
define('_MI_SSECTION_HEADERPRINT'               , '[OPCJE DRUKOWANIA] Nagłówek strony');
define('_MI_SSECTION_HEADERPRINTDSC'            , 'Nagłówek, który będzie drukowany dla każdego artykułu');
define('_MI_SSECTION_HELP_CUSTOM'               , "Ścieżka dowolna");
define('_MI_SSECTION_HELP_INSIDE'               , "W środku modułu - pomoc zawarta w module");
define('_MI_SSECTION_HELP_PATH_CUSTOM'          , "Ścieżka pokazująca lokalizację plików pomocy dla SmartSection");
define('_MI_SSECTION_HELP_PATH_CUSTOM_DSC'      , "Jeśli używasz ścieżki z wcześniejszej opcji, napisz tu URL do plików pomocy SmartSection, w formacie : http://www.nazwatwojejstrony.com/doc");
define('_MI_SSECTION_HELP_PATH_SELECT'          , "Ścieżka do plików pomocy dla SmartSection");
define('_MI_SSECTION_HELP_PATH_SELECT_DSC'      , "Wybierz gdzie mają być dostępne pliki pomocy dla SmartSection help files. Jeśli ściągąłeś 'Pakiet pomocy dla SmartSection' i wczytałeś ja do 'modules/smartsection/doc/', wybiesz 'Ścieżka w środku modułu'. Możesz też używać plików pomocy dla modułu bezpośrednio ze strony docs.xoops.org robiąc taki wybór. Możesz też wybrać 'Ścieżkę dowolną' i samemu wskazać położenie plików pomocy w poniższym polu");
define("_MI_SSECTION_HITSCOL"					, "[TREŚĆ] Wyświetlać kolumnę z liczbą odsłon?");
...
define("_MI_SSECTION_HLCOLOR"					, "[OPCJE FORMATOWANIA] Kolor zaznaczenia szukanych słów");
define("_MI_SSECTION_HLCOLORDSC"				, "Podczas wyszukiwania słowa wpisane w wyszukiwarce zostaną podświetlone na wybrany kolor");
...
define('_MI_SSECTION_INDEXFOOTER'               , '[OPCJE TREŚCI] Stopka na stronie administracyjnej');
define('_MI_SSECTION_INDEXFOOTER_SEL'           , 'Stopka indeksu');
define('_MI_SSECTION_INDEXFOOTERDSC'            , 'Stopka, która będzie wyświetlana na stronie administracyjnej modułu');
define('_MI_SSECTION_INDEXMSG'         			, '[OPCJE TREŚCI] Wiadomość powitalna:');
define('_MI_SSECTION_INDEXMSGDEF'				, "");
define('_MI_SSECTION_INDEXMSGDSC' 				, 'Wiadomość powitalna wyświetlana na stronie głównej modułu.');
...
define("_MI_SSECTION_ITEMFOOTER"				, "[TREŚĆ] Item footer");
...
define("_MI_SSECTION_LASTITEM"			, "[TREŚĆ] Display last item column ?");
define("_MI_SSECTION_LASTITEMDSC"		, "Select 'Yes' to display the last item in each category in the index and category page.");
define("_MI_SSECTION_LASTITEMS"			, "[TREŚĆ] Display the list of newly published articles?");
define("_MI_SSECTION_LASTITEMSDSC"		, "Select 'Yes' to have the list at the bottom of the first page of the module");
define('_MI_SSECTION_LASTITSIZE'		, '[OPCJE FORMATOWANIA] Wielkość ostatniego artykułu:');
define('_MI_SSECTION_LASTITSIZEDSC'		, "Ustaw maksymalną długość tytułu dla ostatniego obiektu.");
define('_MI_SSECTION_LINKED_PATH'		, '[OPCJE FORMATOWANIA] Podebnij linki do aktualnej ścieżki:');
define('_MI_SSECTION_LINKED_PATHDSC'	, "Wybierz 'Tak' jeśli chcesz by użytkownik mógł się cofać przez kliknięcie na aktualna ścieżkę prezentowana w górze artykułu.");
...
define('_MI_SSECTION_NO_FOOTERS'		, 'Żaden ');
define('_MI_SSECTION_ORDERBY'			, '[OPCJE FORMATOWANIA] Sortuj obiekty według:');
define("_MI_SSECTION_ORDERBY_DATE"		, "Daty malejąco");
define("_MI_SSECTION_ORDERBY_TITLE"		, "Tytułu rosnąco");
define("_MI_SSECTION_ORDERBY_WEIGHT"	, "Wagi rosnąco");
define('_MI_SSECTION_ORDERBYDSC'		, 'Wybierz "Tak" aby każdy obiekt w kategorii był sortowany według daty, w przeciwnym wypadku artykuły będą sortowane według wagi.');
define('_MI_SSECTION_OTHER_ITEMS_TYPE'	, '[OPCJE FORMATOWANIA] Prezentacja pozostałych artykułów ');
define('_MI_SSECTION_OTHER_ITEMS_TYPE_ALL'	, "Wszystkie artykuły");
define('_MI_SSECTION_OTHER_ITEMS_TYPE_DSC'	, 'Wybierz, jak chcesz przedstawić dla użytkownika inne artykuły z tej kategorii.');
define('_MI_SSECTION_OTHER_ITEMS_TYPE_NONE'	, "Żaden ");
define('_MI_SSECTION_OTHER_ITEMS_TYPE_PREVIOUS_NEXT', "Wcześniejszy i następny");
define('_MI_SSECTION_PERPAGE'				, "[OPCJE FORMATOWANIA] Maksymalna ilość artykułów na stronie administratora:");
define('_MI_SSECTION_PERPAGEDSC'			, "Maksymalna ilość artykułów pokazywana od razu na stronie administratora.");
define('_MI_SSECTION_PERPAGEINDEX'			, "[OPCJE FORMATOWANIA] Maksymalna ilość artykułów na stronie użytkownika:");
define('_MI_SSECTION_PERPAGEINDEXDSC'		, "[OPCJE DRUKOWANIA] Maksymalna ilość artykułów pokazywana od razu na stronie użytkownika.");
define('_MI_SSECTION_PRINTLOGOURL'			, '[OPCJE DRUKOWANIA] URL do logo');
define('_MI_SSECTION_PRINTLOGOURLDSC'		, 'URL do loga, które będzie pokazane na górze strony.');
define("_MI_SSECTION_RECENTITEMS"			, "Recent items (Detail)");
define("_MI_SSECTION_SHOW_RSS"				,"[TREŚĆ] Wyświetlić link do kanału RSS");
define("_MI_SSECTION_SHOW_RSSDSC"			,"");
define('_MI_SSECTION_SHOW_SUBCATS'			, "[OPCJE TREŚCI] Pokaż podkategorii na stronie administratora");
define("_MI_SSECTION_SHOW_SUBCATS_ALL"		, "Wyświetlić wszystkie podkategorie");
define('_MI_SSECTION_SHOW_SUBCATS_DSC'		, "Wybierz 'Tak' aby pokazać listę podkategorii na stronie modułu");
...
define("_MI_SSECTION_SUB_SMNAME1"			, "Dodaj artykuł");
define("_MI_SSECTION_SUB_SMNAME2"			, "Popularne artykuły");
define('_MI_SSECTION_SUBMITMSG'				, '[OPCJE TREŚCI] Informacja widoczna w czasie dodawania:');
define('_MI_SSECTION_SUBMITMSGDEF'			, "");
define('_MI_SSECTION_SUBMITMSGDSC'			, 'Informacja pokazywana na stronie modułu, która umożliwa wysłanie pliku.');
define('_MI_SSECTION_TITLE_SIZE'			, "[OPCJE FORMATOWANIA] Długość tytułu :");
define('_MI_SSECTION_TITLE_SIZEDSC'			, "Określ maksymalna długość tytułu dla pojedynczego elementu na stronie z listami.");
...
define('_MI_SSECTION_USEREALNAME'			, '[OPCJE FORMATOWANIA] Użyj prawdziwych nazw użytkowników');
define('_MI_SSECTION_USEREALNAMEDSC'		, 'Wybierz "Tak" aby pokazać prawdziwę imię użytkownika o ile on je ma wypełnione.');
...
define("_MI_SSECTION_WELCOME", "[TREŚĆ] Display the welcome title and message:");
...
define("_MI_SSECTION_WHOWHEN", "[TREŚĆ] Display the poster and date?");
