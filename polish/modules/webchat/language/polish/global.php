...
define("_WCINVALIDROOM" , "Wybra³e¶ b³êdny pokój. Wybierz jeszcze raz");
define("_WCNONICK" , "A gdzie nick/pseudo?");
define("_WCPWREQROOM" , "Wymagane jest has³o");
define("_WCINVUSERPW" , "B³êdne has³o lub nazwa u¿ytkownika");
...
define("_WCNORMROOM" , "Pokoje ogólnodostêpne");
define("_WCPRIVROOM" , "Pokoje prywatne");
define("_WCENTERUNAME" , "Nazawa u¿ytkownika");
define("_WCINVROOMPW" , "B³êdne has³o dla %s");
define("_WCREGONLY" , "%s tylko dla zarejestrowanych u¿ytkowników");
define("_WCALREADYINROOM" , "U¿ytkownik z twoim nickiem %s  jest zalogowany w %s z tym samym adresem IP.<br>Tablica u¿ytkowników czyszczona jest co %s sekund. Po tym czasie spróbuj znów.");
...
define("_WCCHATTIPS" , "Tips: Wstaw tekst miêdzy gwiazdki <b>*</b> aby <b>wyt³u¶ciæ</b>, lub w podkre¶leniach <b>_</b> dla <i>kursywy</i>");
...
define("_WCCHATWELCOME" , "Witaj na czacie <br>Prowad¼ proszê kulturalne pogawêdki");
define("_WCQUIT","Dziêki za u¿ywanie "._WCAPPNAME.", na Polonia-IT.org. Wpadnij tu kiedy¶");
define("_WCQUITREASON0" , "%s, opu¶ci³e¶ %s.");
define("_WCQUITREASON1" , "%s, Wywalono Ciê z %s bo nie jeste¶ tu zalogowany!");
