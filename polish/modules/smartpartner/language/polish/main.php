...
define("_MD_SPARTNER_NOPARTNERSELECTED","Partner zosta³ wybrany niew³a¶ciwie.");
define("_MD_SPARTNER_NOTIFY","Powiadom po zatwierdzeniu");
define("_MD_SPARTNER_READMORE","Wiêcej...");
define("_MD_SPARTNER_SUBMIT_ERROR","Podczas dodawania partnera wyst±pi³ b³±d.");
define("_MD_SPARTNER_SUBMIT_SUCCESS","Partner zosta³ dodany pomy¶lnie.");
define("_MD_SPARTNER_DETAIL_CAT","Poka¿ wszystkich partnerów w tej kategorii");
define("_MD_SPARTNER_EDIT","Edytuj");
define("_MD_SPARTNER_DELETE","Usuñ");
define("_MD_SPARTNER_JOIN","Zostañ partnerem");
...
define("_MD_SPARTNER_HITS","Ods³on");
define("_MD_SPARTNER_NOPART","Nie ma ¿adnych partnerów.");
//file join.php
define("_MD_SPARTNER_IMAGE","Logo");
define("_MD_SPARTNER_TITLE","Nazwa");
define("_MD_SPARTNER_URL","Adres WWWW:");
define("_MD_SPARTNER_SEND","Wy¶lij pro¶bê");
