...
define('_AM_EXTGALLERY_CATEGORY',"Wybierz kategorię");
define('_AM_EXTGALLERY_INFORMATION',"Informacje");
define('_AM_EXTGALLERY_PARENT_CAT',"Kategoria nadrzędna");
define('_AM_EXTGALLERY_DESC',"Opis");
define('_AM_EXTGALLERY_PHOTO',"Zdjcie");
define('_AM_EXTGALLERY_WEIGHT',"Waga");
define('_AM_EXTGALLERY_TITLE',"Tytuł");

// Main administration menu
define('_AM_EXTGALLERY_GO_TO_MODULE',"Idź do modułu");
...
define('_AM_EXTGALLERY_UPDATE_UPGRADE',"Kliknij tutaj aby uaktualnić moduł do nowszej wersji");
define('_AM_EXTGALLERY_CHECK_UPDATE_ERROR',"Błąd podczas pobierana informacji o ostatniej wersji eXtGalley.");
define('_AM_EXTGALLERY_UPDATE_KO',"Twoja wersja eXtGallery jest przestarzała. Zalecamy instalację najnowszej wersji eXtGallery z <a href=\"http://www.zoullou.net/\">Zoullou.net</a>.");
...
define('_AM_EXTGALLERY_GIF_SUPPORT',"Dostępność GIF");
define('_AM_EXTGALLERY_JPEG_SUPPORT',"Dostępność JPEG");
define('_AM_EXTGALLERY_PNG_SUPPORT',"Dostępność PNG");
define('_AM_EXTGALLERY_PUBLIC_ORIG_PATH',"Katalog zdjęć oryginalnych");
define('_AM_EXTGALLERY_PUBLIC_LARGE_PATH',"Katalog zdjęć dużych");
define('_AM_EXTGALLERY_PUBLIC_MEDIUM_PATH',"Katalog zdjęć średnich");
define('_AM_EXTGALLERY_PUBLIC_THUMB_PATH',"Katalog miniaturek");
define('_AM_EXTGALLERY_NOT_CREATED',"Nie utworzono");
define('_AM_EXTGALLERY_NOT_WRITABLE',"Brak możliwości zapisu ");
define('_AM_EXTGALLERY_CHANGELOG',"Lista zmian (changelog)");
define('_AM_EXTGALLERY_XOOPS_VERSION_NOT_SUPPORTED',"Twoja wersja XOOPS nie współpracuje z nową wersją eXtGallery. Uaktualnij proszę XOOPS do wersj <b>%s</b> lub wyższej.");
define('_AM_EXTGALLERY_EXTGALLERY_VERSION',"Wersja eXtGallery");


// Public category page
define('_AM_EXTGALLERY_MODDELETE_PUBLICCAT',"Modyfikuj lub usuń kategorię");
define('_AM_EXTGALLERY_MODDELETE_PUBLICCAT_INFO',"Tutaj znajduje się lista wszystkich kategorii/albumów umieszczonych na stronie. Numer w nawiasie oznacza wagę kategorii.");
define('_AM_EXTGALLERY_ADD_PUBLIC_CAT',"Dodaj kategorię");
define('_AM_EXTGALLERY_ADD_PUBLIC_CAT_INFO',"Możesz dodać kategorię tylko pod istniejącą kategorię bez zdjęć. Tylko te kategorie, które spełniają ten warunek, są umieszczone poniżej..");
define('_AM_EXTGALLERY_NAME',"Nazwa");
define('_AM_EXTGALLERY_DELETE_CAT_CONFIRM',"Cała zawartoś tej kategorii bądź tego albumu zostanie usunięta.");
...
define('_AM_EXTGALLERY_CAT_CREATED',"Utworzono kategorię");
define('_AM_EXTGALLERY_CAT_MODIFIED',"Kategoria zmodyfikowana");
define('_AM_EXTGALLERY_CAT_DELETED',"Kategoria usunięta");
define('_AM_EXTGALLERY_NO_CATEGORY_SELECTED',"Nie wybrano żadnej kategorii");

// Photo page
define('_AM_EXTGALLERY_ADD_BATCH',"Masowe dodawanie zdjęć");
define('_AM_EXTGALLERY_BATCH_PATH',"Folder dla zdjęć");
define('_AM_EXTGALLERY_ADD_BATCH_INFO',"W folderze znajduje się <b>%d</b> zdjęć. Poprzez naciśnięcie guzika ZAPISZ poniżej, wszystkie zdjęcia z folderu masowego dodawania zostaną przpisane do wybranej kategorii.");
define('_AM_EXTGALLERY_EDITDELETE_PHOTO',"Edytuj/Kasuj zdjęcie");
define('_AM_EXTGALLERY_EDITDELETE_PHOTO_INFO',"Wybierz kategorię, z której chcesz edytować lub kasować zdjęcie.");
define('_AM_EXTGALLERY_PENDING_PHOTO',"Zdjęcia oczekujące");
define('_AM_EXTGALLERY_APPROVE_INFO',"<b>Zatwierdź</b> to zdjęcie");
define('_AM_EXTGALLERY_EDIT_INFO',"<b>Edytuj</b> to zdjęcie przed zatwierdzeniem");
define('_AM_EXTGALLERY_DELETE_INFO',"<b>Kasuj</b> to zdjęcie");
define('_AM_EXTGALLERY_ACTION',"Akcja");
define('_AM_EXTGALLERY_APPROVE',"Zatwierdź");
define('_AM_EXTGALLERY_EDITDELETE_PHOTOTABLE_INFO',"Tylko zdjęcie, które zostało zaznaczone zostanie edytowane lub skasowane.");
define('_AM_EXTGALLERY_APPLY_CHANGE',"Zatwierdź zmiany");
define('_AM_EXTGALLERY_X_PHOTO_ADDED',"Liczba dodanych zdjęć: %d ");
define('_AM_EXTGALLERY_X_PHOTO_APPROVED',"Liczba zatwierdzonych zdjęć: %d ");
define('_AM_EXTGALLERY_X_PHOTO_DELETED',"Liczba skasowanych zdjęć: %d ");
define('_AM_EXTGALLERY_X_PHOTO_MODIFIED',"Liczba zmodyfikowanych zdjęć: %d ");
define('_AM_EXTGALLERY_PHOTO_MODIFIED',"Zdjęcie zostało zmodyfikowane");
define('_AM_EXTGALLERY_BATCH_CONTINUE_MESSAGE',"Dodano zdjęć: %d , %d więcej. Kliknij aby kontynuować.");
define('_AM_EXTGALLERY_NOT_AN_ALBUM',"Musisz zaznaczyć odpowiedni album");
define('_AM_EXTGALLERY_ALBUM',"Album");
define('_AM_EXTGALLERY_NO_PHOTO_IN_BATCH_DIR',"Nie ma zdjęć w folderze masowego dodawania.");
define('_AM_EXTGALLERY_NO_PHOTO_SELECTED',"To nie są zaznaczone zdjęcia");
define('_AM_EXTGALLERY_NO_PHOTO_IN_THIS_ALBUM',"Nie ma żadnych zdjęć w tym albumie");
define('_AM_EXTGALLERY_THUMB_REBUILDED',"Miniaturki zostały przbudowane");
define('_AM_EXTGALLERY_REBUILD_THUMB',"Przebuduj miniaturki");
define('_AM_EXTGALLERY_REBUILD_THUMB_INFO',"Wybierz kategorię w której miniaturki mają być przebudowane. Ta funkcja jest przydatna jeśli chcesz zmieniż wielkość miniaturek lub ich jakość.");

// Permissions
define('_AM_EXTGALLERY_PUBLIC_PERM_MASK',"Publiczna maska uprawnień");
define('_AM_EXTGALLERY_PUBLIC_PERM_MASK_INFO',"Tutaj możesz ustawić domyślną maskę uprawnień, która będzie dotyczyła nowej kategorii. Bądź ostrożny, ponieważ takie same uprawnienia będą nadawane każdym kolejnie tworzonym kategoriom.");
define('_AM_EXTGALLERY_GROUP_NAME',"Nazwa grupy");
define('_AM_EXTGALLERY_CAN_ACCESS',"Ma dostęp");
define('_AM_EXTGALLERY_CAN_RATE',"Może oceniać");
define('_AM_EXTGALLERY_CAN_SEND_ECARD',"Może wysyłać e-kartki");
define('_AM_EXTGALLERY_CAN_DOWNLOAD',"Może pobierać zdjęcia");
define('_AM_EXTGALLERY_CAN_DOWNLOAD_ORIG',"Może pobierać oryginalne zdjęcia");
define('_AM_EXTGALLERY_CAN_UPLOAD',"Może wysyłać zdjęcia na serwer");
define('_AM_EXTGALLERY_AUTOAPPROVE',"Zdjęcie nie musi być zatwierdzane przez admina");
define('_AM_EXTGALLERY_DISPLAYED',"Widoczność albumu");

define('_AM_EXTGALLERY_PERM_MASK_UPDATED',"Maska uprawnień uaktualniona");

define('_AM_EXTGALLERY_SELECT_PERM',"Wybierz uprawnienia");
define('_AM_EXTGALLERY_SELECT_PERM_DESC',"Sprawdź proszę wszystkie części i uaktualnij uprawnienia. Jeśli chcesz aby użytkownicy mieli dostęp do oglądania albumów i zdjęć musisz wybrać uprawnienia dla wszystkich grup");

define('_AM_EXTGALLERY_ACCESS_PERM',"Uprawnienia dostępu");
define('_AM_EXTGALLERY_ACCESS_PERM_DESC',"Wybierz kategorie, które będą dostępne");
define('_AM_EXTGALLERY_ACCESS_PERM_INFO',"To uprawnienie pozwala ograniczyć dostęp do kategorii. Bez tego uprawnienia użytkownik nie będzie widział kategorii.");

define('_AM_EXTGALLERY_RATE_PERM',"Ocenianie");
define('_AM_EXTGALLERY_RATE_PERM_DESC',"Wybierz kategorie, w których użytkownik może oceniać zdjęcia");
define('_AM_EXTGALLERY_RATE_PERM_INFO',"To uprawnienie pozwala ograniczyć dostępność funkcji oceniania. Bez tego uprawnienia nie można oceniać w kategorii ale nadal można oglądać jak inni ocenili zdjęcie.");

define('_AM_EXTGALLERY_PUBLIC_ECARD',"Wysyłanie eCards (e-kartki)");
define('_AM_EXTGALLERY_PUBLIC_ECARD_DESC',"Wybierz kategorie, z których użytkownik może wysyłać e-kartki");
define('_AM_EXTGALLERY_PUBLIC_ECARD_INFO',"To uprawnienie pozwala ograniczyć możliwość wysyłania e-kartek. (Dla bezpieczeństwa eXtGallery zapisuje (loguje) wszystkie adresy IP wysyłających e-kartki).");

define('_AM_EXTGALLERY_PUBLIC_DOWNLOAD',"Pobieranie");
define('_AM_EXTGALLERY_PUBLIC_DOWNLOAD_DESC',"Wybierz kategorie, z których użytkownik może pobierać zdjęcia");
define('_AM_EXTGALLERY_PUBLIC_DOWNLOAD_INFO',"To uprawnienie pozwala ograniczyć możliwość pobierania dużych wersji zdjęć. Jeśli użytkownik jest uprawniony do pobierania dużych zdjęć, może to robić jeśli opcja \"Zapisz duże zdjęcia\" jest włączona w preferencjach modułu.");

define('_AM_EXTGALLERY_PUBLIC_DOWNLOAD_ORIG',"Pobieranie oryginałów");
define('_AM_EXTGALLERY_PUBLIC_DOWNLOAD_ORIG_DESC',"Wybierz kategorie, z których użytkownik może pobierać oryginalne zdjęcia.<br />Opcja zachowania oryginalnych obrazków musi być włączona w opcjach.");
define('_AM_EXTGALLERY_PUBLIC_DOWNLOAD_ORIG_INFO',"To uprawnienie pozwala ograniczyć możliwość pobierania oryginalnych wersji zdjęć. Jeśli użytkownik jest do tego uprawniony, będzie mógł pobierać oryginalne zdjęcia (bez ramki, znaku wodnego, przed przeskalowaniem) jeśli tylko opcja \"Zapisz oryginały zdjęć\" jest włączona w preferencjach modułu.");

define('_AM_EXTGALLERY_PUBLIC_UPLOAD',"Wysyłanie na serwer");
define('_AM_EXTGALLERY_PUBLIC_UPLOAD_DESC',"Wybierz kategorie, do których użytkownik może wysyłać zdjęcia");
define('_AM_EXTGALLERY_PUBLIC_UPLOAD_INFO',"To uprawnienie ogranicza możliwość wysyłania nowych zdjęć do publicznych abumów.");

define('_AM_EXTGALLERY_PUBLIC_AUTOAPROVE',"Kategorie bez zatwierdzania");
define('_AM_EXTGALLERY_PUBLIC_AUTOAPROVE_DESC',"Wybierz kategorie, w których zdjęcia nie będą wymagały zatwierdzania");
define('_AM_EXTGALLERY_PUBLIC_AUTOAPROVE_INFO',"To uprawnienie pozwala wybrać kategorie w których nie będzie wymagane zatwierdzenie zdjęcia przez administratora. W pozostałych kategoriach zdjęcie przesłane do albumu będzie oczekiwało na zatwierdzenie przez administratora zanim zostanie opublikowane.");

define('_AM_EXTGALLERY_PUBLIC_DISPLAYED',"Wyświetl uprawnienia albumów");
define('_AM_EXTGALLERY_PUBLIC_DISPLAYED_DESC',"Wybierz kategorie do wyświetlenia");
define('_AM_EXTGALLERY_PUBLIC_DISPLAYED_INFO',"Pozwala ukryć nazwy kategorii, a jednocześnie wyświetlać zdjęcia z ukrytej kategorii. To może być wykorzystane np. gdy chcesz użyć zdjęć jako część swojego serwisu www i nie chcesz by te zdjęcia były widoczne jako album.");

// Watermark and border page
define('_AM_EXTGALLERY_AVAILABLE_FONT',"Dostępne czcionki");
define('_AM_EXTGALLERY_ADD_FONT',"Dodaj czionkę (TTF)");
define('_AM_EXTGALLERY_FONT_FILE',"Plik z czcionką");
define('_AM_EXTGALLERY_FONT_MANAGMENT',"Zarządzanie czcionkami");
define('_AM_EXTGALLERY_ADD_FONT_LINK',"Dostępnych czcionek: %s . <a href=\"watermark-border.php?op=uploadfont\">Klknij tutaj</a> aby dodać");
define('_AM_EXTGALLERY_WATERMARK_FREETYPE_WARN',"<b>PHP musi być skompilowane z FreeType by działały znaki wodne. Zobacz <a href=\"http://www.freetype.org/\">FreeType.org</a> aby uzyskać więcej informacji.</b>");
define('_AM_EXTGALLERY_WATERMARK_CONF',"Konfiguracja znaków wodnych");
define('_AM_EXTGALLERY_FONT',"Czcionka");
define('_AM_EXTGALLERY_WATERMARK_TEXT',"Treść znaku wodnego");
define('_AM_EXTGALLERY_POSITION',"Pozycja");
define('_AM_EXTGALLERY_TOP_LEFT',"Góra lewo");
define('_AM_EXTGALLERY_TOP_RIGHT',"Góra prawo");
define('_AM_EXTGALLERY_BOTTOM_LEFT',"Dół lewo");
define('_AM_EXTGALLERY_BOTTOM_RIGHT',"Dół prawo");
define('_AM_EXTGALLERY_TOP_CENTER',"Góra środek");
define('_AM_EXTGALLERY_BOTTOM_CENTER',"Dół środek");
define('_AM_EXTGALLERY_LEFT_CENTER',"Lewo środek");
define('_AM_EXTGALLERY_RIGHT_CENTER',"Prawo środek");
...
define('_AM_EXTGALLERY_INNER_BORDER_COLOR',"Kolor ramki wewnętrznej");
define('_AM_EXTGALLERY_INNER_BORDER_SIZE',"Rozmiar ramki wewnętrznej (px)");
define('_AM_EXTGALLERY_OUTER_BORDER_COLOR',"Kolor ramki zewnętrznej");
define('_AM_EXTGALLERY_OUTER_BORDER_SIZE',"Rozmiar ramki zewnętrznej (px)");
define('_AM_EXTGALLERY_WATERMARK_BORDER_EXEMPLE',"Przykład znaku wodnego i ramki");
define('_AM_EXTGALLERY_WATERMARK_BORDER_EXEMPLE_INFO',"Jeżeli nie widzisz obrazka - odśwież stronę.");
define('_AM_EXTGALLERY_FONT_ADDED',"Czionka dodana");
define('_AM_EXTGALLERY_CONFIGURATION_SAVED',"Ustawienia zapisane");
define('_AM_EXTGALLERY_PRINT_SUBMITTER_UNAME',"Wyświetl nazwę dodającego");

// Slideshow
define('_AM_EXTGALLERY_SLIDESHOW_CONF',"Pokaz slajdów - konfiguracja");
