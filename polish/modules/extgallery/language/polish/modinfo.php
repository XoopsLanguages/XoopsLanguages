...
define('_MI_EXTGAL_DESC',"Prosta i dużo potrafiąca galeria dla XOOPSa");

// Main menu
define('_MI_EXTGALLERY_USERALBUM',"Mój album");
define('_MI_EXTGALLERY_PUBLIC_UPLOAD',"Wyślij zdjęcie");

// Main administration menu
define('_MI_EXTGALLERY_INDEX',"Strona główna");
define('_MI_EXTGALLERY_PUBLIC_CAT',"Kategorie/Albumy");
define('_MI_EXTGALLERY_PHOTO',"Zdjęcia");
define('_MI_EXTGALLERY_PERMISSIONS',"Uprawnienia");
define('_MI_EXTGALLERY_WATERMARK_BORDER',"Znak wodny &amp; ramka");
define('_MI_EXTGALLERY_SLIDESHOW',"Pokaz slajdów");
...
// Module options
define('_MI_EXTGAL_DISP_TYPE',"Tryb wyświetlania");
define('_MI_EXTGAL_DISP_TYPE_DESC',"Wybierz tryb wyświetlania dla zdjęcia");
define('_MI_EXTGAL_DISP_SET_ORDER',"Porządek wyświetlania zdjęć");
define('_MI_EXTGAL_DISP_SET_ORDER_DESC',"Porządek wyświetlania zdjęć, malejący lub rosnący, bazujący na czasie wysłania zdjęcia do galerii");
define('_MI_EXTGALLERY_DESC',"Malejąco");
define('_MI_EXTGALLERY_ASC',"Rosnąco");
define('_MI_EXTGAL_NB_COLUMN',"Liczba kolumn w albumie");
define('_MI_EXTGAL_NB_COLUMN_DESC',"Ile kolumn ma być użytych do wyświetlania miniaturek");
define('_MI_EXTGAL_NB_LINE',"Liczba wierszy w albumie");
define('_MI_EXTGAL_NB_LINE_DESC',"Ile wierszy ma być użytych do wyświetlania miniaturek");
define('_MI_EXTGAL_SAVE_L',"Zapisuj olbrzymie zdjęcia");
define('_MI_EXTGAL_SAVE_L_DESC',"Czy chcesz zapisywać zdjęcia większe niż rozmiar średni? Jeżeli zapiszesz, to link do zdjęcia w oryginalnych rozmiarach będzie wyświetlony pod zmniejszonym.");
define('_MI_EXTGAL_M_WIDTH',"Szerokość średniego zdjęcia");
define('_MI_EXTGAL_M_WIDTH_DESC',"Zdjęcie będzie przeskalowane do podanej szerokości");
define('_MI_EXTGAL_M_HEIGTH',"Wysokość średniego zdjęcia");
define('_MI_EXTGAL_M_HEIGTH_DESC',"Zdjęcie będzie przeskalowane do podanej wysokości");
define('_MI_EXTGAL_T_WIDTH',"Szerokość miniaturki");
define('_MI_EXTGAL_T_WIDTH_DESC',"Maksymalna szerokość miniaturki");
define('_MI_EXTGAL_T_HEIGTH',"Wysokość miniaturki");
define('_MI_EXTGAL_T_HEIGTH_DESC',"Maksymalna wysokość miniaturki");
define('_MI_EXTGAL_M_WATERMARK',"Włącz znak wodny dla średnich zdjęć");
define('_MI_EXTGAL_M_WATERMARK_DESC',"Ta opcja pozwoli na dodawanie znaku wodnego do średnich zdjęć, ale dopiero gdy zmienisz ustawienia znaków wodnych.");
define('_MI_EXTGAL_M_BORDER',"Włącz ramkę dla średnich zdjęć");
define('_MI_EXTGAL_M_BORDER_DESC',"Ta opcja pozwoli na dodawanie ramki do średnich zdjęć, ale dopiero gdy zmienisz ustawienia ramek.");
define('_MI_EXTGAL_L_WATERMARK',"Włącz znak wodny dla olbrzymich zdjęć");
define('_MI_EXTGAL_L_WATERMARK_DESC',"Ta opcja pozwoli na dodawanie znaku wodnego do olbrzymich zdjęć, ale dopiero gdy zmienisz ustawienia znaków wodnych.");
define('_MI_EXTGAL_L_BORDER',"Włącz ramki dla olbrzymich zdjęć");
define('_MI_EXTGAL_L_BORDER_DESC',"Ta opcja pozwoli na dodawanie ramki do olbrzymich zdjęć, ale dopiero gdy zmienisz ustawienia ramek.");
define('_MI_EXTGAL_NAME_PATTERN',"Automatyczny szablon nazwy");
define('_MI_EXTGAL_NAME_PATTERN_DESC',"Jeżeli nie dodasz opisu do zdjęcia, jego nazwa zostanie użyta do tego celu.<br />Z nazwy \"Tournament-06-may-2006_1.jpg\" otrzymasz \"Tournament 06 may 2006\".");
define('_MI_EXTGAL_DISPLAY_EXTRA',"Wyświetl dodatkowe pole");
define('_MI_EXTGAL_DISPLAY_EXTRA_DESC',"ta opcja pozwala na dodanie większej ilości informacji w formularzu dodawania zdjęcie. Możesz na przykład wstawić przycisk paypal dla każdego dodawanego zdjęcia.");
define('_MI_EXTGAL_ALLOW_HTML',"Dopuść HTML w dodatkowym polu");
define('_MI_EXTGAL_ALLOW_HTML_DESC',"Dopuść lub nie kod HTML w opisie i dodatkowym polu.");
define('_MI_EXTGAL_HIDDEN_FIELD',"Ta stała jest używana tylko do pozbywania się powiadomienia PHP. Ten tekst nie jest używany w module.");
define('_MI_EXTGAL_SAVE_ORIG',"Zapisuj oryginalne zdjęcie");
define('_MI_EXTGAL_SAVE_ORIG_DESC',"Dzięki tej opcji na serwerze zostaną zapisane zdjęcia w wersji oryginalnej (bez znaku wodnego i ramki). Opcja \"Zapisuj olbrzymie zdjęcia\" <b>musi</b> być włączona aby wszystko poprawnie funkcjonowało.<br /><b>Zdjęcie w wersji oryginalnej może być pobrane tylko, gdy użytkownik ma ustawione odpowiednie uprawnienia dla \"Pobierania oryginałów\"</b>.");
define('_MI_EXTGAL_ADM_NBPHOTO',"Liczba wyświetlonych zdjęć na stronach administracyjnych");
define('_MI_EXTGAL_ADM_NBPHOTO_DESC',"Podaj liczbę zdjęć wyświetlanych na stronach edycji oraz zatwierdzania.");
define('_MI_EXTGAL_GRAPHLIB',"Biblioteka graficzna");
define('_MI_EXTGAL_GRAPHLIB_DESC',"Wybierz, którą bibliotekę chcesz używać. Nie modyfikuj tej opcji jeżeli nie wiesz co robisz.");
define('_MI_EXTGAL_GRAPHLIB_PATH',"Ścieżka do biblioteki graficznej");
define('_MI_EXTGAL_GRAPHLIB_PATH_DESC',"Path to the graphic library on the serveur <b>WITH</b> trailing slash.");
define('_MI_EXTGAL_ENABLE_RATING',"Włącz możliwość oceniania zdjęć");
define('_MI_EXTGAL_ENABLE_RATING_DESC',"This option allow you to globaly enable or disable the rating feature.");

define('_MI_EXTGAL_DISP_PH_TITLE',"Pokazuj tytuł zdjęcia");
define('_MI_EXTGAL_DISP_PH_TITLE_DESC',"Ta opcja pozwala wybrać czy w widoku albumu tytuł zdjęcia ma być pokazywany.");
define('_MI_EXTGAL_DISP_CAT_IMG',"Obrazek kategorii");
define('_MI_EXTGAL_DISP_CAT_IMG_DESC',"Wybierz, czy chcesz mieć możliwość dodawania obrazka do kategorii.");
...
// Bloc Name
define('_MI_EXTGAL_B_PHOTO',"Zdjęcia");
define('_MI_EXTGAL_B_SUB',"Najaktywniejsi ");
define('_MI_EXTGAL_B_AJAX',"Zdjęcia - pokaz slajdów");
...
define('_MI_EXTGAL_PHOTO_NOTIFY',"Zdjęcie");
define('_MI_EXTGAL_PHOTO_NOTIFYDSC',"_MI_EXTGAL_PHOTO_NOTIFYDSC");
define('_MI_EXTGAL_NEW_PHOTO_NOTIFY',"Nowe zdjęcie");
define('_MI_EXTGAL_NEW_PHOTO_NOTIFYCAP',"Powiadom mnie o dodaniu nowego zdjęcia");
define('_MI_EXTGAL_NEW_PHOTO_NOTIFYDSC',"NEW_PHOTO_NOTIFYDSC");
define('_MI_EXTGAL_NEW_PHOTO_NOTIFYSBJ',"Wysłano nowe zdjęcie");
define('_MI_EXTGAL_NEW_PHOTO_PENDING_NOTIFY',"Nowe zdjęcie oczekuje na zatwierdzenie");
define('_MI_EXTGAL_NEW_PHOTO_PENDING_NOTIFYCAP',"Powiadom mnie o dodaniu nowego zdjęcia oczekującego na zatwierdzenie");
define('_MI_EXTGAL_NEW_PHOTO_PENDING_NOTIFYDSC',"_MI_EXTGAL_NEW_PHOTO_PENDING_NOTIFYDSC");
define('_MI_EXTGAL_NEW_PHOTO_PENDING_NOTIFYSBJ',"Nowe zdjęcie oczekuje na zatwierdzenie");
define('_MI_EXTGAL_NEW_PHOTO_ALBUM_NOTIFY',"Powiadom mnie o dodaniu nowego zdjęcia do tego albumu");
define('_MI_EXTGAL_NEW_PHOTO_ALBUM_NOTIFYCAP',"Powiadom mnie o dodaniu nowego zdjęcia do tego albumu");
define('_MI_EXTGAL_NEW_PHOTO_ALBUM_NOTIFYDSC',"_MI_EXTGAL_NEW_PHOTO_ALBUM_NOTIFYDSC");
define('_MI_EXTGAL_NEW_PHOTO_ALBUM_NOTIFYSBJ',"Dodano nowe zdjęcie");
