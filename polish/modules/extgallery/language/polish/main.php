...
define("_MD_EXTGALLERY_NBPHOTOS","Zdjęć");
define("_MD_EXTGALLERY_DESC","Opis");
define("_MD_EXTGALLERY_SEND_ECARD","Wyślij e-kartkę");
define("_MD_EXTGALLERY_EXTRA_INFO","Dodatkowe informacje");
define("_MD_EXTGALLERY_NOPERM","Nie masz uprawnień do wykonywania tej czynności");
define("_MD_EXTGALLERY_PHOTO_TITLE","Tytuł");
define("_MD_EXTGALLERY_PHOTO_WEIGHT","Waga");
define("_MD_EXTGALLERY_RSS","Kanał RSS galerii");
define("_MD_EXTGALLERY_ALBUMRSS","Kanał RSS albumu");

// Album page
define("_MD_EXTGALLERY_HITS","Wyświetleń");
...
define("_MD_EXTGALLERY_NEXT","Następne");
define("_MD_EXTGALLERY_OF","z");
define("_MD_EXTGALLERY_VOTE_FOR_THIS_PHOTO","Głosuj na to zdjęcie");
define("_MD_EXTGALLERY_PHOTO_INFORMATION","Informacje");
define("_MD_EXTGALLERY_RESOLUTION","Rozdzielczość");
...
define("_MD_EXTGALLERY_VOTES","głosów");
define("_MD_EXTGALLERY_DOWNLOAD_ORIG","Pobierz oryginał");
define("_MD_EXTGALLERY_DOWNLOADS","pobrań");
define("_MD_EXTGALLERY_SENDS","wysłań");
define("_MD_EXTGALLERY_ALL_PHOTO_BY","wszystkie zdjęcia ");
define("_MD_EXTGALLERY_SUBMITTER","Dodał");
...
define("_MD_EXTGALLERY_GREETINGS","Treść");
define("_MD_EXTGALLERY_SECURITY","Przepisz kod z obrazka");

// View eCard page and mail
define("_MD_EXTGALLERY_CLICK_FOR_MORE","Kliknij tutaj aby zobaczyć więcej zdjęć!");
define("_MD_EXTGALLERY_ECARD_TITLE","E-karkta od %s dla Ciebie");

// Public upload page
define("_MD_EXTGALLERY_PUBLIC_UPLOAD","Wyślij zdjęcie do galerii");
define("_MD_EXTGALLERY_PHOTO","Zdjęcie");
define('_MD_EXTGALLERY_NOT_AN_ALBUM',"Musisz wybrać poprawny album");
define('_MD_EXTGALLERY_UPLOAD_ERROR',"Błąd podczas wysyłania");
...
define("_MD_EXTGALLERY_MODIFY_PHOTO","Modifikuj zdjęcie");
define("_MD_EXTGALLERY_CATEGORY","Kategoria");
define("_MD_EXTGALLERY_PHOTO_UPDATED","Zdjęie zmodyfikowane");

// Public rating page
define("_MD_EXTGALLERY_VOTE_THANKS","Dziękujemy za oddany głos");
define("_MD_EXTGALLERY_ALREADY_VOTED","Już głosowałeś na to zdjęcie");

// Public send eCard page
define("_MD_EXTGALLERY_ECARD_SENT","Wysłano");
define("_MD_EXTGALLERY_CAPTCHA_ERROR","Źle przepisany kod. Spróbuj ponownie.");

// Public Upload photo page
define("_MD_EXTGALLERY_PHOTO_UPLOADED","Wyłano pomyślnie. Dziękujemy.");
define("_MD_EXTGALLERY_PHOTO_PENDING","Dziękujemy za dodanie, Twoje zdjęcie musi być zatwierdzone przez admina.");

// Public user's album
define("_MD_EXTGALLERY_USERS_SUB_PHOTO_ALBUM"," - własny album");
// Public Slideshow
define("_MD_EXTGALLERY_MOREINFO","Więcej");
define("_MD_EXTGALLERY_GFIC_DOWNLOAD","Pobierz oryginalne zdjęcie"); 
define("_MD_EXTGALLERY_GFIC_PLAY","Włącz"); 
...
// Public bookmarks
define("_MD_EXTGALLERY_BOOKMARK_ME", "Dodaj zakładkę");
define("_MD_EXTGALLERY_BOOKMARK_TO_BLINKLIST", "Zakładka do Blinklist");
define("_MD_EXTGALLERY_BOOKMARK_TO_DELICIOUS", "Zakładka do del.icio.us");
...
define("_MD_EXTGALLERY_ORDERBY","Uporządkowane według : ");
define("_MD_EXTGALLERY_ORDERBY_DATEASC","Data, nowe zdjęcia w pierwszej kolejności");
define("_MD_EXTGALLERY_ORDERBY_DATEDESC","Data, najstarsze zdjęcia najpierw");
define("_MD_EXTGALLERY_ORDERBY_TITREASC","Nazwa, A - Z");
define("_MD_EXTGALLERY_ORDERBY_TITREDESC","Nazwa, Z - A");
define("_MD_EXTGALLERY_ORDERBY_HITSASC","Kliknięcia, najbardziej popularne najpierw");
define("_MD_EXTGALLERY_ORDERBY_HITSDESC","Kliknięcia, najmniej popularne najpierw");
define("_MD_EXTGALLERY_ORDERBY_NOTEASC","Ocena, nawyżej oceniane najpierw");
define("_MD_EXTGALLERY_ORDERBY_NOTEDESC","Ocena, najnirzej oceniane najpierw");
define("_MD_EXTGALLERY_SORTDATE","Data");
define("_MD_EXTGALLERY_SORTDATEASC","Stare zdjęcia najpierw");
define("_MD_EXTGALLERY_SORTDATEDESC","Nowe zdjęcia najpierw");
...
define("_MD_EXTGALLERY_SORTHITS","Kliknięcia");
