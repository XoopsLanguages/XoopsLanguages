...
define("_US_INCORRECTLOGIN","Błędny login!");
...
// %s is your site name
define("_US_NEWUSERREGAT","Rejestracja nowego użytkownika na %s");
// %s is a username
define("_US_HASJUSTREG","%s już się zarejestrował!");
define("_US_INVALIDMAIL","BŁĄD: niepoprawny email");
define("_US_EMAILNOSPACES","BŁĄD: adresy email nie zawierają spacji.");
define("_US_INVALIDNICKNAME","BŁĄD: Niepoprawny login");
define("_US_NICKNAMETOOLONG","Login jest za długi. Musi krótszy niż %s znaków.");
define("_US_NICKNAMETOOSHORT","Login jest za krótki. Musi dłuższy niż %s znaków.");
define("_US_NAMERESERVED","BŁĄD: nazwa jest już zarezerwowana.");
define("_US_NICKNAMENOSPACES","Login nie może zawierać spacji.");
define("_US_NICKNAMETAKEN","BŁĄD: login jest już zajęty.");
define("_US_EMAILTAKEN","BŁĄD: adres email już zarejestrowany.");
define("_US_ENTERPWD","BŁĄD: musisz podać hasło.");
define("_US_SORRYNOTFOUND","Niestety, nie znaleziono odpowiednich informacji.");
// %s is your site name
define("_US_NEWPWDREQ","Prośba o nowe hasło na %s");
define("_US_YOURACCOUNT","Twoje konto na %s");
...
define("_US_CONFMAIL","Email potwierdzający dla %s został wysłany.");
define("_US_ACTVMAILNG","Nie udało się wysłać emaila potwierdzającego do %s");
define("_US_ACTVMAILOK","Email z zawiadomieniem został wysłany do %.");
...
define("_US_LOCATION","Skąd");
define("_US_OCCUPATION","Zawód");
define("_US_INTEREST","Zainteresowania");
define("_US_SIGNATURE","Podpis");
define("_US_EXTRAINFO","Dodatkowe informacje");
