...
define('_MD_RUDELIMGCAT','Czy na pewno chcesz usunąć tę kategorię wraz z wszystkimi obrazami?');
define('_MD_RUDELIMG','Czy na pewno chcesz usunąć ten obraz?');

define('_MD_FAILDEL','Nie udało się usunąć obrazu %s z bazy danych');
define('_MD_FAILDELCAT','Nie udało się usunąć kategorii %s z bazy danych');
define('_MD_FAILUNLINK','Nie udało się usunąć obrazu %s z serwera');
