...
// Navigation
define("_AM_SYSTEM_IMAGES_MANAGER","Zarządzanie obrazkami");
define("_AM_SYSTEM_IMAGES_MAIN","Pliki graficzne - strona główna");
...
define("_AM_SYSTEM_IMAGES_NAME","Nazwa");
define("_AM_SYSTEM_IMAGES_NBIMAGES","Obrazów");
define("_AM_SYSTEM_IMAGES_MAXSIZE","Maksymalny rozmiar pliku");
define("_AM_SYSTEM_IMAGES_MAXWIDTH","Maksymalna szerokość");
define("_AM_SYSTEM_IMAGES_MAXHEIGHT","Maksymalna wysokość");
define("_AM_SYSTEM_IMAGES_DISPLAY","Wyświetl");
define("_AM_SYSTEM_IMAGES_ACTIONS","Akcje");
define("_AM_SYSTEM_IMAGES_VIEW","Pokaż");
...
define("_AM_SYSTEM_IMAGES_URL","Pokazuj adres URL obrazów");

// Messages
define("_AM_SYSTEM_IMAGES_RUDELIMG","Czy na pewno chcesz usunąć ten obraz?");
define("_AM_SYSTEM_IMAGES_FAILSAVE","Nie udało się zapisać obrazu %s w bazie danych");
define("_AM_SYSTEM_IMAGES_RUDELIMGCAT","Czy na pewno chcesz usunąć tę kategorię wraz z wszystkimi obrazami?");
define("_AM_SYSTEM_IMAGES_FAILDEL","Nie udało się usunąć obrazu %s z bazy danych");
define("_AM_SYSTEM_IMAGES_FAILDELCAT","Nie udało się usunąć kategorii %s z bazy danych");
define("_AM_SYSTEM_IMAGES_FAILUNLINK","Nie udało się usunąć obrazu %s z serwera");

// Tips
define("_AM_SYSTEM_IMAGES_TIPS","<ul><li>Kategorie grafik wraz z uprawnieniami użytkowników</li></ul>");
