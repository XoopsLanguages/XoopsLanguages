...
define("_MD_AM_USESSLDSC", ", protokół SSL jest używany do bezpiecznego logowania i wymaga certyfikatu. Skontaktuj się z Twoją firmą hostingową aby dowiedzieć się jak uzyskać certyfikatu dla twojego serwisu.");
