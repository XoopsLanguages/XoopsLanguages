...
define('_MD_PROTECTOR_FMT_JAILINFO','Ta restrykcja straci ważność %s');
define('_MD_PROTECTOR_FMT_JAILTIME','Y-m-j H:i:s');
define('_MD_PROTECTOR_BANDWIDTHLIMITED','Ta witryna jest teraz bardzo obciążona. Spróbuj później.');
...
define('_MD_PROTECTOR_FMT_REGISTER_MORATORIUM','Wyślij ponownie później, za %s minut.  (zabezpieczenie Anty-SPAMowe, przepraszamy)');
