...
define('_AD_REGISTERED', 'Zarejestrowany dnia'); //Registered Date
// define( '_AD_PRESSGEN', 'Po raz pierwszy wszedłeś do działu administracji. Naciśnij przycisk poniżej, aby kontynuować.' );
