...
define( "TABLES_CREATION_TITLE", "Tworzenie tabel w bazie SQL" );
...
define( "DB_PREFIX_LABEL", "Przedrostek tabel" );    // L30
...
define( "TABLE_CREATED", "Utworzono tabelę %s." ); // L45
define( "ROWS_INSERTED", "%d dane wprowadzone do tabeli %s." ); // L119
define( "ROWS_FAILED", "Błąd wprowadzania %d danych do tabeli %s." ); // L120
define( "TABLE_ALTERED", "Tablela %s zaktualizowana."); // L133
...
define( "ERR_NEED_WRITE_ACCESS", "Serwer musi mieć prawa do zapisu plików i folderów <br /> (i.e. <em>chmod 777 nazwa_katalogu</em> na serwerze UNIX/LINUX)<br />Jeśli nie są dostępne lub poprawnie utworzone, proszę utworzyć je ręcznie i udzielić stosownych uprawnień." );
