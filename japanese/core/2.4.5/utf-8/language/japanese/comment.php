...
define('_CM_THANKSPOST', '投稿ありがとうございます!');
define('_CM_NOTICE', "コメントの権利は投稿者にあります。私たちは投稿されたコメントに責任を持つことはできません。");
