...
define("_MD_TDMDOWNLOADS_INDEX_BLPOP","Haut de page des téléchargements :");
define("_MD_TDMDOWNLOADS_INDEX_DLNOW","Télécharger maintenant !");
define("_MD_TDMDOWNLOADS_INDEX_LATESTLIST","Dernières listes");
...
define("_MD_TDMDOWNLOADS_INDEX_THEREARE","Il y a <b>%s</b> fichier(s) dans notre base de données");
...
define("_MD_TDMDOWNLOADS_CAT_THEREARE","Il y a <b>%s</b> fichier(s) dans cette catégorie");
...
define("_MD_TDMDOWNLOADS_SEARCH_THEREARE","Il y a <b>%s</b>fichier(s)");
