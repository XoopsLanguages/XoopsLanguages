...
define('_AM_SMALLWORLD_UPDATE_STATUS','Статус версии Smallworld:');

// tab two in admin section

// tab three in admin section
define('_AM_SMALLWORLD_USERADMIN_TITLE','Пользователи');
...
define("_AM_SMALLWORLD_TITLE_IMAGE","Изображение");
...
define("_AM_SMALLWORLD_TITLE_COMPLAINTS","Принято жалоб");
...
define('_AM_SMALLWORLD_UPDATE_SERVER_ERROR','Сервер выключен или идет обновление.<br/>Попробуйте позже.');
...
define('_AM_SMALLWORLD_UPDATE_YOUHAVENEWESTVERSION',' У вас последняя версия Smallworld');
define('_AM_SMALLWORLD_HELP','Помощь');
...
C:\Temp\smallworld\language\smallworld\language\russian\admin.phpdefine('_AM_SMALLWORLD_SP','<img style="margin: 0pt 5px 0pt 0pt; vertical-align: middle;" src="../images/sp.png" height="30px" width="30px"> <a style="position: relative; margin: 0px;vertical-align: middle;" href="javascript:void(0);" id="smallworldDonate">Если вам нравится этот модуль и работа, которую я вложил в него, вы можете поддержать меня, купив мне кофе.</a>');
