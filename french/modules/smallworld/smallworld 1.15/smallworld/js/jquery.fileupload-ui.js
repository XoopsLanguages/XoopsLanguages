...
(function (xoops_smallworld) {
    ...
    UploadHandler = function (container, options) {
        ...
        this.imageTypes = /^image\/(gif|jpeg|png|jpg|bmp)$/;
        ...
        this.hideProgressBarAll = function (callBack) {
            if (uploadHandler.progressbarAll && !xoops_smallworld(getUploadTable(uploadHandler))
        ...
        this.initProgressBar = function (node, value) {
            ...
            if (typeof node.progressbar === func) {
                ...
                node.addClass('progressbar')
                    .append(xoops_smallworld('<div/>').css('width', value + '%'))
                    .progressbar = function (key, value) {
                        return this.each(function () {
                            if (key === 'destroy') {
                                xoops_smallworld(this).removeClass('progressbar').empty();
                            } else {
                                xoops_smallworld(this).children().css('width', value + '%');
                            }
                        });
                    };
                return node;
        ...
        this.loadPreviewImage = function (files, index, handler) {
            ...
            handler.uploadRow.find(handler.previewSelector).each(function () {
                var previewNode = xoops_smallworld(this),
                    file = files[index];
                setTimeout(function () {
                    handler.loadImage(
                        file,
        ...
        this.parseResponse = function (xhr, handler) {
            if (typeof xhr.responseText !== undef) {
                return xoops_smallworld.parseJSON(xhr.responseText);
            } else {
                // Instead of an XHR object, an iframe is used for legacy browsers:
                return xoops_smallworld.parseJSON(xhr.contents().text());
            }
        };
    ...
    methods = {
        init : function (options) {
            return this.each(function () {
                xoops_smallworld(this).fileUpload(new UploadHandler(xoops_smallworld(this), options));
            });
        },
        ...
        option: function (option, value, namespace) {
            ...
            return this.each(function () {
                xoops_smallworld(this).fileUpload('option', option, value, namespace);
            });
        },
            
        destroy : function (namespace) {
            return this.each(function () {
                xoops_smallworld(this).fileUpload('destroy', namespace);
            });
        },
        
        upload: function (files, namespace) {
            return this.each(function () {
                xoops_smallworld(this).fileUpload('upload', files, namespace);
            });
        }
    };
    
    xoops_smallworld.fn.fileUploadUI = function (method) {
        if (methods[method]) {
            return methods[method].apply(this, Array.prototype.slice.call(arguments, 1));
        } else if (typeof method === 'object' || !method) {
            return methods.init.apply(this, arguments);
        } else {
            xoops_smallworld.error('Method "' + method + '" does not exist on jQuery.fileUploadUI');
        }
    };
