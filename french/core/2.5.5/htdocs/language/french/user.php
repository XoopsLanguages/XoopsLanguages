...
define("_US_NOPROBLEM","Pas de problème. Entrez simplement l'adresse email que vous avez fournie pour votre inscription.");
...
define("_US_ALLOWVIEWEMAIL","Autoriser les autres utilisateurs à voir mon adresse email");
...
define("_US_YOURREGISTERED","Vous êtes maintenant enregistré.<br />Un email contenant une clef d'activation de votre compte a été envoyé à l'adresse email que vous nous avez fournie.<br />Avant de vous connecter sur ce site, il est impératif d'activer votre compte en utilisant le lien contenu dans cet email.");
define("_US_YOURREGMAILNG","Vous êtes maintenant enregistré.<br />Cependant, nous sommes dans l'incapacité d'envoyer l'email d'activation à votre adresse email en raison d'une erreur interne qui est survenue sur notre serveur.<br />Nous sommes désolés pour cet incident, merci d'envoyer un email de notification à l'administrateur du site.");
define("_US_YOURREGISTERED2","Vous êtes maintenant enregistré.<br />Merci de patienter afin que votre compte soit activé par un des administrateurs.<br />Vous recevrez un email lorsqu'il aura été activé. Ceci peut prendre de quelques minutes à quelques jours, merci d'être patient.");
// %s is your site name
...
define("_US_EXTRAINFO","Informations complémentaires");
