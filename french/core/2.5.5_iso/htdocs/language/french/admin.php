...
define("_AD_NORIGHT","Vous n'avez pas les permissions pour accéder à cette zone");
define("_AD_ACTION","Action");
define("_AD_EDIT","Editer");
define("_AD_DELETE","Effacer");
define("_AD_LASTTENUSERS","Les 10 derniers utilisateurs enregistrés");
define("_AD_NICKNAME","Identifiant");
...
define("_AD_WARNINGXOOPSLIBINSIDE","<span style='color:red; font-weight: bold;'>AVERTISSEMENT</span> : Le dossier \"%s\" est à la racine de votre site ! <br />Pour des raisons de sécurité, il est fortement recommandé de déplacer ce dossier à l'extérieur de la racine de votre site.");
