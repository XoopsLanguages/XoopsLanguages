...
define("_AM_TDMCREATE_THEREARE_NUMMODULES","&#45; <span class='red bold'>%s</span> modules stored in the Database");
define("_AM_TDMCREATE_THEREARE_NUMTABLES","&#45; <span class='red bold'>%s</span> tables stored in the Database");

define("_AM_TDMCREATE_FIELD_MORE_ELEMENTS","Forms: Elements");
define("_AM_TDMCREATE_FIELD_MORE_DISPLAY_ADMIN","Page: Show admin");
define("_AM_TDMCREATE_FIELD_MORE_DISPLAY_USER","Page: View User");
define("_AM_TDMCREATE_FIELD_MORE_BLOC","Bloc: View");
define("_AM_TDMCREATE_FIELD_MORE_MAIN_FIELD","Table: Main Field");
define("_AM_TDMCREATE_FIELD_MORE_SEARCH","Search: Index");
define("_AM_TDMCREATE_FIELD_MORE_REQUIRED","Forms: Requires field");
...
define("_AM_TDMCREATE_NB_CHAMPS","Number of fields");
...
define("_AM_TDMCREATE_MODULE_EDIT","Create a module");
...
define("_AM_TDMCREATE_MODULE_AUTHOR_MAIL","Email the author");
define("_AM_TDMCREATE_MODULE_AUTHOR_WEBSITE_URL","Site author");
define("_AM_TDMCREATE_MODULE_AUTHOR_WEBSITE_NAME","Site Name");
...
define("_AM_TDMCREATE_MODULE_RELEASE_FILE","File attached to the release");
define("_AM_TDMCREATE_MODULE_MANUAL","Manual");	
define("_AM_TDMCREATE_MODULE_MANUAL_FILE","Manual file");
define("_AM_TDMCREATE_MODULE_IMAGE","Logo");
define("_AM_TDMCREATE_MODULE_DEMO_SITE_URL","Address of the demo site");	
define("_AM_TDMCREATE_MODULE_DEMO_SITE_NAME","Title of the demo site");	
define("_AM_TDMCREATE_MODULE_FORUM_SITE_URL","Topic URL");
define("_AM_TDMCREATE_MODULE_FORUM_SITE_NAME","Topic URL Title");
define("_AM_TDMCREATE_MODULE_WEBSITE_URL","Website Module");
define("_AM_TDMCREATE_MODULE_WEBSITE_NAME","Website Title Module");
...
define("_AM_TDMCREATE_MODULE_ACTIVE_COMS","Enable Comments");

//Tables.php
//Form1
define("_AM_TDMCREATE_TABLE_ADD","Add tables to the form:");
define("_AM_TDMCREATE_TABLE_EDIT","Changing Tables Module");
define("_AM_TDMCREATE_TABLE_MODULES","Choose the module");
define("_AM_TDMCREATE_TABLE_NAME","Name of the table <br> <i>(The name of the module will automatically be added to the prefix)</i> <br> Example: &#39;nome_modulo&#39;_&#39;table&#39;_");
define("_AM_TDMCREATE_TABLE_NB_CHAMPS","Number of fields in this table <br> <i>in this version of the module, you can not add new fields after this form <br> properly calculates what you need</i>");
define("_AM_TDMCREATE_TABLE_IMAGE","Table Logo");
define("_AM_TDMCREATE_TABLE_BLOCS","Create a new block for this table");
define("_AM_TDMCREATE_TABLE_BLOCS_DESC","(blocs: random, latest, today)");
define("_AM_TDMCREATE_TABLE_DISPLAY_ADMIN","Use the side view of TAB Admin");
define("_AM_TDMCREATE_TABLE_DISPLAY_USER","Use the side view of TAB Member");
define("_AM_TDMCREATE_TABLE_DISPLAY_SUMENU","Use view TAB Submenu");
define("_AM_TDMCREATE_TABLE_SUBMITTER","Add champ submitter?");
define("_AM_TDMCREATE_TABLE_CREATED","Add champ date created?");
define("_AM_TDMCREATE_TABLE_ONLINE","Add champ online?");
define("_AM_TDMCREATE_TABLE_SEARCH","Active research for this table <br> <i>the form for the moment, is able to handle the search on the table <br> If you confirm the search option will be disabled</i>");
define("_AM_TDMCREATE_TABLE_EXIST","The name specified for this table is already in use");
define("_AM_TDMCREATE_TABLE_COMS","Enable the search in this table <br> <i>the module can manage for the moment, the coms on a table <br> Coms option will be disabled if you Confirmed</i>");
define("_AM_TDMCREATE_TABLE_TOPIC_ADD","Add the table to the category");
// v1.38
...
//Form2
define("_AM_TDMCREATE_FIELD_ADD","Enter the fields");
define("_AM_TDMCREATE_FIELD_EDIT","Edit your field");
define("_AM_TDMCREATE_FIELD_NAME","Field");
define("_AM_TDMCREATE_FIELD_TYPE","Type");
define("_AM_TDMCREATE_FIELD_VALEUR","Value");
define("_AM_TDMCREATE_FIELD_ATTRIBUTS","Attributes");
define("_AM_TDMCREATE_FIELD_NULL","Null");
define("_AM_TDMCREATE_FIELD_DEFAULT","Default");
define("_AM_TDMCREATE_FIELD_KEY","Key");
define("_AM_TDMCREATE_FIELD_MORE","More");
...
//Creation
//OK
define("_AM_TDMCREATE_CONST_OK_ARCHITECTURE","Created architecture module (index.html, icons ,...)");
...
define("_AM_TDMCREATE_TABLE_LIST","Tables List");
