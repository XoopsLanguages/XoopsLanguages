...
define('_MD_AM_DBERROR','áã íÊã ÊÍÏíË ÞÇÚÏÉ ÇáÈíÇäÇÊ áÍÏæË Îáá');
...
define('_MD_AM_PERMADDNG','áÇ íãßä %s ÅÚØÇÁ ÇáÊÕÑíÍ %s ááãÌãæÚÉ %s');
define('_MD_AM_PERMADDOK','Êã ÇÚØÇÁ ÇáÕáÇÍíÉ ááãÌãæÚÉ (ÇáÕáÇÍíÉ : %s ÇáãÌãæÚÉ : %s)');
define('_MD_AM_PERMRESETNG','áÇ íãßä ÅÚÇÏÉ ÇáÊÕÑíÍ ááÈÑäÇãÌ  %s');
define('_MD_AM_PERMADDNGP','íÌÈ ÊÍÏíÏ ßá ÇáÇÎÊíÇÑÇÊ ÇáÑÆíÓíÉ');
