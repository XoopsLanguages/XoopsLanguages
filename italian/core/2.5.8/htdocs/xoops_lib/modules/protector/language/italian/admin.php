...
define('_AM_ADV_USETRANSSID',"Il tuo ID di sessione sar&agrave; mostrato nei tag ancora, ecc...<br>Per prevenire il dirottamento di sessione (session hijacking), aggiungi la seguente linea al tuo file .htaccess nella root principale.<br><b>php_flag session.use_trans_sid off</b>");
