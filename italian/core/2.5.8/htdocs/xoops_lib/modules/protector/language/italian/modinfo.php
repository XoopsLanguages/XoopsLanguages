...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined($constpref.'_LOADED')) {
    ...
    define($constpref . '_SAN_NULLBYTEDSC',"Il carattere terminale &quot;\0&quot; &egrave; spesso utilizzato negli attacchi malevoli.<br>Ogni null-byte verr&agrave; sostituito con uno spazio.<br>(Raccomandato: S&igrave;)");
    define($constpref . '_DIE_NULLBYTE',"Esci se viene identificato un null-bytes");
    define($constpref . '_DIE_NULLBYTEDSC',"Il carattere terminale &quot;\0&quot; &egrave; spesso utilizzato negli attacchi malevoli.<br>(Raccomandato: S&igrave;)");
    ...
    define($constpref . '_ISOCOM_ACTIONDSC',"Anti iniezione SQL:<br>Seleziona l'azione da intraprendere qualora sia identificato un commento isolato (&quot;/*&quot;).<br>&quot;Sterilizzazione&quot; significa aggiungere un altro &quot;*/&quot; in coda.<br>(Raccomandato: Sterilizzazione)");
    define($constpref . '_UNION_ACTION',"Azione se rilevato UNION");
    define($constpref . '_UNION_ACTIONDSC',"Anti iniziezione SQL:<br>Seleziona l'azione da intraprendere qualora sia identificata una sintassi di tipo UNION.<br>&quot;Sterilizza&quot; significa sostituire la parola chiave &quot;union&quot; in &quot;uni-on&quot;.<br>(Raccomandato: Sterilizza)");
    define($constpref . '_ID_INTVAL',"Forza valori interi per le variabili tipo id");
    define($constpref . '_ID_INTVALDSC',"Tutte le richieste di parametri &quot;*id&quot; verranno trattate come numeri interi.<br>Questa opzione protegge da alcuni tipi di attacchi XSS e a iniezione SQL.<br>(Raccomandato: S&igrave; - Pu&ograve;causare problemi con alcuni moduli)");
    ...
    define($constpref . '_DOS_CRSAFEDSC',"Un pattern regex per gli User-Agent.<br>Se coincidente, il crawler non sar&agrave; mai considerato troppo invasivo.<br>(es.) /(msnbot|Googlebot|Yahoo! Slurp)/i");
    ...
    define($constpref . '_BIP_EXCEPTDSC',"Un utente appartenente ai gruppi specificati non sar&agrave; mai espulso.<br>(Raccomandato: tutti i gruppi di Amministrazione)");
    ...
    define($constpref . '_SPAMURI4GDSC',"Se in un invio di dati POST da parte di un utente anonimi sono rilevati pi&ugrave; indirizzi URL di quanto consentito qui, l\'invio viene considerato SPAM. Impostare 0 per disabilitare questa funzionalit&agrave;..");

    //3.40b
    define($constpref . '_ADMINHOME',"Dashboard");
