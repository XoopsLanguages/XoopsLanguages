...
Si &egrave; verificato l'evento {X_NOTIFY_EVENT} sul {X_ITEM_TYPE} "{X_ITEM_TILE}"
...
Se si &egrave; trattato di un errore o se non vuoi ricevere altri messaggi di notifica 
