...
define('_TZ_GMTM1',"(GMT-1:00) Azzorre, Isole di Capo Verde");
define('_TZ_GMT0',"(GMT) Greenwich, Londra, Dublino, Lisbona, Casablanca, Monrovia");
define('_TZ_GMTP1',"(GMT+1:00) Amsterdam, Berlino, Roma, Copenhagen, Bruxelles, Madrid, Parigi");
define('_TZ_GMTP2',"(GMT+2:00) Atene, Istanbul, Minsk, Helsinki, Gerusalemme, Sud Africa");
define('_TZ_GMTP3',"(GMT+3:00) Baghdad, Kuwait, Riyadh, Mosca, San Pietroburgo");
...
define('_TZ_GMTP55',"(GMT+5:30) Bombay, Calcutta, Madras, Nuova Delhi");
