...
define('_MD_AM_USEMYSESSDSC',"Selezionare 'S&igrave;' per impostare le opzioni relative alla sessioni.");
...
define('_MD_AM_MYIPDSC',"Questo IP non sar&agrave; conteggiato come visualizzazione di banner");
...
define('_MD_AM_THEMEFILE',"Permettere/visualizzare le modifiche a temi e template?");
define('_MD_AM_THEMEFILEDSC',"Se questa opzione &egrave; abilitata il tema e/o i template modificati saranno ricompilati in automatico a ogni aggiornamento della pagina visualizzando eventuali modifiche.<br>Sconsigliato su siti in produzione.");
...
define('_MD_AM_SOAP_CLIENTDESC',"Questo &egrave; l'indirizzo del server SOAP.");
...
define('_MD_AM_SOAP_FIELDMAPPINGDESC',"Definire qui la corrispondenza tra il campo del database Xoops e il campo del sistema di autenticazione LDAP<br><br>Formato: [Campo Database Xoops]=[Attributo sistema SOAP]<br>per esempio : email=mail<br>Separare ciascuna coppia di campi con <b>|</b><br><br>!! Per utenti esperti !!");
...
define('_MD_AM_LDAP_USETLS_DESC',"Imposta una connessione TLS (Transport Layer Security).<br>TLS utlizza di default la porta 389.<br> La versione LDAP deve essere impostata sul valore '3'.");
...
define('_MD_AM_LDAP_LOGINNAME_ASDN_D',"Il nome utente XOOPS sar&agrave; usato nel DN LDAP<br>(es : uid=<loginname>,dc=xoops,dc=org)<br>Il dato viene letto direttamente dal server LDAP, senza ricerca.");
define('_MD_AM_LDAP_FILTER_PERSON',"Filtro per la ricerca utente usato da LDAP");
define('_MD_AM_LDAP_FILTER_PERSON_DESC',"Filtro speciale LDAP per la ricerca di un utente. @@loginname@@ viene sostituito dall'id di accesso dell'utente<br> LASCIARE IN BIANCO SE NON SI CONOSCE IL CODICE!<br>Es : (&(objectclass=person)(samaccountname=@@loginname@@)) per AD<br>Es : (&(objectclass=inetOrgPerson)(uid=@@loginname@@)) per LDAP");
...
define('_MD_AM_LDAP_PROVIS_GROUP_DSC',"I nuovi utenti sono inseriti in questi gruppi");
define('_MD_AM_LDAP_FIELD_MAPPING_ATTR',"Mappatura campi server Xoops-Auth");
define('_MD_AM_LDAP_FIELD_MAPPING_DESC',"Definire qui la corrispondenza tra il campo del database Xoops e il campo del sistema di autenticazione LDAP<br><br>Formato: [Campo Databse Xoops]=[Attributo sistema LDAP]<br>per esempio : email=mail<br>Separaree ciascuna coppia di campi con <b>|</b><br><br>!! Per utenti esperti !!");
define('_MD_AM_LDAP_PROVIS_UPD',"Sincronizzazione della gestione dell'account Xoops");
define('_MD_AM_LDAP_PROVIS_UPD_DESC',"L'account utente Xoops sar&agrave; sempre sincronizzato con il server di autenticazione");
