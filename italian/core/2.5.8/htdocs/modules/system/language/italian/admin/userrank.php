...
define('_AM_SYSTEM_USERRANK_EDIT',"Modifica livello");
define('_AM_SYSTEM_USERRANK_IMAGE',"Immagine");
define('_AM_SYSTEM_USERRANK_IMAGE_PATH',"Percorso file: %s");
define('_AM_SYSTEM_USERRANK_MAXPOST',"Post massimi");
define('_AM_SYSTEM_USERRANK_MINPOST',"Post minimi");
define('_AM_SYSTEM_USERRANK_OFF',"Livello speciale");
define('_AM_SYSTEM_USERRANK_ON',"Livello normale");
define('_AM_SYSTEM_USERRANK_SAVE',_AM_SYSTEM_DBUPDATED);
define('_AM_SYSTEM_USERRANK_SPECIAL',"Livello speciale");
define('_AM_SYSTEM_USERRANK_SPECIAL_CAN',"(I livelli speciali possono essere assegnati agli utenti indipendentemente dal numero di messaggi)");
...
define('_AM_SYSTEM_USERRANK_TIPS_FORM2',"<li>Dimensione massima del file: %s kb</li></ul>");
