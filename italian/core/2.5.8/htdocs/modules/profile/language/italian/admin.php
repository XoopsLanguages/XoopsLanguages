...
define('_PROFILE_AM_YESNO',"Bottoni S&igrave;/No");
...
define('_PROFILE_AM_USERCREATED',"Data di registrazione");
    define('_PROFILE_AM_CANNOTDELETESELF',"Non &egrave; permesso eliminare il proprio account - use your profile page to delete your own account");
