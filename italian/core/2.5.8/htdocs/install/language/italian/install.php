...
define('XOOPS_URL_HELP',"L'indirizzo principale che sar&agrave; utilizzato per accedere al vostro sito XOOPS."); // L58
...
define('DB_HOST_HELP',"Hostname del server del database.<br>Se non si &egrave; sicuri, <em>localhost</em> funzioner&agrave; nella maggior parte dei casi."); // L67
...
define('DB_NAME_HELP',"Nome del database su server.<br>Il programma di installazione tenter&agrave; di creare il database se non esiste."); // L64
define('DB_CHARSET_LABEL',"Set di caratteri del database");
define('DB_CHARSET_HELP',"MySQL include un supporto per set di caratteri che permette di archiviare i dati utilizzando diversi set di caratteri ed eseguire delle comparazioni rispetto a differenti collazioni.<br>Il set di default &egrave; adeguato per la maggior parte dei casi.");
define('DB_COLLATION_LABEL',"Collation del database");
define('DB_COLLATION_HELP',"Una collation &egrave; un inseme di regole per comparare i caratteri in un set caratteri.");
define('DB_PREFIX_LABEL',"Prefisso delle tabelle");    // L30
define('DB_PREFIX_HELP',"Questo prefisso sar&agrave; aggiunto a tutte le nuove tabelle generate per evitare conflitti di nomi nel database.<br>Se non si &egrave; sicuri utilizzare il valore gi&agrave; presente."); // L63
define('DB_PCONNECT_LABEL',"Utilizzare connessioni persistenti");    // L54
define('DB_PCONNECT_HELP',"Valore di default: &quot;NO&quot;.<br>Selezionare &quot;NO&quot; se non si &egrave; sicuri."); // L69
...
define('FILTER_FUNCTIONS',"Funzioni Filtro"); // Aggiunto in 2.5.5-rc
...
define('NO_MODULES_FOUND',"Non &egrave; stato trovato alcun modulo.<br>Premere <strong>Avanti</strong> per procedere al passo successivo.");
define('NO_INSTALLED_MODULES',"Nessun modulo installato.<br>Premere <strong>Avanti</strong> per procedere al passo successivo.");
define('THEME_NO_SCREENSHOT',"Non &egrave; presente alcuna miniatura");
define('IS_VALOR'," => ");
// password message
...
//2.5.7
define('WRITTEN_LICENSE',"Scritta Licenza XOOPS %s. Chiave licenza: <strong>%s</strong>");
//2.5.8
define('CHMOD_CHGRP_REPEAT',"Riprova");
define('CHMOD_CHGRP_IGNORE',"Utilizzare comunque");
