...
define("_SR_NOMATCH","Nessun risultato per la ricerca effettuata");
define("_SR_FOUND","Sono stati trovati <strong>%s</strong> risultati");
define("_SR_SHOWING","(Visualizza %d - %d)");
define("_SR_ANY","Almeno una (OR)");
define("_SR_ALL","Tutte (AND)");
