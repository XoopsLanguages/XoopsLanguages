...
define('_MD_PLZINSTALL','Premere il pulsante di seguito per avviare l\'installazione');
define('_MD_PLZGENERATE','Premere il pulsante di seguito per generare i template');
define('_MD_CLONETHEME','Clona un set di template');
define('_MD_THEMENAME','Set di template base');
define('_MD_NEWNAME','Inserire un nuovo nome per il set di template');
define('_MD_IMPORT','Importa');
define('_MD_RUSUREIMPT','Importando i dati dalla cartella dei template le modifiche che fatte nel database saranno sovrascritte.<br />Premere "Importa" per procedere.');
define('_MD_THMSETNAME','Nome');
define('_MD_CREATED','Data di creazione');
...
define('_MD_CHOOSEFILE','Secegliere un file da caricare');
define('_MD_UPWILLREPLACE','Il caricamento di questo template sovrascriver&agrave; i templates presente nel database!');
define('_MD_UPLOADTAR','Caricamento set di templates');
define('_MD_CHOOSETAR','Scegli un pacchetto di template da caricare');
define('_MD_ONLYTAR','Deve essere un file tar.gz/.tar con una struttura di template valida per XOOPS');
define('_MD_NTHEMENAME','Nuovo nome per il set di templates');
define('_MD_ENTERTH','Inserire un nome per il set di template di questo pacchetto. Lasciare vuoto per il riconoscimento automatico.');
...
define('_MD_AM_ERRTHEME','I seguenti set di template non hanno dati validi negli skin file. Premi \'Elimina\' per rimuovere i dati relativi al set di template.');
...
define('_MD_FILENEWER','Un template pi&ugrave; recente non ancora importato &egrave; ancora presente nella cartella <strong>templates</strong>.');
define('_MD_FILEIMPORT','Un vecchio template non importato &egrave; ancora presente nella cartella <strong>templates</strong>.');
define('_MD_FILEGENER','Il template non esiste. Pu&ograve; essere generato (copiato dal template di <strong>default</strong>), caricato o importato dalla cartella <strong>templates</strong>.');
?>
