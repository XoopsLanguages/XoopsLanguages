...
$content .= '
<p><acronym title="eXtensible Object-Oriented Portal System">XOOPS</acronym> &egrave; un applicativo web open source per la gestione di contenuti, orientato agli oggetti e scritto in PHP.<br />&Egrave; lo strumento ideale per sviluppare piccoli e grandi siti web, portali intranet per aziende e molto altro.</p>
<p>XOOPS viene rilasciato secondo i termini della <a href="http://www.gnu.org/copyleft/gpl.html" rel="external">Licenza GNU General Public (GPL)</a> e pu&ograve; essere utilizzato e modificato gratuitamente. Pu&ograve; essere inoltre liberamente distribuito tenendo fede ai termini di distribuzione descritti dalla stessa GPL.</p>
<h3>Requisiti</h3>
<ul>
