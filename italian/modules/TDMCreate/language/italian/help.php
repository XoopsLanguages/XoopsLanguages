...
define ("_AM_TDMCREATE_HELP_DESCRIPTION_DESC", "Il modulo TDMCreate può essere utilizzato per creare nuovi moduli di XOOPS <br /> <br />");
...
define ("_AM_TDMCREATE_HELP_OPERATINGINSTRUCTIONS_DESC", "Il modulo Sondaggi è molto semplice da configurare e utilizzare Fondamentalmente è necessario:. <br /> <br />
i) Creare uno o più sondaggi per le persone a votare (amministrazione Sondaggi -> Aggiungi sondaggio) <br /> <br />
ii) Visualizza il Sondaggi blocco da qualche parte sul tuo sito web (non &#232; strettamente necessario che le persone possono anche accedervi attraverso il &#232; link nel menu principale, ma la visualizzazione del blocco sondaggi in una posizione prominente incoraggerà la gente di voto) <br /> <br />
