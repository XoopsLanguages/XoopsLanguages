...
define("_MESSAGEICON","Lekmee Tarma");
define("_COMMENTS","Yelas");
define("_POSTANON","Thar'Ai'er");
define("_DISABLESMILEY","Tamp'smiley");
define("_DISABLEHTML","Tamp'html");
define("_PREVIEW","Dae");
...
define("_POSTEDBY","Lle'Lekmee ya");
define("_VISITWEBSITE","Aut'Parma");
define("_SENDPMTO","Fain Dina Lekmee a\' %s");
define("_SENDEMAILTO","Fain E-Lekmee a\' %s");
define("_ADD","Onot");
define("_REPLY","Yellekmee");
define("_DATE","Yaluumesse");   // Lle'Lekmee date

//%%%%%%	Ai Parma Esse admin_functions.php 	%%%%%
define("_MAIN","Yeste'");
define("_MANUAL","Soor");
define("_INFO","Dalnya");
define("_CPHOME","Cala'Quessir Eska");
define("_YOURHOME","Eska Soronuume");
...
//%%%%%%	Ai Parma Esse ai parma.textsanitizer.php 	%%%%%
define("_QUOTEC","Suil'Lekmee:");

//%%%%%%	Ai Parma Esse admin.php 	%%%%%
define("_NOPERM","Aiya, lle n'sinome leneema tul'lema sinamen'.");
...
define("_DELETE","Kela");
define("_SUBMIT","Sama");
define("_MODULENOEXIST","lem'ai parma tel'anwa turs'sinta!");
define("_ALIGN","Yamen'");
define("_LEFT","Hyarya");
...
define('_IMGMAXWIDTH','Leneem\'alta width (pixels):');
define('_IMGMAXHEIGHT','Leneem\'alta height (pixels):');
define('_IMAGECAT','Ukin:');
define('_IMAGEFILE','Image ai parma:');
...
define("_ENTERCODE","Enter tanya codes tanya lle want a\' add.");
define("_ENTERQUOTE","Enter tanya text tanya lle want a\' be quoted.");
define("_ENTERTEXTBOX","Please input text into tanya textbox.");
define("_ALLOWEDCHAR","Ilyaowed max chars length: ");
define("_CURRCHAR","Current chars length: ");
define("_PLZCOMPLETE","Please complete tanya subject and lekmee fields.");
...
/*
Tanya following tengwanda kerta are recognized yassene tanya format string:
a - "am" or "pm"
A - "AM" or "PM"
d - day en tanya month, 2 digits yassen leading zeros; i.e. "01" a\' "31"
D - day en tanya week, textual, 3 letters; i.e. "Fri"
F - month, textual, an; i.e. "January"
h - hour, 12-hour format; i.e. "01" a\' "12"
H - hour, 24-hour format; i.e. "00" a\' "23"
g - hour, 12-hour format avaene leading zeros; i.e. "1" a\' "12"
G - hour, 24-hour format avaene leading zeros; i.e. "0" a\' "23"
i - minutes; i.e. "00" a\' "59"
j - day en tanya month avaene leading zeros; i.e. "1" a\' "31"
l (lowercase 'L') - day en tanya week, textual, an; i.e. "Friday"
L - boolean ten'whether it ta a\' leap year; i.e. "0" or "1"
m - month; i.e. "01" a\' "12"
...
w - day en tanya week, numeric, i.e. "0" (Sunday) a\' "6" (Saturday)
Y - year, 4 digits; i.e. "1999"
y - year, 2 digits; i.e. "99"
z - day en tanya year; i.e. "0" a\' "365"
Z - coiasirazone offset yassene seconds (i.e. "-43200" a\' "43200")
*/
