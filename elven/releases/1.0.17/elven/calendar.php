...
define("_CAL_TGL1STD", "Toggle first day en week");
define("_CAL_PREVYR", "Prev. year (hold ten'menu)");
define("_CAL_PREVMNTH", "Prev. month (hold ten'menu)");
define("_CAL_GOTODAY", "Na'Sii' Today");
define("_CAL_NXTMNTH", "Ento month (hold ten'menu)");
define("_CAL_NEXTYR", "Ento year (hold ten'menu)");
define("_CAL_SELDATE", "Dethol\'menin date");
define("_CAL_DRAGMOVE", "Drag a\' move");
