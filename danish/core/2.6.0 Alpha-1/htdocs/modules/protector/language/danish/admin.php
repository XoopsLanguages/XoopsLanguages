...
*****************************************/
//index.php
define("_AM_PROTECTOR_NBALERT", "Der er %s alarmer");

// advisory.php
define("_AM_ADV_ACTION", "Handling");
define("_AM_ADV_INFO", "Information");
define("_AM_ADV_STATUS", "Status");
define("_AM_ADV_TYPE", "Type af security");
define("_AM_ADV_VIEW", "Information");

// prefix_manager.php
define("_AM_PROTECTOR_PREFIX", "PREFIX");
define("_AM_PROTECTOR_PREFIX_ACTIONS", "HANDLINGER");
define("_AM_PROTECTOR_PREFIX_CHANGEDB", "Ændre prefix");
define("_AM_PROTECTOR_PREFIX_CHANGEDBLINE", "Linje: define('XOOPS_DB_PREFIX', '<b>%s</b>');");
define("_AM_PROTECTOR_PREFIX_COPY", "COPIER");
define("_AM_PROTECTOR_PREFIX_ERROR_CT", "FEJL: CREATE TABLE (%s)");
define("_AM_PROTECTOR_PREFIX_ERROR_CTDWT", "Du kan ikke droppe virksomme tabeller");
define("_AM_PROTECTOR_PREFIX_ERROR_II", "FEJL: INSERT INTO (%s)");
define("_AM_PROTECTOR_PREFIX_ERROR_NACT", "Du kan ikke kopiere tabeller");
define("_AM_PROTECTOR_PREFIX_ERROR_NADT", "Du må ikke slette tabeller");
define("_AM_PROTECTOR_PREFIX_ERROR_NPX", "Dette er ikke et XOOPS prefiks");
define("_AM_PROTECTOR_PREFIX_ERROR_SCT", "FEJL: SHOW CREATE TABLE (%s)");
define("_AM_PROTECTOR_PREFIX_ERROR_WP", "forkert prefix");
define("_AM_PROTECTOR_PREFIX_LOG", "Log");
define("_AM_PROTECTOR_PREFIX_TABLES", "TABLES");
define("_AM_PROTECTOR_PREFIX_UPDATED", "OPDATERET");