...
define("_TAKINGBACK","Tager dig tilbage hvor du kom fra....");
...
define("_DISABLESMILEY","Slå smileys fra");
define("_DISABLEHTML","Slå html fra");
...
define("_MORE","mere...");
define("_MULTIPAGE","For at dele din artikel over flere sider, indsæt <font color=red>[pagebreak]</font> (med sparentes) i artiklen.");
define("_IFNOTRELOAD","Hvis siden ikke indlæses automatisk, klik <a href='%s'>her</a>");
...
define('_MUSTWABLE','Filen %s skal være skrivbar for serveren!'); // %s represents file name
