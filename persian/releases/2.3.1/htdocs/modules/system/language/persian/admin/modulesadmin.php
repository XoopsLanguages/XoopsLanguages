...
define("_MD_AM_BTOMADMIN","بازگشت به صفحهٔ اصلی مدیریت ماژول‌ها");
...
define('_MD_AM_RUSUREINS', 'برای نصب ماژول دکمهٔ زیر را بزنید');
define('_MD_AM_RUSUREUPD', 'برای به روز کردن ماژول دکمهٔ زیر را بزنید');
...
define('_MD_AM_MODULEID', ' شمارهٔ ماژول: %s');
...
define('_MD_AM_GROUP_ID', ' شمارهٔ گروه: %s ');
...
define('_MD_AM_BLOCK_ID', ' شمارهٔ بلاک: %s ');
