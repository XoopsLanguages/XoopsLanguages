...
<ol>
   ...
   <li>یک شناسه‌ی کاربری برای پایگاه‌داده‌ای که ساخته‌اید ایجاد کرده‌باشید و این شناسه را به پایگاه‌داده اختصاص داده باشید.</li>
	...
	<li>اگر شما ماژول <em>protector</em> را نصب میکنید, <div class="confirmMsg">فایل <em>mainfile.dist.php</em> را در ریشه سایت خود با فایل <em>/extras/mainfile.dist.php.protector</em> جایگزین کنید.</div></li>
