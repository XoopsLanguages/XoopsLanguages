...
define("_PROFILE_AM_FLOAT","نقطه شناور");
define("_PROFILE_AM_DECIMAL","عدد اعشاری");
define("_PROFILE_AM_UNICODE_ARRAY","آرایه یونیکد");
define("_PROFILE_AM_UNICODE_EMAIL","ایمیل یونیکد");
define("_PROFILE_AM_UNICODE_TXTAREA","منطقه متن یونیکد");
define("_PROFILE_AM_UNICODE_TXTBOX","فیلد متنی یونیکد");
define("_PROFILE_AM_UNICODE_URL","آدرس یونیکد");
...
define("_PROFILE_AM_PROF_ACCESS_DESC", 
        "<ul>" .
        "<li>گروه وب‌مسترها: اگر کاربر عضو گروه وب‌مسترها باشد, کاربر مورد نظر در صورتی دسترسی دارد که یکی از گروه هایی که کاربر عضو آن است دسترسی گروه وب مستر ها را داشته باشد; در غیر این صورت</li>" .
        "<li>گروهی غیر از گروه های پایه: اگر کاربر عضو یک یا چند گروه غیر از گروه های پایه باشد (یعنی  وب‌مسترها, كاربران عضو, مهمان), کاربر مورد نظر در صورتی دسترسی دارد که گروه فعلی او اجازه دسترسی به یکی از گروه های غیر اصلی سایت را بدهد; در غیر این صورت</li>" .
        "<li>گروه كاربران عضو: اگر کاربر عضو گروه كاربران عضو باشد, کاربر مورد نظر در صورتی درسترسی دارد که اگر و فقط اگر یکی از گروه های که کاربر عضو آن است گروه کاربران عضو باشد</li>" .
        "</ul>");
...
define("_PROFILE_AM_AUTOTEXT","متن خودکار");
define("_PROFILE_AM_DATETIME","تاریخ و زمان");
define("_PROFILE_AM_LONGDATE","تاریخ طولانی");
...
define("_PROFILE_AM_CANNOTDELETEADMIN","شما اجازه حذف شناسه مدیریتی را ندارید");
...
//1.62
define('_PROFILE_AM_ACTION','عملکرد');
//1.63
define('_PROFILE_AM_REQUIRED_TOGGLE','تعویض فیلد های ضروری');
define('_PROFILE_AM_REQUIRED_TOGGLE_SUCCESS','فیلد های مورد نیاز با موفقیت تغییر کرد');
define('_PROFILE_AM_REQUIRED_TOGGLE_FAILED','تغییر فیلد های ضروری نا موفق بود');

define('_PROFILE_AM_SAVESTEP_TOGGLE','ذخیره تعویض');
define('_PROFILE_AM_SAVESTEP_TOGGLE_SUCCESS','تغییرات بعد از این مرجله با موفقیت ذخیره شد');
define('_PROFILE_AM_SAVESTEP_TOGGLE_FAILED',"تغییر 'بعد از این مرجله' موفقیت آمیز نبود");
