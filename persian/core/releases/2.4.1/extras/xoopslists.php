...
if (! defined('XOOPS_LISTS_INCLUDED')) {
    ...
    class XoopsLists
    {
        ...
        {
            $time_zone_list = false;
            if (file_exists($file = XOOPS_ROOT_PATH . '/language/' . $GLOBALS['xoopsConfig']['language'] . '/timezone.php')) {
                include_once $file;
                // start hack for 30 min 30 min timezone
                ...
                trigger_error('Lanaguge file not found: ' . str_replace(XOOPS_ROOT_PATH, '', $file) . ' in file:' . __FILE__ . ' line ' . __LINE__);
            }
            return $time_zone_list;
        }
