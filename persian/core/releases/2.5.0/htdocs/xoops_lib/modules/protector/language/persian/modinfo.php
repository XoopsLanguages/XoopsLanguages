...
define($constpref.'_HIJACK_DENYGPDSC','مقابله با دزدی جلسه (Anti Session Hi-Jacking):<br />گروه ‌های که IP شان در جلسه بین زوپس و کاربر نباید تغییر کند انتخاب کنید.<br />(پیشن‌هاد میشود فقط برای وب مستر ‌ها روشن باشد.)<br /><br />Session Hi-Jacking(دزدی جلسه): در اصل ترکیب ماهرانه ای است از دو نوع حمله ی دزدین IP و استراق سمع با این روش حمله یک م‌هاجم خودش را به جای شما جا زده و اقدام به ادامه دادن کار ‌ها و فعالیت ‌های شما در سایت مطابق خواسته ی خود میکند البته در حدی که شما دسترسی دارید');
...
define($constpref.'_CONTAMI_ACTIONDS','رفتاری را که میخواید در برابر کاربری که قصد وارد کمردن داده ‌های نا مناسب به سیستم زوپس شما را دارد انجام شود مشخص کنید.<br />(پیشن‌هاد میشود بر روی صفحه ی سفید قرار دهید)');
