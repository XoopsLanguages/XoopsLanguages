...
define('_MESSAGEICON','نشانه‌ی پيام');
define('_COMMENTS','نظر‌‌ها');
define('_POSTANON','فرستنده‌ی ناشناس');
...
define('_MORE','ادامه...');
define('_MULTIPAGE',' برای چند صفحه‌ای کردن نوشته خود در ابتدای آغاز صفحه بعدی جمله‌ی <font color=red>[pagebreak]</font> را قرار دهيد');
...
define('_CPHOME','صفحه‌ی‌کنترل');
define('_YOURHOME','صفحه‌ی‌اول');
//%%%%%%	File Name misc.php (who's-online popup)	%%%%%
define('_WHOSONLINE','چه کسانی در سايت هستند');
define('_GUESTS','مهمان');
define('_MEMBERS','عضو');
define('_ONLINEPHRASE','<strong>%s</strong> کاربر آن‌لاين است');
define('_ONLINEPHRASEX','<strong>%s</strong> کاربر در حال مشاهده‌ی سایت <b>%s</b>');
...
* Image manager
*/
define("_MD_ADDIMGCAT","اضافه کردن شاخه");
define("_MD_IMGCATNAME","نام شاخه");
define("_MD_IMGCATRGRP","انتخاب گروه‌‌های مجاز برای استفاده از تصاویر مدیریت");
define("_MD_IMGCATWGRP","انتخاب گروه‌‌های مجاز برای بارگذاری تصاویر مدیریت");
define("_MD_IMGCATWEIGHT","تعیین محل قرارگیری در مدیریت تصاویر");
define("_MD_IMGCATDISPLAY","نمایش");
define("_MD_IMGCATSTRTYPE","تصویر بارگذاری شد در:");
define("_MD_STRTYOPENG","این گزینه بعدا قبل تغییر نیست!");
define("_MD_ASFILE","ذخیره به صورت فایل (در شاخه uploads)");
define("_MD_INDB","ذخیره در پایگاه داده ‌ها (as binary \"blob\" data)");
...
define('_ENTERURL','لطفا آدرس پیوندی را که می‌خواهید به نوشته‌ی خود اضافه کنید را وارد کنید:');
define('_ENTERWEBTITLE','لطفا نام پیوند را وارد کنید:');
define('_ENTERIMGURL','لطفا آدرس عکسی را که می‌خواهید به نوشته‌ی خود اضافه کنید وارد کنید');
define('_ENTERIMGPOS','حالا مکانی را که می‌خواهید عکس در صفحه قرار بگیرد مشخص کنید');
define('_IMGPOSRORL','\'R\' یا \'r\' برای راست ،\'L\' یا \'l\' برای چپ، و برای اینکه عکس بدون تعین مکان قرار بگیرد این باکس را خالی ر‌ها کنید.');
...
define('_ENTERCODE','کدی را که می‌خواهید به نوشته‌ی خود اضافه کنید وارد کنید.');
define('_ENTERQUOTE','متنی را که می‌خواهید به عنوان نقل قول به نوشته‌ی خود اضافه کنید وارد کنید');
define('_ENTERTEXTBOX','لطفا متن را داخل باکس وارد کنید');
define('_ALLOWEDCHAR','حداکثر مجاز طول نویسه‌‌ها: ');
define('_CURRCHAR','طول نویسه‌‌ها در حال حاضر: ');
define('_PLZCOMPLETE','لطفا عنوان نوشته و متن داخل نوشته را کامل کنید');
define('_MESSAGETOOLONG','نوشته‌ی شما طولانی است');
/**
* xoops smilie
*/
define('_AM_ADDSMILE','اضافه کردن لبخند جدید');
