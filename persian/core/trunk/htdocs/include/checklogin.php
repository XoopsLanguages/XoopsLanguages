...
// EmailLogin begin irmtfan
if( strstr( $_POST['uname'] , '@' ) ) { @list( $uname ) = $xoopsDB->fetchRow( $xoopsDB->query( "SELECT uname FROM ".$xoopsDB->prefix('users')." WHERE email='".$myts->addSlashes($_POST['uname'])."'" ) ) ; } 
// EmailLogin end irmtfan
// Place here the Auth class calls //**** BEGIN AUTH ****
