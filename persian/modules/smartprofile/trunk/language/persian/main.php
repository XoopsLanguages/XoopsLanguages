...
define('_PROFILE_MA_AVATAR','تصویر عضو');
...
define('_PROFILE_MA_REGISTERNG','ناتواني در عضو کردن کاربر جديد');
...
define('_PROFILE_MA_YOURREGISTERED2','شما الآن عضو شديد.  لطفا صبر کنيد تا اکانت شما توسط وبمستر فعال شود.هر وقت شناسه شما فعال شد ايميلي در اين باره دريافت خواهيد کرد. اين ممکن است ساعتي طول بکشد پس صبور باشيد.');
...
define('_PROFILE_MA_STATISTICS','آمار');
...
define('_PROFILE_MA_REMOVEINFO','اين عمل تمام اطلاعات شما را از پايگاه داده پاک مي کند');
