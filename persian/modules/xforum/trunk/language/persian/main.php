...
define('_MD_HITS','دفعات دیدن');
define('_MD_GROUPS','گروه‌ها:');
define('_MD_DEL_ONE','فقط این پیام را پاک کن');
define('_MD_DEL_RELATED','این پیام و تمامی پیام‌های مربوط به آن را پاک کن');
...
define('_MD_TOTALPOSTSC','مجموع تمامی پیام‌های زده‌ شده: ');
...
define('_MD_POSTEDON','پیام زده شده در: ');
...
define('_MD_FORUMINDEX','%s صفحه‌ی اصلی انجمن‌ها');
...
define('_MD_NEXTPAGE','صفحه‌ی بعد');
define('_MD_SORTEDBY','مرتب شده بر اساس');
define('_MD_TOPICTITLE','نام عنوان');
define('_MD_NUMBERREPLIES','تعداد پاسخ‌ها');
define('_MD_TOPICPOSTER','ارسال‌کننده‌ی پیام');
define('_MD_TOPICTIME','زمان زده شدن عنوان');
...
define('_MD_PM','پی ام');
define('_MD_EMAIL','ایمیل');
define('_MD_WWW','سایت شخصی');
define('_MD_AIM','AIM');
...
define('_MD_EDITPOLL','این نظر سنجی را ویرایش کن');
define('_MD_DELETEPOLL','این نظر سنجی را حذف کن');
define('_MD_RESTARTPOLL','این نظر سنجی را از اول شروع کن');
define('_MD_ADDPOLL','اضافه کردن نظر سنجی');
define('_MD_ADDTOPIC','تاپیک جدید');
...
define('_MD_NORIGHTTOACCESS','شما اجازه وارد شدن به این انجمن را ندارید.');
define('_MD_ERRORTOPIC','خطا: پیامی انتخاب نشده است.');
define('_MD_ERRORCONNECT','خطا: تماس با دیتابیس انجمن مقدور نیست.');
define('_MD_ERROREXIST','خطا: انجمنی که شما انتخاب کرده‌اید وجود ندارد.');
define('_MD_ERROROCCURED','یک خطا رخ داده‌است.');
define('_MD_COULDNOTQUERY','در دیتابیس انجمن نمی‌توان استفسار کرد.');
...
define('_MD_COULDNOTREMOVE','خطا - هیچ پیامی را نمیتوان پاک کرد.');
define('_MD_COULDNOTREMOVETXT','خطا - نمی‌توان متن پیام‌ها را پاک کرد.');
...
//post.php
define('_MD_EDITNOTALLOWED','شما اجازه‌ی ویرایش این پیام را ندارید.');
define('_MD_EDITEDBY','ویرایش شده توسط ');
define('_MD_ANONNOTALLOWED','کاربران مهمان اجازه‌ی پیام فرستادن ندارند.<br>لطفا ثبت نام کنید');
...
define('_MD_URRECEIVING','شما این ایمیل را دریافت کرده‌اید چرا که به پیام شما در انجمن‌های سایت %s پاسخ داده شده است.'); // %s is your site name
...
define('_MD_POSTING_LIMITED','زدن پیام های پشت سر هم ممنوع است چرا کمی صبر نمی کنید .لطفا %d ثانیه پس از آخرین پست خود در این عنوان پست بزنید');

//forumform.inc
define('_MD_NAMEMAIL','نام/ایمیل:');
...
define('_MD_RETURNFORUMINDEX','بازگشت به صفحه‌ی اصلی انجمن‌ها');
...
define('_MD_DESC_MERGE','وقتی شما دکمه ادغام کن در پایین را می‌زنید، این عنوان که انتخاب کرده اید به همراه  تمام پیام‌های نوشته شده و متعلق به آن با عنوانی که انتخاب خواهید کرد ادغام می شود.<br /><strong>شماره شناسایی (ID) عنوان مقصد باید کوچکتر از این عنوان باشد</strong>.');
...
define('_MD_DESC_UNLOCK','وقتی شما دکمه قفل  را باز کن  در پایین را می‌زنید، این عنوان که انتخاب کرده اید از حالت قفل خارج خواهد شد. شما بعدا اگر بخواهید دوباره می توانید آن را قفل کنید.');
...
// delete.php
define('_MD_DELNOTALLOWED','متأسفم، شما اجازه پاک کردن این پیام را ندارید.');
define('_MD_AREUSUREDEL','مطمئنید که می‌خواهید این پیام و تمامی پیام‌های وابسته به آن را پاک کنید؟');
define('_MD_POSTSDELETED','پیام انتخاب شده و تمامی پیام‌های وابسته‌ی آن پاک شدند!');
define('_MD_POSTDELETED','پیام انتخاب شده پاک شد.');
...
define("_MD_INVALID_SUBMIT","ارسال نا معتبر است. زمان شما برای ارسال در انجمن ها به پایان رسیده است. لطفا دوباره روی دکمه ارساال بزنید یا اگر لاگین نکرده اید یک پشتیبان از پیام خود تهیه کرده و سپس لاگین کنید و پست خود را ارسال کنید");
