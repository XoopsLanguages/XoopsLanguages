...
define("_AM_LAWSUIT_PAGES","صفحات");
define("_AM_LAWSUIT_CATEGORY","شاخه ها");
define("_AM_LAWSUIT_FORMS","فرم ها");
define("_AM_PERM_ACTION","انتخاب نوع دسترسی برای تنظیم");
define("_AM_LAWSUIT_PAGES_PERMHEADER","تنظیم دسترسی صفحات");
define("_AM_LAWSUIT_FORMS_PERMHEADER","تنظیم دسترسی فرم ها");
define("_AM_LAWSUIT_CATEGORY_PERMHEADER","تنظیم دسترسی شاخه ها");
...
define("_AM_CAT_TITLE","نام");
define("_AM_CAT_DOMAIN","دامنه شخصی");
define("_AM_CAT_DOMAINS","دامنه های در ارتباط");

define("_AM_PAGE_DEFAULT","پیش فرض در شاخه");
define("_AM_PAGE_DESCRIPTION","توضیخات صفحه");
define("_AM_PAGE_TITLE","عنوان صفحه");
define("_AM_PAGE_WEIGHT","وزن چینش صفحه");
define("_AM_PAGE_CAT","شاخه صفحه");
define("_AM_PAGE_FORMS","فرم صفحه");
define("_AM_PAGE","توضیح صفحه");
