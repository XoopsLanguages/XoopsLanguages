...
define('_XHELP_SEC_TEXT_FAQ_ADD','اضافه کردن FAQ');
...
define('_XHELP_LOG_NEWFAQ','مقاله FAQ \'%s\' اضافه شد');
...
define('_XHELP_TEXT_PROBLEM','مشکل');
define('_XHELP_TEXT_SOLUTION','حل شده');
define('_XHELP_TEXT_PREVIEW','خصوصی');
define('_XHELP_TEXT_SUBMIT','ارسال');
define('_XHELP_TEXT_ADD_FAQ','اضافه کردن FAQ');
define('_XHELP_TEXT_CATEGORIES','شاخه ها');
...
define('_XHELP_TEXT_ACC_TICKETS','بلیط های قبول شده');
define('_XHELP_TEXT_UNACC_TICKETS','بلیط های قبول نشده');

define('_XHELP_TEXT_REPORTS','گزارش ها');
define('_XHELP_TEXT_REPORT','گزارش');
define('_XHELP_TEXT_REPORT_NAME','نام گزارش');
...
define('_XHELP_TEXT_VIEW_REPORT','دیدن گزارش');

define('_XHELP_TEXT_TOTAL','مجموع');
