...
define('_AM_XHELP_MENU_MANAGE_FAQ','مدیریت  FAQ');
...
define('_AM_XHELP_SEC_TEXT_FAQ_ADD','اضافه کردن FAQs');
...
define('_AM_XHELP_TEXT_VERSION','نسخه');
define('_AM_XHELP_TEXT_PLUGIN_VERSION','نسخه پلاگین ');
define('_AM_XHELP_TEXT_TESTED_VERSIONS','نسخه تست شده');
