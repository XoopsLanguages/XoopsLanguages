<?php
define('_AM_QUIZ_LIST_NUM','حداکثر تعداد آزمون‌هايي که در بخش مديريت در يک صفحه نمايش داده مي‌شوند');
define('_AM_QUEST_LIST_NUM','حداکثر تعداد سوال‌هايي که در بخش مديريت در يک صفحه نمايش داده مي‌شوند');
define('_AM_CATEGORY_LIST_NUM','حداکثر تعداد شاخه‌هایی که در بخش مديريت در يک صفحه نمايش داده مي‌شوند');/////////////add
define('_AM_QUEST_USER_LIST_NUM','حداکثر تعداد کاربرانی که در صفحه‌ي مدیریت آمار در يک صفحه نمايش داده مي‌شوند');
define('_AM_QUIZ_USER_LIST_NUM','حداکثر تعداد آزمون‌هايي که در صفحه‌ي کاربري در يک صفحه نمايش داده مي‌شوند');
define('_AM_QUIZ_QUIZS','آزمون‌ها');
define('_AM_QUIZ_QUESTIONS','سوال‌ها');
define('_AM_QUIZ_STATISTICS','آمار');
define('_AM_QUIZ_INDEX','صفحه اصلي');
define('_AM_QUIZ_PERMISSIONS','مجوزها');
define('_AM_QUIZ_CATEGORY','شاخه');
define('_AM_QUIZ_SEE_SCORE','کاربران بتوانند پس از آزمون نتيجه را ببينند');
define('_AM_QUIZ_SEE_SCORE_DESC','با انتخاب اين گزينه هر کاربر پس از آزمون مي‌تواند نتيجه‌اش را ببيند.در غير اين صورت نتيجه‌ها در پايان زمان هر آزمون قابل مشاهده است.');
define('_AM_QUIZ_ANONYMOUS','فقط کاربران عضو بموانند در آزمون‌ها شرکت کنند.');
define('_AM_QUIZ_SEE_STAT','کاربران مهمان  بتوانند نتایج و آمار آزمون‌ها را ببینند.');
define('_AM_QUIZ_PROFILE_SCORE','کاربران بتوانند پس از آزمون نتيجه را در پروفایل خود ببينند');
define('_AM_QUIZ_PROFILE_SCORE_DESC','با انتخاب اين گزينه هر کاربر پس از آزمون مي‌تواند نتيجه‌اش را در پروفایل خود ببيند.در غير اين صورت نتيجه‌ها در پايان زمان هر آزمون قابل مشاهده است.');
...
define('_AM_QUIZ_MAIL_SCORE_DESC','با انتخاب این گزینه، نتیجه‌ی آزمون پس از شرکت در آزمون برای کاربر ایمیل می‌شود.');
/////////////////////////////////////////////////////
define('_AM_QUIZ_EDITORS','ویرایشگر پیش‌فرض');
?>