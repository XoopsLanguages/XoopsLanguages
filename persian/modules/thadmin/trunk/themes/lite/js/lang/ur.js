...
/* Start open menu from right_to_left - hacked by irmtfan www.jadoogaran.org */
box2.style.Right = ( box1.offsetLeft + this.position.level1.left) + "px";}
/* End open menu from right_to_left - hacked by irmtfan www.jadoogaran.org */
...
/* Start open popup from right_to_left on mouse click - hacked by irmtfan www.jadoogaran.org */
box2.style.right = (box1.offsetLeft + box1.offsetWidth + this.position.levelX.left) + "px";}
/* End open popup from right_to_left on mouse click - hacked by irmtfan www.jadoogaran.org */
break; case "arrow":
