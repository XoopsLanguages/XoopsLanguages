<?php
// $Id: blocks.php,v 1.15 2005/08/08 06:29:39 skalpa Exp $
// Blocks
define("_MB_SYSTEM_ADMENU","Μενού Διαχειριστή");
define("_MB_SYSTEM_RNOW","Εγγραφή!");
define("_MB_SYSTEM_LPASS","Ξεχάσατε το Password;");
define("_MB_SYSTEM_SEARCH","Αναζήτηση");
define("_MB_SYSTEM_ADVS","Προχωρημένη Αναζήτηση");
...
define("_MB_SYSTEM_HOME","Αρχική Σελίδα"); // link to home page in main menu block
define("_MB_SYSTEM_RECO","Προτείνετέ μας");
