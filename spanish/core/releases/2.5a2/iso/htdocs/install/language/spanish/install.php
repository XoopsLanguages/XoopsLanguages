...
define( "XOOPS_ROOT_PATH_LABEL", "Ruta a la carpeta que contendrá la instalación de XOOPS" ); // L55
...
define( "XOOPS_LIB_PATH_HELP", "Ruta a la carpeta de datos (escribible) SIN barra invertida a la izquierda (\), para mantener la compatibilidad en el futuro colóquela fuera de " . XOOPS_ROOT_PATH_LABEL . " para que sea más segura.");
define( "XOOPS_DATA_PATH_LABEL", "Carpeta de datos de XOOPS" );
define( "XOOPS_DATA_PATH_HELP", "Ruta a la carpeta de datos (escribible) SIN la barra invertida a la izquierda (\). Para mantener la compatibilidad en el futuro colóquela fuera de " . XOOPS_ROOT_PATH_LABEL . " para que sea más segura." );
...
define( "ERR_NEED_WRITE_ACCESS", "El servidor debe tener permisos de escritura con relación a los siguientes archivos y carpetas <br />(i.e. <em>chmod 777 nombre_de_la_carpeta</em> en un servidor UNIX/LINUX)" ); // L72
