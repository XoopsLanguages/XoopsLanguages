 ...
 * _LANGCODE    es
 * _CHARSET     UTF-8
 * @version     $Id: preferences.php 4486 2010-02-25 00:19:24Z forxoops $
 */
...
/*define('_AM_SYSTEM_PREFERENCES_NAV_MD_AM_GENERAL', 'Config. general');
define('_AM_SYSTEM_PREFERENCES_NAV_MD_AM_USERSETTINGS', 'Config. Info del usuario');
define('_AM_SYSTEM_PREFERENCES_NAV_MD_AM_METAFOOTER', 'Meta Tags y Footer');
define('_AM_SYSTEM_PREFERENCES_NAV_MD_AM_CENSOR', 'Opciones para la censura');
define('_AM_SYSTEM_PREFERENCES_NAV_MD_AM_SEARCH', 'Opciones para la búsqueda');
define('_AM_SYSTEM_PREFERENCES_NAV_MD_AM_MAILER', 'Config. del correo');
define('_AM_SYSTEM_PREFERENCES_NAV_MD_AM_AUTHENTICATION', 'Opciones de autenticación');*/

//Tips
define('_AM_SYSTEM_PREFERENCES_NAV_TIPS', '<ul><li>Admin. todas las config. del sitio.</li></ul>');
/*

define('_AM_SYSTEM_PREFERENCES_NAV_TIPS_MD_AM_GENERAL', 'Por hacer');
define('_AM_SYSTEM_PREFERENCES_NAV_TIPS_MD_AM_USERSETTINGS', 'Por hacer');
define('_AM_SYSTEM_PREFERENCES_NAV_TIPS_MD_AM_METAFOOTER', 'Por hacer');
define('_AM_SYSTEM_PREFERENCES_NAV_TIPS_MD_AM_CENSOR', 'Por hacer');
define('_AM_SYSTEM_PREFERENCES_NAV_TIPS_MD_AM_SEARCH', 'Por hacer');
define('_AM_SYSTEM_PREFERENCES_NAV_TIPS_MD_AM_MAILER', 'Por hacer');
define('_AM_SYSTEM_PREFERENCES_NAV_TIPS_MD_AM_AUTHENTICATION', 'Por hacer');
*/
...
define("_MD_AM_THEMESET","Diseños (Theme Set)");
define("_MD_AM_CUSTOM_REDIRECT", "Utilizar redirección jGrowl");
define("_MD_AM_CUSTOM_REDIRECT_DESC", "sustituir redirección antigua por la redirección jQuery");
