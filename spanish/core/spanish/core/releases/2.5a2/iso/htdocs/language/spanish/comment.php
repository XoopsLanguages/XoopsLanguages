...
define('_CM_DOSMILEY','Permitir caritas');
define('_CM_DOHTML','Permitir código HTML');
define('_CM_DOAUTOWRAP','Auto "wrap lines"');
define('_CM_DOXCODE','Permitir códigos XOOPS');
...
define('_CM_DELETEONE' , 'No, borrar sólo este comentario');
define('_CM_DELETEALL', 'Sí, borrarlos todos');
define('_CM_THANKSPOST', 'Gracias por el envío');
...
define('_CM_COMAPPROVEALL','Los comentarios serán siempre aprobados');
define('_CM_COMAPPROVEUSER','Los comentarios de los usuarios registrados serán siempre aprobados');
define('_CM_COMAPPROVEADMIN','Todos los comentarios necesitan ser aprobados por el administrador');
define('_CM_COMANONPOST','¿Permitir a los usuarios anónimos enviar comentarios?');
