 ...
 */
// Navigation
define('_AM_SYSTEM_MODULES_ADMIN', 'Administrar este Módulo');
...
define('_AM_SYSTEM_MODULES_RUSUREUNINS', '¿Seguro que quieres desinstalar este módulo?');
define('_AM_SYSTEM_MODULES_RUSUREUPD', 'Presione el botón de abajo para actualizar este módulo');
define('_AM_SYSTEM_MODULES_BTOMADMIN', 'Administración de Módulos');
...
define('_AM_SYSTEM_MODULES_FAILACT', 'INo se puede activar %s.');
...
define('_AM_SYSTEM_MODULES_OKINS', 'Módulo %s instalado con éxito.');
define('_AM_SYSTEM_MODULES_OKACT', 'Módulo %s activado con éxito.');
define('_AM_SYSTEM_MODULES_OKDEACT', 'Módulo %s desactivado con éxito.');
define('_AM_SYSTEM_MODULES_OKUPD', 'Módulo %s actualizado con éxito.');
define('_AM_SYSTEM_MODULES_OKUNINS', 'El módulo %s se desinstaló correctamente.');
define('_AM_SYSTEM_MODULES_OKORDER', 'El módulo %sse ha cambiado con éxito.');
...
define('_AM_SYSTEM_MODULES_SYSNO', 'El módulo del sistema no puede ser desactivado.');
define('_AM_SYSTEM_MODULES_STRTNO', 'Este módulo está configurado como su página de inicio predeterminada. Por favor, cambie el módulo de inicio a lo que se ajuste a sus preferencias.');
define('_AM_SYSTEM_MODULES_ORDER', 'Orden');
define('_AM_SYSTEM_MODULES_ORDER0', '(0 = oculto)');
...
define('_AM_SYSTEM_MODULES_NOCHANGE', 'Sin Cambio');
...
define('_AM_SYSTEM_MODULES_LISTUPBLKS', 'Los siguientes bloques se actualizarán. <br> Seleccione los bloques cuyos contenidos (plantilla y opciones) pueden sobrescribirse.<br>');
...
define('_AM_SYSTEM_MODULES_INSERT_DATA_DONE', 'Datos del módulo insertados con éxito.');
define('_AM_SYSTEM_MODULES_MODULEID', ' ID de Módulo: %s');
...
define('_AM_SYSTEM_MODULES_GROUP_ID', ' ID de Grupo: %s ');
define('_AM_SYSTEM_MODULES_NAME', 'Nombre:');
define('_AM_SYSTEM_MODULES_VALUE', 'Valor:');
// Templates
define('_AM_SYSTEM_MODULES_TEMPLATES_ADD', 'Agregar plantillas ...');
...
define('_AM_SYSTEM_MODULES_TEMPLATE_ID', 'ID de Plantilla: %s ');
...
define('_AM_SYSTEM_MODULES_TEMPLATE_COMPILED_FAILED', 'ERROR: plantilla de compilación fallida %s ');
...
define('_AM_SYSTEM_MODULES_TEMPLATE_RECOMPILE_FAILD', 'ERROR: Fallo la recompilación de la plantilla %s');
define('_AM_SYSTEM_MODULES_TEMPLATE_RECOMPILE_ERROR', 'ERROR: no se pudo volver a compilar la plantilla %s');
define('_AM_SYSTEM_MODULES_TEMPLATE_DELETE_OLD_ERROR', 'ERROR: no se pudo eliminar la plantilla anterior %ss. Cancelando la actualización de este archivo.');
...
define('_AM_SYSTEM_MODULES_BLOCK_ID', ' ID de Bloque: %s ');
define('_AM_SYSTEM_MODULES_BLOCK_ACCESS', 'Agregados los permisos de acceso al bloque');
define('_AM_SYSTEM_MODULES_BLOCK_ACCESS_ERROR', 'ERROR: No se agregaron los permisos de acceso al bloque');
define('_AM_SYSTEM_MODULES_BLOCK_ADD', 'El Bloque %s fue agregado');
define('_AM_SYSTEM_MODULES_BLOCK_ADD_ERROR', 'ERROR: ¡No se pudo agregar el bloque %s a la base de datos!');
...
define('_AM_SYSTEM_MODULES_BLOCK_DELETE_DATA', 'Plantilla de bloque %s eliminada de la base de datos.');
define('_AM_SYSTEM_MODULES_BLOCK_DELETE_ERROR', 'ERROR: No se pudo eliminar el bloque %s');
define('_AM_SYSTEM_MODULES_BLOCK_DELETE_TEMPLATE_ERROR', 'ERROR: no se pudo eliminar la plantilla de bloque %s de la base de datos');
define('_AM_SYSTEM_MODULES_BLOCK_DEPRECATED', 'Plantilla de bloque %s obsoleta');
define('_AM_SYSTEM_MODULES_BLOCK_DEPRECATED_ERROR', 'ERROR: no se pudo eliminar la plantilla de bloque en desuso.');
define('_AM_SYSTEM_MODULES_BLOCK_UPDATE', 'Block %s actualizado.');
// Configs
define('_AM_SYSTEM_MODULES_GONFIG_ID', 'ID de opción: %s');
define('_AM_SYSTEM_MODULES_MODULE_DATA_ADD', 'Agregando datos de configuración del módulo ...');
...
define('_AM_SYSTEM_MODULES_CONFIG_ADD', 'Opción de configuración agregada');
define('_AM_SYSTEM_MODULES_CONFIG_DATA_ADD', 'Configuración %s agregado a la base de datos');
define('_AM_SYSTEM_MODULES_CONFIG_DATA_ADD_ERROR', 'ERROR: no se pudo insertar la configuración %s en la base de datos.');
define('_AM_SYSTEM_MODULES_GONFIG_DATA_DELETE', 'Datos de configuración eliminados de la base de datos.');
define('_AM_SYSTEM_MODULES_CONFIG_DATA_DELETE_ERROR', 'ERROR: No se pudo eliminar los datos de configuración de la base de datos');
// Access
define('_AM_SYSTEM_MODULES_GROUP_SETTINGS_ADD', 'Establecer derechos grupales...');
define('_AM_SYSTEM_MODULES_GROUP_PERMS_DELETE_ERROR', 'ERROR: no se pudieron eliminar los permisos del grupo');
define('_AM_SYSTEM_MODULES_GROUP_PERMS_DELETED', 'Permisos de grupo eliminados');
define('_AM_SYSTEM_MODULES_ACCESS_ADMIN_ADD', 'Se agregó el acceso de administrador adecuado para ID de grupo %s');
define('_AM_SYSTEM_MODULES_ACCESS_ADMIN_ADD_ERROR', 'ERROR: no se pudo agregar el acceso de administrador adecuado para ID de grupo %s');
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD_ERROR', 'Acceso de usuario correcto agregado para ID de grupo: %s');
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD_ERROR_ERROR', 'ERROR: no se pudo agregar el acceso de usuario correcto para ID de grupo: %s');
// execute module specific install script if any
define('_AM_SYSTEM_MODULES_FAILED_EXECUTE', 'Falló al ejecutar %s');
define('_AM_SYSTEM_MODULES_FAILED_SUCESS', '%s ejecutado con éxito');
...
define('_AM_SYSTEM_MODULES_DELETE_MOD_TABLES', 'Eliminando tablas de módulos ...');
...
define('_AM_SYSTEM_MODULES_TABLE_DROPPED', 'Tabla %s caída!');
define('_AM_SYSTEM_MODULES_TABLE_DROPPED_ERROR', 'ERROR: no se pudo dejar la tabla %s');
define('_AM_SYSTEM_MODULES_TABLE_DROPPED_FAILDED', 'ERROR: no se permite dejar caer la tabla %s !');
// Tips
...
Para ocultar el módulo en el bloque del Menú principal, configure el orden en 0<li>
<li> Elimine los archivos del módulo no utilizados de su servidor para evitar problemas de seguridad y mantener su sitio seguro. </li>
<li>Para cambiar el orden de los módulos (que se reflejarán en el Menú), solo necesita arrastrar y soltar los módulos en la ubicación deseada.</li>
</ul>');
define('_AM_SYSTEM_MODULES_CONFIRM_TIPS', '<ul>
<li>Verifique todas las modificaciones para validar.</li>
</ul>');
// 2.5.7
define('_AM_SYSTEM_MODULES_INSTALL_TESTDATA', 'Agregar Datos de Prueba');
// 2.5.8
