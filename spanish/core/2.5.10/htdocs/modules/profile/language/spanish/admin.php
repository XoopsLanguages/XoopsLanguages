...
define('_PROFILE_AM_SAVEDSUCCESS', '%s Guardado exitosamente');
define('_PROFILE_AM_DELETEDSUCCESS', '%s eliminado exitosamente');
define('_PROFILE_AM_RUSUREDEL', 'Esta seguro que quiere eliminarlo %s');
define('_PROFILE_AM_FIELDNOTCONFIGURABLE', 'El campo no es configurable.');
define('_PROFILE_AM_ADD', 'Añadir %s');
...
define('_PROFILE_AM_MAXLENGTH', 'Longitud Máxima');
define('_PROFILE_AM_WEIGHT', 'Peso');
define('_PROFILE_AM_DEFAULT', 'Defecto');
define('_PROFILE_AM_NOTNULL', '¿No nulo?');
define('_PROFILE_AM_ARRAY', 'Orden');
define('_PROFILE_AM_EMAIL', 'Correo');
...
define('_PROFILE_AM_FLOAT', 'Punto Flotante');
define('_PROFILE_AM_DECIMAL', 'Número Decimal');
define('_PROFILE_AM_UNICODE_ARRAY', 'Matriz Unicode');
define('_PROFILE_AM_UNICODE_EMAIL', 'Correo Unicode');
...
define('_PROFILE_AM_PROF_EDITABLE', 'Campo editable desde perfil');
define('_PROFILE_AM_PROF_REGISTER', 'Mostrar en el formulario de registro');
define('_PROFILE_AM_PROF_SEARCH', 'Búsqueda por estos grupos');
...
define('_PROFILE_AM_FIELDVISIBLEFOR', 'es visible por');
define('_PROFILE_AM_FIELDVISIBLEON', 'viendo un perfil de');
define('_PROFILE_AM_FIELDVISIBLETOALL', '- Todo el mundo');
define('_PROFILE_AM_FIELDNOTVISIBLE', 'no es visible');
define('_PROFILE_AM_CHECKBOX', 'Caja');
define('_PROFILE_AM_GROUP', 'Seleccione Grupo');
define('_PROFILE_AM_GROUPMULTI', 'Multi Seleccione Grupo');
define('_PROFILE_AM_LANGUAGE', 'Seleccione idioma');
define('_PROFILE_AM_RADIO', 'Botones Circulares');
define('_PROFILE_AM_SELECT', 'Seleccione');
define('_PROFILE_AM_SELECTMULTI', 'Selección Multiple');
...
define('_PROFILE_AM_YESNO', 'Botón Circular Si/No');
define('_PROFILE_AM_DATE', 'Fecha');
define('_PROFILE_AM_AUTOTEXT', 'Texto Automático');
define('_PROFILE_AM_DATETIME', 'Fecha y Hora');
define('_PROFILE_AM_LONGDATE', 'Fecha Larga');
define('_PROFILE_AM_ADDOPTION', 'Agregar Opción');
define('_PROFILE_AM_REMOVEOPTIONS', 'Eliminar Opciones');
define('_PROFILE_AM_KEY', 'Valor para ser almacenado');
...
define('_PROFILE_AM_THEME', 'Diseño');
define('_PROFILE_AM_RANK', 'Rango');
define('_PROFILE_AM_USERDONEXIT', "¡El usuario no existe!");
define('_PROFILE_MA_USERLEVEL', 'Nivel de Usuario');
define('_PROFILE_MA_ACTIVE', 'Activo');
define('_PROFILE_MA_INACTIVE', 'Inactivo');
define('_PROFILE_AM_USERCREATED', 'Creado por el Usuario');
define('_PROFILE_AM_CANNOTDELETESELF', 'No se permite eliminar su propia cuenta: use su página de perfil para eliminar su propia cuenta');
define('_PROFILE_AM_CANNOTDELETEADMIN', ' No está permitido eliminar una cuenta de administrador');
define('_PROFILE_AM_NOSELECTION', 'Ningún usuario ha sido seleccionado!');
...
define('_PROFILE_AM_STEPORDER', 'Orden de pasos');
...
define('_PROFILE_AM_REQUIRED_TOGGLE_SUCCESS', 'Campo Requerido Cambiado con Éxito');
define('_PROFILE_AM_REQUIRED_TOGGLE_FAILED', 'Falló al Cambiar el Campo Requerido');
define('_PROFILE_AM_SAVESTEP_TOGGLE', 'Alternar Guardar');
define('_PROFILE_AM_SAVESTEP_TOGGLE_SUCCESS', 'Se modificó correctamente Guardar Después del Paso');
define('_PROFILE_AM_SAVESTEP_TOGGLE_FAILED', "No se pudo cambiar 'Guardar Después del Paso'");
//XOOPS 2.5.9
define('_PROFILE_AM_CANNOTDEACTIVATEWEBMASTERS', 'No puede desactivar la cuenta de Webmaster');
