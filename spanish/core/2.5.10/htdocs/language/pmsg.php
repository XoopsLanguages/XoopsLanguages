...
define('_PM_REGISTERNOW', '¡Regístrese ahora!');
define('_PM_GOBACK', 'Regresa');
define('_PM_USERNOEXIST', 'El usuario seleccionado no existe en la base de datos.');
define('_PM_PLZTRYAGAIN', 'Por favor revisa el nombre y prueba de nuevo.');
...
//XOOPS 2.5.2
define('_PM_SURE_TO_DELETE', '¿Está seguro de que desea eliminar estos mensajes?');
//XOOPS 2.5.5
