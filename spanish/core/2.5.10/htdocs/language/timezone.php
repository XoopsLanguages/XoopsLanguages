...
define('_TZ_GMTM8', '(GMT-8:00) Hora del Pacífico (US &amp; Canada)');
define('_TZ_GMTM7', '(GMT-7:00) Hora de Montaña (US &amp; Canada)');
define('_TZ_GMTM6', '(GMT-6:00) Hora Central (US &amp; Canada), Centro América, Ciudad de Mexico');
define('_TZ_GMTM5', '(GMT-5:00) Hora del este (US &amp; Canada), Bogota, Lima, Quito');
define('_TZ_GMTM4', '(GMT-4:00) Hora del Atlántico (Canada), Caracas, La Paz');
define('_TZ_GMTM35', '(GMT-3:30) Terranova');
...
define('_TZ_GMT0', '(GMT) Meridiano de Greenwich, Londres, Dublín, Lisboa, Casablanca, Monrovia');
define('_TZ_GMTP1', '(GMT+1:00) Amsterdam, Berlin, Roma, Copenhagen, Bruselas, Madrid, Paris');
define('_TZ_GMTP2', '(GMT+2:00) Atenas, Istanbul, Minsk, Helsinki, Jerusalem, South Africa');
...
define('_TZ_GMTP55', '(GMT+5:30) Mumbai, Calcuta, Chennai, Nueva Delhi');
