...
//3.50
define($constpref.'_STOPFORUMSPAM_ACTION','Detener el spam en el foro');
define($constpref.'_STOPFORUMSPAM_ACTIONDSC','Revisa los datos del POSTEO contra spammers registrados en la base de datos de www.stopforumspam.com. Require la librería CURL de php .');
