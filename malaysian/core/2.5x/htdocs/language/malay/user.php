...
define('_US_LOSTPASSWORD', 'Hilang Password?');
...
define('_US_THANKYOUFORVISIT', 'Terima kasih kerana melawat Portal Hospital Kuala Penyu!');
define('_US_INCORRECTLOGIN', 'Pastikan nama pengguna atau kata laluan anda sah!');
define('_US_LOGGINGU', ' Terima kasih, %s anda sekarang telah log masuk ke dalam Portal Hospital Kuala Penyu.');
// 2001-11-17 ADD
...
define('_US_ACTKEYNOT', 'Kunci Aktivasi tidak betul!');
...
define('_US_NOPERMISS', 'Maaf, anda tiada kebenaran untuk melakukan tindakan ini!');
...
define('_US_NOEDITRIGHT', "Maaf, anda tiada kebenaran untuk kemaskini info pengguna ini");
