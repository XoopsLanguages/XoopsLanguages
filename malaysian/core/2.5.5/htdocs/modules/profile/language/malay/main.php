...
define("_PROFILE_MA_PASSWORDCHANGED","Kata Laluan berjaya ditukar");
define("_PROFILE_MA_OLDPASSWORD","Kata Laluan Semasa");
define("_PROFILE_MA_NEWPASSWORD","Kata Laluan Baru");
...
define("_PROFILE_MA_SEARCH","Cari Pengguna");

//changemail.php
define("_PROFILE_MA_CHANGEMAIL","Tukar Emel");
define("_PROFILE_MA_NEWMAIL","Alamat emel baru");

define("_PROFILE_MA_NEWEMAIL","Alamat emel baru di %s");
define("_PROFILE_MA_EMAILCHANGED","Alamat emel anda telah diubah");
define("_PROFILE_MA_SITEDEFAULT","Site default");

define("_PROFILE_MA_USERINFO","Profil pengguna");
define("_PROFILE_MA_REGISTER","Borang pendaftaran");

define("_PROFILE_MA_ACTUS","Pengguna aktif: %s");
define("_PROFILE_MA_FOUNDUSER","%s pengguna dijumpai");
?>
