...
define('_AD_LASTTENUSERS','10 pengguna terakhir yang mendaftar');
define('_AD_NICKNAME','Nama Samaran');
define('_AD_EMAIL','Emel');
...
define('_AD_WARNINGXOOPSLIBINSIDE','AMARAN: Folder %s terletak dalam DocumentRoot! <br />Untuk pertimbangan keselamatan adalah amat dicadangkan untuk memindahkannya keluar dari DocumentRoot.');
