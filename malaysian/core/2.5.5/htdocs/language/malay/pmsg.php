...
define('_PM_INBOX', 'Kotak Masuk');
define('_PM_FROM', 'Dari');
define('_PM_YOUDONTHAVE', 'Anda tidak mempunyai mesej peribadi');
define('_PM_FROMC', 'Dari: ');
define('_PM_SENTC', 'Dihantar: '); // The date of message sent
define('_PM_PROFILE', 'Profil');
// %s is a username
define('_PM_PREVIOUS', 'Mesej Sebelumnya');
define('_PM_NEXT', 'Mesej Seterusnya');
//%%%%%%    File Name pmlite.php    %%%%%
define('_PM_SORRY', 'Harap maaf! Anda bukan pengguna berdaftar.');
...
define('_PM_PLZTRYAGAIN', 'Sila periksa nama dan cuba lagi.');
define('_PM_MESSAGEPOSTED', 'Mesej anda telah dikirim');
define('_PM_CLICKHERE', 'Anda boleh klik sini untuk melihat mesej peribadi anda');
define('_PM_ORCLOSEWINDOW', 'Atau klik sini untuk tutup window.');
...
//XOOPS 2.5.2
define('_PM_SURE_TO_DELETE',"Adakah anda pasti yang anda ingin hapuskan mesej ini?");
//XOOPS 2.5.5
