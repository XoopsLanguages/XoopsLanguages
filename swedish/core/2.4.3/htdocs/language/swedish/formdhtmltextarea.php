...
define('_XOOPS_FORM_ALT_IMAGE', 'I bilder');
define('_XOOPS_FORM_ALT_SMILEY', 'Smiley');
define('_XOOPS_FORM_ALT_CODE', 'Källkod');
...
define('_XOOPS_FORM_ALT_CENTER', 'Centrerad');
...
define('_XOOPS_FORM_ENTERWIKITERM', 'Ordet som ska länkas till Wiki:');
define('_XOOPS_FORM_ALTMP3', 'MP3');
define('_XOOPS_FORM_ENTERMP3URL', 'MP3 URL');
define('_XOOPS_FORM_ALT_CHECKLENGTH', 'Kontrollera textlängd');
define('_XOOPS_FORM_ALT_LENGTH', 'Aktuell längd: %s');
define('_XOOPS_FORM_ALT_LENGTH_MAX', 'Max längd: ');
define('_XOOPS_FORM_PREVIEW_CONTENT', 'Klicka på <strong>' . _PREVIEW . '</strong> för att se en förhandsvisning av innehållet.');
