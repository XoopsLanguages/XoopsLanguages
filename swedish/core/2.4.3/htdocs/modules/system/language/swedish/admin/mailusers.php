...
define("_AM_REGDMAX","Registreringsdatum är före");
define("_AM_IDLEMORE","Senaste inloggning var för mer än X dagar sedan (ej obligatorisk)");
...
define("_AM_MAILBODY","Text");
define("_AM_MAILTAGS","Användbara taggar:");
define("_AM_MAILTAGS1","{X_UID} skriver ut användar-ID");
define("_AM_MAILTAGS2","{X_UNAME} skriver ut användarnamn");
define("_AM_MAILTAGS3","{X_UEMAIL} skriver ut användare-post");
define("_AM_MAILTAGS4","{X_UACTLINK} skriver ut aktiveringslänk");
