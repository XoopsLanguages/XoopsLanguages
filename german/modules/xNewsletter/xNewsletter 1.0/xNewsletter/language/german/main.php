...
define("_MA_XNEWSLETTER_SUBSCRIPTIONSUBJECT","Bestätigung des Newsletter bei " . $GLOBALS['xoopsConfig']['sitename']);
define("_MA_XNEWSLETTER_SUBSCRIPTION_SUBJECT_CHANGE","Hinweis über Änderungen Ihres Newsletters bei " . $GLOBALS['xoopsConfig']['sitename']);
...
define("_MA_XNEWSLETTER_DELETESUBJECT","Bestätigung der Abmeldung des Newsletter bei " . $GLOBALS['xoopsConfig']['sitename']);
