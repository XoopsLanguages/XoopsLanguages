...
define("_MD_LX_ANDORALL", "Alle Wörter (UND)");
define("_MD_LX_ANDORANY", "Jegliche Wörter (ODER)");
...
define("_MD_LX_BEGINWITHLETTER", "Einträge die mit diesem Buchstaben anfangen.");
...
define("_MD_LX_DELTERM", "Diesen Begriff löschen");
define("_MD_LX_EDITTERM", "Diesen Begriff bearbeiten");
define("_MD_LX_EMAILLEFT", "Der User hat seine E-Mail-Adresse hinterlassen: ");
define("_MD_LX_ENTRIES", " Einträge.");
define("_MD_LX_ENTRIESINCAT", "Einträge in diesem Verzeichnis.");
...
define("_MD_LX_ENTRYRELATEDURL", "Verknüpfte Site: ");
...
define("_MD_LX_INALLGLOSSARIES", "Einträge in all Ihren Glossaren.");
...
define("_MD_LX_INTROREQUEST", "Haben Sie in unserem Lexikon nicht die Definition gefunden nach der Sie gesucht haben? Füllen Sie dieses Formular aus und senden uns den Begriff. Wir suchen nach der Definition und fügen sie hinzu.");
define("_MD_LX_LOOKON", "Suchen nach");
define("_MD_LX_MAINHEAD", "Willkommen auf %s");
define("_MD_LX_MAININTRO", "In diesem Bereich finden Sie sowohl unseren Katalog an Glossar-Einträgen, als auch die neuesten Einträge in den Kategorien. Klicken Sie auf den Kategorienamen und Sie sehen alle Einträge die mit dieser Kategorie verknüpft sind oder klicken Sie auf einen Eintragnamen um den Eintrag direkt zu lesen. Abhängig von Ihren Berechtigungen können Sie jeden Eintrag bewerten, Benachrichtigungen setzen oder Kommentare schreiben.");
define("_MD_LX_MAINNOSELECTCAT", "Sie haben keine gültige Kategorie ausgewählt");
define("_MD_LX_MAINNOTOPICS", "Es gibt keine Einträge für diese Kategorie");
define("_MD_LX_MESSAGESENT", "Nachricht an %s verschickt.");
define("_MD_LX_NO", "Nein");
define("_MD_LX_NOENTRIESINCAT", "Es liegen für dieses Glossar noch keine Einträge vor.");
define("_MD_LX_NORESULTS", "Es gibt keine übereinstimmungen mit dem Suchbegriff. Versuchen Sie einen anderen Suchbegriff.");
define("_MD_LX_NOSEARCHTERM", "Sie haben keinen Suchbegriff angegeben. Bitte holen Sie es jetzt nach.");
define("_MD_LX_NOTERMSINLETTER", "Es gibt keine Einträge die mit diesem Buchstaben beginnen.");
define("_MD_LX_NOTIFY", "Bei Veröffentlichung benachrichtigen?");
...
define("_MD_LX_POPULARENT", "Populäre Eintrage");
define("_MD_LX_POSTED", "Veröffentlicht");
...
define("_MD_LX_RANDOMTERM", "Zufälliger Begriff");
define("_MD_LX_RECEIVED", "Wir haben den Eintrag erhalten. Wir werden ihn schnellstmöglich bearbeiten.");
define("_MD_LX_RECEIVEDANDAPPROVED", "Wir haben den Eintrag erhalten. Da automatische Freigabe eingeschaltet ist, wird der Eintrag sofort veröffentlicht.");
define("_MD_LX_RECENTENT", "Aktuelle Einträge");
define("_MD_LX_REFERENCE", "Referenz<span style='font-size: xx-small; font-weight: normal; display: block;'>(Sie können optional die Quelle der Definition angeben.)</span>");
define("_MD_LX_REQRCVD", "Wir haben Ihre Anfrage erhalten und werden sie schnellstmöglich bearbeiten.");
define("_MD_LX_REQSEND", "Anfrage abgeschickt");
define("_MD_LX_REQTERM", "[*] Zu definierender Begriff");
define("_MD_LX_REQUESTDEF", "Eine Definition anfragen");
...
define("_MD_LX_SENTCONFIRMMAIL", "Ihre Kommentare wurde als Bestätigungsmail an <b>%s</b> geschickt.");
...
define("_MD_LX_SUB_SMNAME", "Füllen Sie dieses Formular aus um Ihren Eintrag einzuschicken");
define("_MD_LX_SUB_SNEWNAME", "Einen Eintrag schicken an %s");
define("_MD_LX_SUB_SNEWNAMEDESC", "Bitte füllen Sie das folgende Formular aus, um einen neuen Eintrag einzuschicken. Je nach Einstellung wird der Eintrag vorher geprüft oder automatisch freigegeben.");
...
define("_MD_LX_SUBMITTEDBY", "von ");//v 1.17
define("_MD_LX_SUBMITTEDON", "Stand: "); //v 1.17
define("_MD_LX_SUBMITTED", "Eingeschickt ");//v 1.17
...
define("_MD_LX_THANKS1", "Vielen Dank für Ihre Beteiligung!<br />");
...
define("_MD_LX_THEREWERE", "Es gibt %s Einträge die dem Suchbegriff entsprechen: <b>%s</b>.");
define("_MD_LX_TIMESREAD", "x mal gelesen");
define("_MD_LX_UNKNOWNERROR", "FEHLER. Sie werden zurückgeleitet!");
define("_MD_LX_URL", "URL<span style='font-size: xx-small; font-weight: normal; display: block;'>(Bitte geben Sie eine gültige URL mit oder ohne HTTP-Präfix an)</span>");
...
define("_MD_LX_BREAKS", "Zeilenumbrüche erlauben?");
...
define("_MD_LX_SUBCATS", "Unterkategorien");
?>