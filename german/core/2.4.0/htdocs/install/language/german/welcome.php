...
<p>
    ...
    und ist damit frei verwendbar und änderbar, so lange Änderungen, 
    wie Sie durch die Bestimungen der GPL genannt sind, unter die selbe Lizenz gestellt werden.
</p>
<h3>Anforderungen</h3>
<ul>
	<li>WWW Server (<a href="http://www.apache.org/" rel="external">Apache</a>, IIS, Roxen, etc)</li>
	<li><a href="http://www.php.net/" rel="external">PHP</a> 4.3.0 oder höher (5.2 oder höher empfohlen)</li>
	<li><a href="http://www.mysql.com/" rel="external">MySQL</a> 3.23 oder höher (4.1 oder höher empfohlen)</li>
</ul>
...
<ol>
    ...
    <li>Bereiten Sie ein Benutzerkonto vor und geben Sie dem Benutzer die benötigten Rechte zur Datenbank.</li>
    ...
    <li>Für mehr Sicherheit sollten die folgenden Verzeichnisse ausserhalb des <a href="http://phpsec.org/projects/guide/3.html" rel="external">Hauptverzeichnisses</a> liegen und umbenannt werden: %s</li>
    <li>Erstellen Sie die folgenden Verzeichnisse und machen diese beschreibbar: %s</li>
