...
define("_AM_REGDMAX","Registrován před");
define("_AM_IDLEMORE","Poslední přihlášení bylo před více než X dny (volitelné)");
...
define("_AM_MAILBODY","Zpráva");
define("_AM_MAILTAGS","Užitečné tagy:");
define("_AM_MAILTAGS1","{X_UID} vloží id uživatele");
define("_AM_MAILTAGS2","{X_UNAME} vloží jméno uživatele");
define("_AM_MAILTAGS3","{X_UEMAIL} vloží email uživatele");
define("_AM_MAILTAGS4","{X_UACTLINK} vloží aktivační odkaz");
