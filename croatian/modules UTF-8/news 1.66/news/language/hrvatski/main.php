...
define("_NW_SENDSTORY","Pošalji ovu objavu prijatelju");
define("_NW_READMORE","Pročitaj više...");
...
define("_NW_THEREAREINTOTAL","Ima ukupno %s članak(a)");

// %s is your site name
define("_NW_INTARTICLE","Interesantan članak na %s");
define("_NW_INTARTFOUND","Evo jedan zanimljiv članak koji sam pronašao na %s");

define("_NW_TOPICC","Tema:");
define("_NW_URL","URL:");
define("_NW_NOSTORY","Žao nam je, ova objava ne postoji.");

//%%%%%%	File Name print.php 	%%%%%

define("_NW_URLFORSTORY","URL za ovu objavu je:");

// %s represents your site name
define("_NW_THISCOMESFROM","Ovaj članak dolazi sa %s");

// Added by Hervé
define("_NW_ATTACHEDFILES","Dodane datoteke:");
define("_NW_ATTACHEDLIB","Ovaj članak ima neke dodane datoteke");
...
define("_NW_PREVIOUS_ARTICLE","Prethodni članak");
define("_NW_NEXT_ARTICLE","Sljedeći članak");
define("_NW_OTHER_ARTICLES","Ostali članci");
...
define("_NW_RATINGSCALE","Ocjene su od 1 - 10, gdje je 1 loše a 10 odlično.");
define("_NW_BEOBJECTIVE","Molimo da budete objektivni, ako svi daju 1 ili 10, rangiranje nije od neke koristi.");
define("_NW_DONOTVOTE","Ne glasujte za svoje osobne članke.");
...
define("_NW_CANTVOTEOWN","Ne možete glasovati za članak koji ste sami prijavili.<br />Svi glasovi se spremaju i pregledavaju.");
define("_NW_VOTEDELETED","Glasački podaci su izbrisani.");
define("_NW_VOTEONCE","Molimo da ne glasati za isti članak više puta.");
...
define("_NW_MAKEPDF","Stvori PDF od članka");
...
define("_NW_BOOKMARK_ME","Zapamti ovaj članak na ovim stranicama");
define('_AM_NEWS_TOTAL',"Ukupno od %u članaka");
define('_AM_NEWS_WHOS_WHO',"Tko je tko");
define('_NW_NEWS_LIST_OF_AUTHORS',"Ovdje je lista autora na ovim stranicama, kliknite na ime da bi vidjeli njegove/njezine članke");
define('_AM_NEWS_TOPICS_DIRECTORY',"Popis tema");
define("_NW_PAGE_AUTO_SUMMARY","Strana %d : %s");

// Added in version 1.51
define("_NW_BOOKMARK_TO_BLINKLIST","Označi za Blinklist");
define("_NW_BOOKMARK_TO_DELICIOUS","Označi za del.icio.us");
define("_NW_BOOKMARK_TO_DIGG","Označi za Digg");
define("_NW_BOOKMARK_TO_FARK","Označi za Fark");
define("_NW_BOOKMARK_TO_FURL","Označi za Furl");
define("_NW_BOOKMARK_TO_NEWSVINE","Označi za Newsvine");
define("_NW_BOOKMARK_TO_REDDIT","Označi za Reddit");
define("_NW_BOOKMARK_TO_SIMPY","Označi za Simpy");
define("_NW_BOOKMARK_TO_SPURL","Označi za Spurl");
define("_NW_BOOKMARK_TO_YAHOO","Označi za Yahoo");
