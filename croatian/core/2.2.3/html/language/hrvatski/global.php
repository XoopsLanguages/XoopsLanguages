...
// !!VAŽNO!! umetni '\' izmeðu prije svakog slova koje je rezervirano slovo: "a","A","B","c","d","D","F","g","G","h","H","i","I","j","l","L","m","M","n","O","r","s","S","t","T","U","w","W","Y","y","z","Z"	
// umetni dvostruko '\' prije 't','r','n'
define("_TODAY","Danas H:m:s");
define("_YESTERDAY","Juæer H:m:s");
define("_MONTHDAY","d.m. H:m:s");
define("_YEARMONTHDAY","d.m.Y H:m");
/*
...
// Error messaging
define("_NOERRORMESSAGE","Nema specifiène poruke o greški");

// Added in XOOPS 2.2
define("_SELECTEDITOR","Izaberite urednika");

define("_REMOVE","Ukloni");
define("_REQUIRED","Obavezno");

// Used for "theme" type profile field
define("_SITEDEFAULT","Postavi na zadano");
?>