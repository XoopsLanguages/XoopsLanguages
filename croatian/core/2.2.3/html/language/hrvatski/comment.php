...
define('_CM_DOSMILEY','Omoguæi smailiæe');
define('_CM_DOHTML','Omoguæi HTML oznake');
define('_CM_DOAUTOWRAP','Automatski prijeði u novi red');
define('_CM_DOXCODE','Omoguæi XOOPS kodove');
define('_CM_REFRESH','Osvježi');
define('_CM_PENDING','Oèekivanje');
...
define('_CM_NOTICE',"Komenatri su vlasništvo komentatora. Mi nismo odgovorni za njihov sadržaj.");
...
define('_CM_COMNOCOM','Onemoguæi komentare');
?>