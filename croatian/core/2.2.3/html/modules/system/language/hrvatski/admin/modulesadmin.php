...
define("_MD_AM_VERSION","Inaèica");
define("_MD_AM_LASTUP","Zadnja modernizacija");
...
define("_MD_AM_UPDATE","Moderniziraj");
...
define("_MD_AM_UPDTED","Izabrani modul je moderniziran!");
define("_MD_AM_SYSNO","Sustavski modul se ne može deaktivirati.");
define("_MD_AM_STRTNO","Ovaj modul je postavljen na poèetnu stranicu. Molimo da promjenite poèetni modul da bi ga mogli deaktivirati.");
...
define("_MD_AM_FAILUPD","Ne mogu modernizirati %s.");
...
define("_MD_AM_ALEXISTS","Modul %s veæ postoji.");
...
define("_MD_AM_OKUPD","Modul %s je uspješno moderniziran.");
define("_MD_AM_OKUNINS","Modul %s je uspješno deinstaliran.");
define("_MD_AM_OKORDER","Modul %s je uspješno promjenjen.");

define('_MD_AM_RUSUREINS','Pritisnite donju tipku za instalaciju ovag modula');
define('_MD_AM_RUSUREUPD','Pritisni donju tipku da bi modernizirali ovaj modul');
define('_MD_AM_RUSUREUNINS','Sigurno želite deinstalirati ovaj modul?');
define('_MD_AM_LISTUPBLKS','Slijedeæi blokovi æe biti modernizirani.<br />Izaberite blokove èiji sadržaj (prijedlošci i opcije) može biti prepisan.<br />');
define('_MD_AM_NEWBLKS','Novi blokovi');
define('_MD_AM_DEPREBLKS','Neodobreni blokovi');
// added in 2.2
define("_MD_AM_SELECT_ADMINS","Izaberi grupe s administracijskim pravima");
define("_MD_AM_SELECT_ACCESS","Izaberite grupe s pristupom");
?>