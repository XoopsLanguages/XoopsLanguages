...
<ol>
    ...
    <li>Ako trebate instalirati <em>protector</em> modul, <div class="confirmMsg">Zamjenite datoteku <em>mainfile.dist.php</em> u vašoj XOOPS početnoj mapi sa <em>/extras/mainfile.dist.php.protector</em>.</div></li>
