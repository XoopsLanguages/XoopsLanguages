...
//%%%%%%	File Name  admin.php 	%%%%%
define('_MD_AM_DBUPDATED','¡Base de datos actualizada correctamente!');
define('_MD_AM_DBERROR', 'A base de datos non se actualizou debido a algún erro');

define('_MD_AM_CONFIG','Configuración del Sistema');
...
define('_MD_AM_PERMRESETNG','Imposible restablecer permiso de grupo para o módulo %s');
define('_MD_AM_PERMADDNGP', 'Tódolos elementos pai deben ser seleccioados.');
?>