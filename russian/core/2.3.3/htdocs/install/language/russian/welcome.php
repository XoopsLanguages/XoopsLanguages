...
<li>Если вам необходимо установить модуль <em>protector</em>, <div class="confirmMsg">замените файл <em>mainfile.dist.php</em> в корне сайта на файл <em>/extras/mainfile.dist.php.protector</em> (не забудьте переименовать файл в <em>htdocs/mainfile.dist.php</em>).</div></li>
