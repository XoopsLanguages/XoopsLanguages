<?php
// $Id: modinfo.php, 2008-10-05 02:02:45Z West $
...
define($constpref.'_BANIP_TIME0','Время блокировки по IP (sec)<br /> 259200 сек.=трое суток');

define($constpref.'_LOGLEVEL0','Журнал отключен');
define($constpref.'_LOGLEVEL15','Минимум событий');
define($constpref.'_LOGLEVEL63','Максимум событий');
define($constpref.'_LOGLEVEL255','Все события');

define($constpref.'_HIJACK_TOPBIT','Защищенные биты IP для сессий');
define($constpref.'_HIJACK_TOPBITDSC','Анти-Налет сессий:<br />Значение по умолчанию 32 (бит). 
 (Все биты защищены)<br />Если у Вас динамический IP адрес, установите IP числом битов.<br />(пример) Если ваш IP может изменятся в диапазоне 192.168.0.0-192.168.0.255, установите в настройках 24 (бит)');
...
define($constpref.'_ISOCOM_ACTIONDSC','Выберите действие выполняемое при обнаружении строки "/*" без экранировния.<br />"Очистка" подразумевает добавление экранирующих символов "*/".<br />(Рекомендуется: Очистка)');
define($constpref.'_UNION_ACTION','Действие при обнаружении ключевого слова UNION');
define($constpref.'_UNION_ACTIONDSC','Выберите действие выполняемое при обнаружении ключевого слова UNION. "Очистка" предполагает замену всех вхождений данного слова "UNI-ON". (Рекомендуется: Очистка)');
...
define($constpref.'_OPT_BIPTIME0','Блокировка по IP (мораторий)');
...
define($constpref.'_DOSOPT_BIPTIME0','Блокировка по IP (мораторий)');
