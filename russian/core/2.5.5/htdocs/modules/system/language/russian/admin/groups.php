...
//Nav
define("_AM_SYSTEM_GROUPS_NAV_MANAGER","Менеджер Групп");
define("_AM_SYSTEM_GROUPS_NAV_LIST","Список Групп");
define("_AM_SYSTEM_GROUPS_NAV_ADD","Создание новой группы");
define("_AM_SYSTEM_GROUPS_NAV_EDIT","Редактирование групп");
define("_AM_SYSTEM_GROUPS_NAV_DELETE","Удаление групп");

// Tips
define("_AM_SYSTEM_GROUPS_NAV_TIPS_1","<ul>
<li>Создавайте новые группы пользователей и устанавливайте им особые права доступа.</li>
<li>Редактируйте существующие группы и изменяйте их права доступа к различным модулям.</li>
</ul>");
define("_AM_SYSTEM_GROUPS_NAV_TIPS_2","<ul>
<li>Создайте или измените права доступа для этой группы, изменения затронут всех пользователей группы.</li>
</ul>");
