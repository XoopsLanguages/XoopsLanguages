...
define('_MD_XOOPSBOOKS','Книги о XOOPS');
define('_MD_NEWMODULE','Новые модули');
define('_MD_XOOPSFAQ','XOOPS FAQ');
define('_MD_CODESVN','SVN хранилище');
define('_MD_REPORTBUG','Сообщения об ошибках');
define('_MD_XGIFTSHOP','Магазин XOOPS атрибутики');
define('_MD_XDONATIONS','Помощь проекту');
define('_MD_XDONATIONS_TEXT','<h4>Нам нужна Ваша мопощь - Пожалуйста сделайте пожертвование!</h4>
...
define('_MD_MOVETOBLUE','Установить официальные модули');
define('_MD_MOVETOBLUE_LINK','http://www.xoops.org/modules/repository/');
/* for xoops 2.5.0 beta and RC */
define('_MD_PROMOBANNER','OpenSource Awards - Пожалуйста, голосуйте за XOOPS!');
