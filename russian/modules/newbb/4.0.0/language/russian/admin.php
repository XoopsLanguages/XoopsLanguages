...
define("_AM_NEWBB_CAN_ACCESS","Доступ к подразделам форума");
define("_AM_NEWBB_CAN_VIEW","Могут просматривать содержимое топика");
define("_AM_NEWBB_CAN_POST","Могут начинать новые");
define("_AM_NEWBB_CAN_REPLY","Могут отвечать");
define("_AM_NEWBB_CAN_EDIT","Могут редактировать собственные посты");
define("_AM_NEWBB_CAN_DELETE","Могут удалять собственные посты");
...
define("_AM_NEWBB_CAN_HTML","Могут использовать HTML теги");
define("_AM_NEWBB_CAN_SIGNATURE","Могут использовать подпись");
...
define("_AM_NEWBB_PROCESSREPORT","Посмотреть новые рапорты");
...
define("_AM_NEWBB_TYPE_TEMPLATE","Шаблон типов");
define("_AM_NEWBB_TYPE_TEMPLATE_APPLY","Применить шаблон");
define("_AM_NEWBB_TYPE_FORUM","Типы в форум");
define("_AM_NEWBB_TYPE_NAME","Имя типа");
...
define("_AM_NEWBB_TODEL_TYPE","Удалить типы: [%s]?");
...
define("_AM_NEWBB_SYNC_TYPE_USER","Пользовательские Данные");
