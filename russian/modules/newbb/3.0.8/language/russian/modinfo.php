<?php
// $Id: modinfo.php,v 1.4 2005/04/18 01:22:30 phppp Exp $
...
define("_MI_SUBJECT_PREFIX","Добавление префикса в тему");
define("_MI_SUBJECT_PREFIX_DESC","Устанавливает, например <b>[решено]</b> в начало темы. Через ','. Оставьте пустым, если префиксы не нужны");
define("_MI_SUBJECT_PREFIX_DEFAULT",'<font color="#00CC00">[решено]</font>,<font color="#00CC00">[исправлено]</font>,<font color="#FF0000">[запрос]</font>,<font color="#FF0000">[сообщенить ошибку]</font>,<font color="#FF0000">[нерешено]</font>');

define("_MI_SUBJECT_PREFIX_LEVEL_DESC","Выберите группу которой разрешено использовать префикс.");
define("_MI_SUBJECT_PREFIX_LEVEL","Уровень группы необходимый для использования Префикса");
define("_MI_SPL_DISABLE",'Запретить');
define("_MI_SPL_ANYONE",'Любой');
define("_MI_SPL_MEMBER",'Пользователи');
define("_MI_SPL_MODERATOR",'Модераторы');
define("_MI_SPL_ADMIN",'Администраторы');
