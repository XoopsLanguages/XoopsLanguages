...
define("_MB_NEWS_VIEW_TYPE2", "Табличный");
define("_MB_NEWS_TAB_COLOR1", "Цвет итоговой строки (это строка сразу под названием пункта )");
define("_MB_NEWS_TAB_COLOR2", "Цвет фона содержания ");
define("_MB_NEWS_TAB_COLOR3", "Цвет текущего заголовка");
define("_MB_NEWS_TAB_COLOR4", "Цвет невыбранных заголовков");
define("_MB_NEWS_TAB_COLOR5", "Цвет всплывающего заголовка ");
define("_MB_NEWS_WHAT_PUBLISH", "Что вы хотите опубликовать в <br />центре внимания ?");
define("_MB_NEWS_RECENT_NEWS", "Последнюю новость (список внизу не используется )");
define("_MB_NEWS_RECENT_SPECIFIC", "Выбрать новости (см. ниже)");
define("_MB_NEWS_DEFAULT_COLORS", "Оставьте зоны пустыми для использования цветов по умолчанию");
// Added in version 1.50
define("_MB_NEWS_CAL_YEAR", "Год");
define("_MB_NEWS_CAL_MONTH", "Месяц");
define("_MB_NEWS_STARTING_DATE", "Начальная дата");
define("_MB_NEWS_ENDING_DATE", "Дата окончания");
define("_MB_NEWS_UNTIL_TODAY", "или до сегодняшнего дня");
define("_MB_NEWS_RECENT_FIRST", "новые вначале");
define("_MB_NEWS_OLDER_FIRST", "старые вначале");
?>